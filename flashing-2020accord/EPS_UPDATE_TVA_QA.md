...
**Cross-checked against:** `D:/sa-key-hunt/sunnypilot_eps/eps-update.py` (upstream), `flashing-2020accord/tva_sa_key.py`, `flashing-2020accord/encode_eps.py`, `analysis-2020accord/HOW_TO_BUILD_ACCORD_TVA_RWD.md` (SA algorithm §6 + build recipe; distilled from the former `V850_ALGORITHM_VERIFIED.md` / `ACCORD_TVA_ARCHITECTURE_MAP.md`), `docs/EPS-FLASH-RUNBOOK.md`, repo `CLAUDE.md`. Candidate `.rwd` files are external under `../accord-firmware/flashing-2020accord/`.
