...
4. **`memory/MEMORY.md`** — 🛑 **PAGINATED IN EIGHT: read `MEMORY-PART2.md` … `MEMORY-PART8.md` too** (there is no `PART9` in this repo — that file exists only in the harness auto-memory store, which is a separate flat directory)
