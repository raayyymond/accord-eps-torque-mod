...
Every statistic here is the one `r5d_ratchet.py` / `r5d_falsifiers.py` / `r5d_bands.py` computed for
...
ORDER, and it is not negotiable (`memory/feedback-episodes-not-windows.md`):
...
Usage:  python v78_symptom_score.py   ->  writes _v78_score.json
"""
import json
import sys
...
with open(ROOT / "_v78_score.json", "w", encoding="utf-8") as fh:
    json.dump(OUT, fh, indent=1, default=float)
print("\nwrote _v78_score.json")
