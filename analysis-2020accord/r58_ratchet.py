...
INSTRUMENT is `r50_ratchet.py` / `r4f_ratchet_inventory.py`, unchanged in every numeric respect:
...
Writes `_r58_ratchet.json`.  Usage: python r58_ratchet.py
"""
import json
import sys
...
(ROOT / "_r58_ratchet.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {ROOT / '_r58_ratchet.json'}")
