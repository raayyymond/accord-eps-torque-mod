...
WHY THIS FILE EXISTS. `r50_grind1.py` ss3 returned ZERO qualifying cells at creep: V70 has 19
...
Writes `_r50_grind1_power.json`.  Usage: python r50_grind1_power.py
"""
import json
import sys
...
(HERE / "_r50_grind1_power.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE / '_r50_grind1_power.json'}")
