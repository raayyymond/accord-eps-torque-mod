...
Every CI resamples EPISODES (memory: feedback-episodes-not-windows). Writes `_r59_equivalence.json`.
"""
import json
import sys
...
json.dump(OUT, open(ROOT / "_r59_equivalence.json", "w"), indent=1, default=float)
print(f"\nwrote {ROOT / '_r59_equivalence.json'}")
