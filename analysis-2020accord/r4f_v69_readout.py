#!/usr/bin/env python3
"""r4f_v69_readout.py -- the V69 probe readout on route 4f, at full resolution.

The stock decoder (`rlog-tools/decode_v69_ratchet.py`) is the AUTHORITATIVE identification and is
...
Usage:  python r4f_v69_readout.py [<segment paths...>]   (defaults to all 8 segments of route 4f)
"""
import os
import sys
...
CACHE = KIT / "analysis-2020accord" / "_cache_r4f_v69.npz"
