...
Usage:  python analyze_bus_amplitude_vs_detector_T.py [--quick]
"""
import sys
...
def main():
    print("Building native-grid stores (cached in _cache_native/)...")
    store = build()
