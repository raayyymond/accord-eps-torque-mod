...
PKL = ROOT / "_cache_r75" / "records_v89_score.pkl"
OUTJ = ROOT / "_cache_r75" / "v89_e2_h2h3.json"

BUILDS = {
    "V88/r73": dict(cache=ROOT / "_cache_r73", pfx="r73s", segs=list(range(11)), parked=[10],
                    stem="r73", kd=9.88),
    "V89/r75": dict(cache=ROOT / "_cache_r75", pfx="r75s", segs=list(range(16)), parked=[14, 15],
                    stem="r75", kd=9.89),
    "V89/r76": dict(cache=ROOT / "_cache_r76", pfx="r76s", segs=list(range(13)), parked=[],
                    stem="r76", kd=9.89),
}
