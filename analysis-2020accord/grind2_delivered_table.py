...
Usage:  python grind2_delivered_table.py
"""
import json
import sys
...
# ================================================================= §3 ============================
# The burst-producing cell, verified in `d4_r59_grind2.py` §4: 20 of 25 V62/V65 bursts and 3 of 3
...
(HERE / "_grind2_delivered_table.json").write_text(json.dumps(OUT, indent=1), encoding="utf-8")
print(f"\nwrote {HERE / '_grind2_delivered_table.json'}")
