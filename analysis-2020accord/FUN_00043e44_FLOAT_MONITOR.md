...
call = 1 ms/call; see SESSION-2026-05-30-EME-RESOLUTION.md §"VERIFIED NUMBERS"). It reads the
...
Confirmed in `reference_accord_override_snap_state_machines.md`.
...
- `SESSION-2026-05-30-EME-RESOLUTION.md` — §"2026-05-31" has the initial unconfirmed findings
  that this decompile confirms
- `reference_accord_override_snap_state_machines.md` — confirms REPORT-ONLY status
- `reference_accord_lerp3_gp3574_chain.md` — integer path LERP1/2/3 chain for comparison
- `fw_inventory/cluster3_shaper_foc.md` — inventory context for this function
