...
Same code path as `r5d_falsifiers.py` / `r5d_tracking_test.py` / `r5d_3xf0_check.py`, thirteen
...
(`memory/reference-accord-falsifier-b-anchored-search-presupposes-answer.md`): an anchored search can
...
Usage:  python v78_symptom_falsifiers.py   ->  writes _v78_falsifiers.json
"""
import json
import sys
...
with open(ROOT / "_v78_falsifiers.json", "w", encoding="utf-8") as fh:
    json.dump(OUT, fh, indent=1, default=float)
print("\nwrote _v78_falsifiers.json")
