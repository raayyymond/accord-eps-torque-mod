...
Corner definition is byte-for-byte `analyze_grind2_corner.py`:  v < 4 m/s  AND  sustained driver
...
Usage:  python _t10_corner_engagement.py
"""
import pickle
import sys
...
PKL = ROOT / "_cache_grind2_records.pkl"
