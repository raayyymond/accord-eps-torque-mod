#!/usr/bin/env python3
"""verify_v71c_image.py -- EXACT-VALUE anchors for V71C, independent of the builder.
...
All three carry `0x454FE = 0xB5` and a stock `gain_B` surface. `diff_build_vs_stock.py` is span-based
...
Usage:  python verify_v71c_image.py [path-to-_v71c_plain_image.bin]
"""
import struct
import sys
...
def main(path=None):
    ...
    print(f"verify_v71c_image.py -- {p}\n  {len(b)} bytes\n")
