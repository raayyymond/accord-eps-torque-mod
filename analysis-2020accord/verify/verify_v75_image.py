#!/usr/bin/env python3
"""verify/verify_v75_image.py -- VALUE-ANCHORED verification of a built V75 image.
...
`builds/v50_v79/build_v75_tva.py`'s own tables AND re-derived from the image's pointer arrays. Three independent
...
Usage:  python verify/verify_v75_image.py [IMAGE]  (default: the CY0.566-EX1.200 cut)
        python verify/verify_v75_image.py --rwd PATH     (decode a .rwd and verify the payload)
"""
...
def cross_check_against_builder():
    ...
    print("=" * 100)
    print("  CROSS-CHECK -- this file's literals against builds/v50_v79/build_v75_tva.py's own tables")
    ok = True
