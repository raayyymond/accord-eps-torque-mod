...
T = [
 ...
 ('iVar21',     8192, 'a clamped branch product', 'unidentified', 'unknown'),
 ('iVar16',     8192, 'a clamped branch product', 'unidentified', 'unknown'),
 ...
 ('gp-0x6ade',  1024, 'a clamped input', 'unidentified', 'unknown'),
