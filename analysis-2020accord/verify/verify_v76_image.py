#!/usr/bin/env python3
"""verify/verify_v76_image.py -- VALUE-ANCHORED verification of a built V76 image.
...
`builds/v50_v79/build_v76_tva.py`'s own tables AND re-derived from the image, so a typo in either one is caught.
...
Usage:  python verify/verify_v76_image.py [IMAGE]
        python verify/verify_v76_image.py --rwd PATH     (decode a .rwd and verify the payload)
"""
...
def cross_check_against_builder():
    ...
    print("=" * 100)
    print("  CROSS-CHECK -- this file's literals against builds/v50_v79/build_v76_tva.py's own tables")
    ok = True
