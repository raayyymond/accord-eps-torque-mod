"""
verify/verify_v52c_image.py -- INDEPENDENT post-build integrity verifier for the V52C broad low-pass image.

DESIGN RULE (the V40 process lesson, CLAUDE.md): a verifier and the builder it checks MUST NOT share an
assumption. This file therefore imports NOTHING from build_v52*.py / studies/caves/v52_cave_asm.py. Every check --
...
Usage:  python verify/verify_v52c_image.py [--built PATH] [--baseline PATH]
