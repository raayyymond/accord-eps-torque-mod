#!/usr/bin/env python3
"""verify/audit_rlog_raw_census.py -- SECOND, INDEPENDENT METHOD for the rlog service census.

`verify/audit_rlog_channels.py` counts services through pycapnp's schema layer. That layer can only see
...
Usage:  python verify/audit_rlog_raw_census.py 4a 20 21
"""
import struct
import sys
