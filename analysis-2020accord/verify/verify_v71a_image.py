#!/usr/bin/env python3
"""verify/verify_v71a_image.py -- EXACT-VALUE anchors for V71A, independent of the builder.
...
`builds/v50_v79/build_v71a_tva.py` beyond the addresses.
...
Usage:  python verify/verify_v71a_image.py [path-to-_v71_plain_image.bin]
"""
...
def main(path=None):
    ...
    print(f"verify/verify_v71a_image.py -- {p}\n  {len(b)} bytes\n")
