#!/usr/bin/env python3
"""verify/verify_v73_image.py -- VALUE-ANCHORED verification of a built V73 image.
...
value below is re-declared here as a LITERAL and then CROSS-CHECKED against `builds/v50_v79/build_v73_tva.py`'s own
...
Usage:  python verify/verify_v73_image.py [IMAGE]        (default: _v73_plain_image.bin)
        python verify/verify_v73_image.py --rwd PATH     (decode a .rwd and verify the payload)
"""
...
def cross_check_against_builder():
    ...
    print("\n  CROSS-CHECK -- this file's literals vs builds/v50_v79/build_v73_tva.py's tables:")
    ok = True
