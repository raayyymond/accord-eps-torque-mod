#!/usr/bin/env python3
"""verify/audit_alias_evidence.py -- does anything ACTUALLY fold, and how sensitive is each channel?
...
Usage:  python verify/audit_alias_evidence.py
"""
import sys
