"""CORRECTION to verify/redteam_k185.py: X[9]=6000 for v>=80 km/h, so |Tc| (<=8192) CAN exceed it
...
d=np.load("_scratch/cache/r85/r85.npz",allow_pickle=True); e=d["cc_lat"].astype(bool)
