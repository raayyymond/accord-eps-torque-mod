#!/usr/bin/env python3
"""verify/audit_rlog_channels.py -- INSTRUMENT AUDIT: every service in an rlog and its TRUE sample rate.
...
Usage:  python verify/audit_rlog_channels.py 4a 20 21          # route tag + segments
        python verify/audit_rlog_channels.py 4a                # default segments
        python verify/audit_rlog_channels.py 47 5
"""
import sys
