#!/usr/bin/env python3
"""verify/verify_v74_image.py -- VALUE-ANCHORED verification of a built V74 image.
...
then CROSS-CHECKED against `builds/v50_v79/build_v74_tva.py`'s own tables AND re-derived from the image's pointer
...
Usage:  python verify/verify_v74_image.py [IMAGE]  (default: _v74_engagedcols_x0_12_addonly_plain_image.bin)
        python verify/verify_v74_image.py --rwd PATH     (decode a .rwd and verify the payload)
"""
...
def cross_check_against_builder():
    ...
    print("=" * 100)
    print("  CROSS-CHECK -- this file's literals against builds/v50_v79/build_v74_tva.py's own tables")
    ok = True
