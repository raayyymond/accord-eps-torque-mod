...
`r5d_falsifiers.py`'s Falsifier B searches for the "5 x f0" peak within +/-4 bins of the PREDICTED
...
`accord-v59-parametric-pump-marginal.md`) that a f0-anchored search will only ever "catch" when 5 x f0
...
Usage:  python r5d_tracking_test.py   ->  writes _r5d_tracking_test.json
"""
import json
import sys
...
with open(ROOT / "_r5d_tracking_test.json", "w", encoding="utf-8") as fh:
    json.dump(OUT, fh, indent=1, default=float)
print("\nwrote _r5d_tracking_test.json")
