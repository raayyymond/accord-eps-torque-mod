...
INSTRUMENT is `r59_ratchet_vs_history.py`'s `scan`, ported VERBATIM in every numeric respect:
...
axis as every route in `_r59_ratchet_hist.json`.
...
CACHE, PFX, SEGS = ROOT / "_cache_r5a", "r5as", list(range(18))
