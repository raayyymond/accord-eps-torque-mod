...
WHAT CHANGED SINCE price_flat_6b86_boost.py
-------------------------------------------
1. `a` is no longer the budget-closure 0.098.  `v103_filter_natural_experiment.py` measures the
...
A_FILT = 0.0457                       # MEASURED, v103_filter_natural_experiment.py sec 4
