...
new cut 62 counts (`docs/HANDOFF-2026-08-06-v75-faulted-and-the-gate2-gain.md` §4). Those are
...
Usage:  python v78_symptom_cost.py   ->  writes _v78_cost.json
"""
import json
import pickle
import sys
...
with open(ROOT / "_v78_cost.json", "w", encoding="utf-8") as fh:
    json.dump(OUT, fh, indent=1, default=float)
print("\nwrote _v78_cost.json")
