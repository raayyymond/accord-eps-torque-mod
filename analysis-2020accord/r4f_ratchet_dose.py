#!/usr/bin/env python3
"""r4f_ratchet_dose.py -- is the ~7.5 Hz RATCHET dose-responsive in the r24 torque-rate lane?
...
without it (`r4f_ratchet_conditions.py`, C2). Routes differ enormously in how much railed-command
...
ARMS = [
    ("V61 r31  Kd 0.00x", "_cache_r31", "r31s", 0.00),
    ("V59 r2c  Kd 1.00x", "_cache_r2c", "r2cs", 1.00),
    ("V64 r35  Kd 1.00x", "_cache_r35", "r35s", 1.00),
    ("V62 r37  Kd 2.00x", "_cache_r37", "r37s", 2.00),
    ("V65 r3a  Kd 2.00x", "_cache_r3a", "r3as", 2.00),
    ("V65 r3b  Kd 2.00x", "_cache_r3b", "r3bs", 2.00),
    ("V67 r47  Kd 2.00x", "_cache_r47", "r47s", 2.00),
    ("V68 r4c  Kd 2.00x", "_cache_v68", "4cs", 2.00),
    ("V68 r4e  Kd 2.00x", "_cache_v68", "4es", 2.00),
    ("V69 r4f  Kd 4.00x", "_cache_r4f", "r4fs", 4.00),
]
...
def main():
    ...
    r4f = cell("V69 r4f  Kd 4.00x", "_cache_r4f", "r4fs", 4.0)
    ...
    allw = []
    for p in sorted(glob.glob(str(ROOT / "_cache_r4f" / "r4fs*.npz"))):
