...
axis (`docs/HANDOFF-2026-08-06-v75-faulted-and-the-gate2-gain.md` §3).
...
Two response axes, because they disagree and the disagreement is the finding:
  ...
  * limit-cycle DUTY at T = 600 counts, engaged creep, span 8-200  -- the ONSET axis, which
    `r5d_duty.py` established is the right headline for grind #1 (duty spans 64x, in-burst 1.24x).

Usage:  python v78_symptom_dose.py   ->  writes _v78_dose.json, plots/v78_dose_response.png
"""
import json
import pickle
import sys
...
with open(ROOT / "_v78_dose.json", "w", encoding="utf-8") as fh:
    json.dump(OUT, fh, indent=1, default=float)
print("wrote _v78_dose.json")
