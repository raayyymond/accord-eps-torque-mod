...
this session; the canonical memories (`reference/firmware/reference_accord_override_snap_state_machines.md`,
`project/project_accord_torque_mod_v0.md`, `reference/tooling/reference_accord_pointer_base_audit.md`,
`notes/EME_OVERRIDE_SM_NONVERIFIED.md`) should POINT here, not duplicate it. Pending: fold the
...
Builder: `analysis-2020accord/builds/v18_v49/build_v20_tva.py`. Method: decode validated V19 .rwd (cipher v9b
...
**Full analysis:** `notes/FUN_00043e44_FLOAT_MONITOR.md`  
...
- **FUN_00043e44 is REPORT-ONLY.** It is a float-domain watchdog that cross-checks the integer
  ...
  `reference/firmware/reference_accord_override_snap_state_machines.md` — the "dual-path int/float monitor" entry.)
