...
Companion to the **verified** record in `memory/reference/firmware/reference_accord_override_snap_state_machines.md`.
...
and `analysis-2020accord/notes/TORQUE_PATH_GUIDE.md` before using this.
...
## RESOLVED 2026-05-30 (drive-data + corrected-address re-trace) — see analysis-2020accord/notes/SESSION-2026-05-30-EME-RESOLUTION.md
Many §-items above are now closed; do not re-open without reading
`notes/SESSION-2026-05-30-EME-RESOLUTION.md`:
