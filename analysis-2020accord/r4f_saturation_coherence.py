...
Writes `_r4f_sat_coh.json`.  Usage: python r4f_saturation_coherence.py
"""
import json
import sys
import time
...
(HERE / "_r4f_sat_coh.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE / '_r4f_sat_coh.json'}")
