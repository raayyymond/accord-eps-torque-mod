#!/usr/bin/env python3
"""audit_wheelspeed_channel.py -- can the ABS wheel-speed message see a 50-150 Hz disturbance?
...
Usage:  python audit_wheelspeed_channel.py 4a 20 21 22 23 24 25
        python audit_wheelspeed_channel.py 47 5 6 7
"""
import sys
