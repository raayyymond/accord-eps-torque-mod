"""build_v14_tva.py — V14 LKAS 2x-torque build for the 2020 Accord (39990-TVA-A160).
...
edited DOWNSTREAM of the real magnitude stage.  See project_accord_torque_mod_v0.md and
reference_accord_lkas_window_ceiling.md / reference_accord_databin_tp_base.md.

WHAT V14 EDITS — the actual LKAS-torque magnitude binder (corrected 2026-05-26 eve):
  ...
  V14 = double the gain, and double the two output clamps so the doubled gain is not
...
# --- V14 calibration halfword edits (addr, current u16, new u16, note) -------------
...
def main():
    ...
    build("V14A", code, headers, tag="LKAS-2x-arbgain-clamps")
    return 0
