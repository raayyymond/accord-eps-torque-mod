...
Usage:
    python ledger_v38_to_v99_bytes.py            # everything: A + B1 + B2 + B3 + C, writes JSON
    python ledger_v38_to_v99_bytes.py diff V98 V99
    python ledger_v38_to_v99_bytes.py matrix | frozen | virgin | delta | mask
"""
import hashlib
import json
import os
