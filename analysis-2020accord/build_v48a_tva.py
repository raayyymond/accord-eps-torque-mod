"""
build_v48a_tva.py -- V48A = V38 + the state-4 ratchet fix + COMBINED CARRIER MUTE (cal-only).
...
WHY THESE TWO CARRIERS  [loop-gain model + six-agent audit, docs/VIBRATION-DOSSIER.md]
