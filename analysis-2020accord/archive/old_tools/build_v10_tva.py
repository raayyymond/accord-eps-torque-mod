...
Base recipe is the CONFIRMED V9b stock build (notes/HOW_TO_BUILD_ACCORD_TVA_RWD.md):
...
# --- the two torque Y-axis lists (notes/TORQUE_PATH_AND_TABLE.md §3c), 12 x int16 LE each ---
