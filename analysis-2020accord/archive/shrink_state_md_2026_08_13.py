#!/usr/bin/env python3
"""archive/shrink_state_md_2026_08_13.py -- move four now-superseded STATE.md sections to a new archive.

Companion to archive/shrink_state_md.py (kept, not overwritten) -- same discipline, different pass.
...
their durable facts already have dedicated homes: memory/accord/builds/accord-v94-flew-and-the-lane-is-a-damper.md,
memory/reference/measurement/reference-accord-steeringpressed-mask-excludes-the-symptom-regime.md,
memory/accord/mechanism/accord-rez-antidamping-replicated-three-drives.md, docs/BUILD-LINEAGE.md's V94/V96/V88 rows.

NEVER deletes: every archived section is written verbatim to
docs/archive/STATE-ARCHIVE-2026-08-13-v96-to-v99.md, with its original STATE.md line numbers, and a short
...
ARCHIVE = ROOT / "docs" / "archive/STATE-ARCHIVE-2026-08-13-v96-to-v99.md"
...
def main():
    ...
    arch_txt = [
        ...
        "",
        f"Split by `analysis-2020accord/archive/shrink_state_md_2026_08_13.py`.",
        "",
        "---",
        "",
        "## Contents",
