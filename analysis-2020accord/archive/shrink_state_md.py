#!/usr/bin/env python3
"""archive/shrink_state_md.py -- split docs/STATE.md into a CURRENT file and a verbatim ARCHIVE.
...
section is written verbatim to docs/archive/STATE-ARCHIVE-pre-V89.md with its original line numbers.
...
ARCHIVE = ROOT / "docs" / "archive/STATE-ARCHIVE-pre-V89.md"
...
def main():
    ...
    arch_txt = [
        ...
        "",
        f"Split by `analysis-2020accord/archive/shrink_state_md.py`. Source was {before} B / "
