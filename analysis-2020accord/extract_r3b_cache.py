#!/usr/bin/env python3
"""Extract V65 route `3b` (0000003b--a4a7f4dbf1) signals to .npz caches.

Same grid and decode conventions as extract_r37_cache.py: 0x14A src1 arrivals carry the probe and
...
Usage:  python extract_r3b_cache.py 0 1 2
"""
import json
import os
import sys
...
ROUTE = "75604b0a432fdc89_0000003b--a4a7f4dbf1"
OUT = Path(os.environ.get("R3B_CACHE", ROOT / "_cache_r3b"))
TAG = "r3b"
