#!/usr/bin/env python3
"""v75_fault_exact_model.py -- the EPS damping dose surface, mirroring FUN_00034350 EXACTLY.

(Companion to the lighter `v75_fault_surface.py`. This one hard-codes NOTHING: every table
constant is read little-endian out of the plain images via v75_fault_tables.py, the LERP is
