...
🛑 WHY THIS FILE EXISTS. `highway_order_test.py` reported the median per-window prominence-argmax
...
Usage:  python highway_meanspec.py
"""
import json
import sys
