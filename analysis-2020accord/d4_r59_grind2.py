...
PFX = {"_cache_r31": "r31s", "_cache_r2b": "r2bs", "_cache_r2c": "r2cs", "_cache_r35": "r35s",
       "_cache_r37": "r37s", "_cache_r3a": "r3as", "_cache_r3b": "r3bs", "_cache_r47": "r47s",
       "_cache_v68": "4es", "_cache_r4f": "r4fs", "_cache_r50": "r50s", "_cache_r54": "r54s",
       "_cache_r58": "r58s", "_cache_r59": "r59s"}
...
(ROOT / "_d4_r59_grind2.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {ROOT / '_d4_r59_grind2.json'}")
