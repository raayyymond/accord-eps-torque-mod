#!/usr/bin/env python3
"""v89_a5_engagement_model.py -- does ENGAGEMENT amplify the 6-9 Hz column mode, and does that
...
OUT = ROOT / "_cache_r73" / "v89_a5_engagement_model.json"
...
def load_windows():
    rows = []
    seen = set()          # 🛑 _cache_r66 and _cache_r66x hold the SAME route. Glob by ROUTE.
