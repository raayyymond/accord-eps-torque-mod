...
INSTRUMENT -- identical numerics to r58_ratchet.py / r50_ratchet.py:
...
json.dump(OUT, open(ROOT / "_r59_inventory.json", "w"), indent=1, default=float)
print(f"\nwrote {ROOT / '_r59_inventory.json'}")
