...
Registered in `docs/STATE.md` / `HANDOFF-2026-08-05-the-car-is-tvca4-and-both-dead-zones.md` BEFORE
V74 flew:
...
Usage:  python r5d_ratchet.py   ->  writes _r5d_ratchet.json
"""
import json
import sys
...
D.PARKED["V74/r5d"] = [2, 3, 9]                  # from the per-segment census -- see `r5d_bands.py`
L.install_fs()
...
with open(ROOT / "_r5d_ratchet.json", "w", encoding="utf-8") as fh:
    json.dump(OUT, fh, indent=1, default=float)
print("\nwrote _r5d_ratchet.json")
