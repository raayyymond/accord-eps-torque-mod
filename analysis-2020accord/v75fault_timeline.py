#!/usr/bin/env python3
"""v75fault_timeline.py -- locate and characterise the V75 hard fault on route 5e.

Reads `_cache_r5e/r5e.npz` (written by `v75fault_extract.py`). Everything here is Python + numpy;
