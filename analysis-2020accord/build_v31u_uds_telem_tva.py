"""build_v31u_uds_telem_tva.py - V31U = V31 drivability cal + CORRECTED UDS-over-CAN RAM telemetry.
...
This SUPERSEDES the earlier UDStelem build (build_uds_telem_tva.py), which had an off-by-one-ENTRY bug:
...
CAVE = 0x0C4E00
HANDLER = bytes.fromhex(                 # 72B, verbatim from build_uds_telem_tva.py (ABI verified)
