...
Same grid and decode conventions as extract_r31_cache.py (0x14A src1 arrivals carry the probe,
...
Usage:  python extract_r35_cache.py 0 1 2
"""
import json
import os
import sys
...
OUT = Path(os.environ.get("R35_CACHE", ROOT / "_cache_r35"))
