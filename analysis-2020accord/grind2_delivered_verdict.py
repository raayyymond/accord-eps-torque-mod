...
Usage:  python grind2_delivered_verdict.py
"""
import json
import sys
...
(HERE / "_grind2_delivered_verdict.json").write_text(json.dumps(OUT, indent=1), encoding="utf-8")
print(f"wrote {HERE / '_grind2_delivered_verdict.json'}")
