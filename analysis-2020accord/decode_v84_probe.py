#!/usr/bin/env python3
"""decode_v84_probe.py -- decode V84's `0x14A` byte-4 probe field, and REFUSE anything that is not V84.
...
Usage:
    python decode_v84_probe.py <route-dir-or-rlog> [...]
    python decode_v84_probe.py --selftest
"""
import sys
...
try:
    ...
    raise SystemExit(f"decode_v84_probe must sit beside build_v84_tva.py: {exc}")
