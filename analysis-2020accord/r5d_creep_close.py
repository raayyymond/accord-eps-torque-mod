...
1. THE CREEP-RESTRICTED STRATIFIED COMPARISON. `r5d_bands.py` section 3 stratifies over ALL speeds,
   and section 4's raw creep medians disagree with `r5d_duty.py`'s grind-active creep numbers
...
2. THE MDE OF THE BURST METRICS. `r5d_ratchet.py` reported duty/duration ratios with CIs but no MDE,
...
Usage:  python r5d_creep_close.py   ->  writes _r5d_creep_close.json
"""
import json
import pickle
import sys
...
with open(ROOT / "_r5d_creep_close.json", "w", encoding="utf-8") as fh:
    json.dump(OUT, fh, indent=1, default=float)
print("\nwrote _r5d_creep_close.json")
