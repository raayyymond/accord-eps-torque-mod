...
Writes `_r50_stiffness.json`.  Usage: python r50_stiffness.py
"""
import json
import sys
...
ROUTES = {"V70/r50": ("_cache_r50", "r50s", [0, 1, 2]),
          ...
          "V68/r4e": ("_cache_v68", "4es", [31, 32, 33, 34]),
...
(HERE / "_r50_stiffness.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE / '_r50_stiffness.json'}")
