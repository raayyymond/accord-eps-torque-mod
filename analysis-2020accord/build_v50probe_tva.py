"""
build_v50probe_tva.py -- V50-PROBE = V38 + READ-ONLY telemetry that reads gp-0x1500 (0xFEDF6B00) into
...
PURPOSE
    ...
    Decode with the existing decode_v49p_polarity.py (byte4>>3 & 0x1F, byte7>>6 & 0x3 -> gp-0x1500 low bits).
...
TECHNIQUE (identical to build_v49p_tva.py, which is identical to the flashed-and-driven V31P-V2)
...
def main():
    ...
    print("  Decode with decode_v49p_polarity.py: 330 byte4>>3&0x1F + byte7>>6&0x3 = gp-0x1500 low bits.")
