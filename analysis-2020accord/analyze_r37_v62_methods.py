...
POOLS = {"V59 r2c": str(ROOT / "_cache_r2c" / "r2cs*.npz"),
         "V64 r35": str(ROOT / "_cache_r35" / "r35s*.npz"),
         "V61 r31": str(ROOT / "_cache_r31" / "r31s*.npz"),
         "V62 r37": str(ROOT / "_cache_r37" / "r37s*.npz")}   # seg 0 INCLUDED -- it is real driving
CAP = 5.35
...
def main():
    ...
    print("   that argmax is the ratchet's 3rd harmonic (see analyze_r37_v62_harmonic.py), so the")
