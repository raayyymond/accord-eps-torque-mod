#!/usr/bin/env python3
"""v89_g1_cmd_column_phase.py -- is `0xC40D4`'s 2-pole EMA a MODEL OF THE PLANT LAG, or smoothing?
...
def build_grid():
    ...
    # `rlog-tools/v89_i1_can_order.py`), so a row carries the last 0x18F strictly BEFORE it.
