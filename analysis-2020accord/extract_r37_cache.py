...
Same grid and decode conventions as extract_r31_cache.py / extract_r35_cache.py: 0x14A src1
...
Usage:  python extract_r37_cache.py 0 1 2
"""
import json
import os
import sys
...
OUT = Path(os.environ.get("R37_CACHE", ROOT / "_cache_r37"))
