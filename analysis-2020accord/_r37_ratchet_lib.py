...
ROUTES = [
    ...
    ("2c/V59",    C.ROOT / "_cache_r2c", "r2cs", [0, 1, 3, 4, 8, 9, 10, 11, 12]),
    ("31/V61",    C.ROOT / "_cache_r31", "r31s", [0, 1, 2, 3]),
    ("35/V64=V59", C.ROOT / "_cache_r35", "r35s", [0, 1, 2]),
    ("37/V62",    C.ROOT / "_cache_r37", "r37s", list(range(0, 15))),   # seg 0 INCLUDED
]

# Route-37 wall clock: single continuous boot clock, one offset for all 15 segments.
# Fitted over the post-NTP-sync clocks cluster by r37_wallclock.py (sd 0.054 s).
