#!/usr/bin/env python3
"""r70_ratchet_dose_response.py -- is the ~7.5 Hz RATCHET dose-responsive across V67 / V68 / V69?
...
METHOD -- identical estimator, cell, and null machinery as `r4f_v69_readout.py`, applied route by
...
Usage:  python r70_ratchet_dose_response.py
"""
import os
import sys
