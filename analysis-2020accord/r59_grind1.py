...
`r58_grind1.py` §2, so the verdicts are directly comparable.
...
Writes `_r59_grind1.json`.  Usage: python r59_grind1.py [ep|blk]
"""
import json
import sys
...
(HERE.parent / "_r59_grind1.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE.parent / '_r59_grind1.json'}")
