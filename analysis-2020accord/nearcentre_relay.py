...
Usage: python nearcentre_relay.py [ep|blk] -> writes _nearcentre_relay.json
"""
import json
import sys
...
(HERE.parent / "_nearcentre_relay.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE.parent / '_nearcentre_relay.json'}")
