...
See memory/accord-a-caveat-can-mutate-into-a-result.md.
...
# --- V52C's repoint set, read from build_v52c_tva.py: BASE(7) + EXTRA(3) + BROAD(9) = 19 sites -------
V52C_REPOINTED = {
...
# gp-0x4f62 read/store pair. build_v52c_tva.py leaves it RAW deliberately, classified as part of "the
