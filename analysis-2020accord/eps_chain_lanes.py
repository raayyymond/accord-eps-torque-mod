"""eps_chain_lanes.py -- SECTIONS 2-3 of the golden model: CAN intake and the LKAS setpoint, the
driver torque sensor and voter, base driver assist, the boost index, and the assist-shaping rate
lanes. Split out of `eps_lkas_chain_model.py` on 2026-08-12 to keep every mandatory-read file under
