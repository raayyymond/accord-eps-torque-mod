#!/usr/bin/env python3
"""build_v77_tva.py -- SINGLE-VARIABLE REVERT of `0xC63A0` 2048 -> 1024 (back to STOCK).
...
# 🛑 The default in firmware_paths.py is STALE (`../accord-firmware`, singular). Set before import.
