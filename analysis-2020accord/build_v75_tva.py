#!/usr/bin/env python3
"""build_v75_tva.py -- V75 = V74 CARRIED, with the dose cranked 2.74x and a MAGNITUDE probe.
...
DECODER = os.path.join(HERE, "..", "rlog-tools", "decode_v75_probe.py")
...
def build():
    ...
    if assert_decoder_matches(cave_bytes):
        print("    ✅ rlog-tools/decode_v75_probe.py CAVE_HEX matches the built cave byte-for-byte.")
