...
Usage:
    ...
    python analyze_r47_grind1.py            # everything (~2 min; records cached after first run)
    python analyze_r47_grind1.py s0 s3      # named sections only
    R47_FORCE=1 python analyze_r47_grind1.py    # rebuild the window-record cache
"""
import json
import os
import pickle
...
RECS = ROOT / "_cache_r47" / "r47_grind1_records.pkl"
C47 = ROOT / "_cache_r47"
...
def s7_occupancy(st):
    ...
    print("   Estimator mirrors v66_v67_explained.py SECTION 6: CREEP windows, TOP DECILE of the")
