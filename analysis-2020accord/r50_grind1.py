...
Writes `_r50_grind1.json`.  Usage: python r50_grind1.py [ep|blk]
"""
import json
import sys
...
(HERE / "_r50_grind1.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE / '_r50_grind1.json'}")
