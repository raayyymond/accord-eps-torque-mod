#!/usr/bin/env python3
"""v75_step_rolling_null.py -- CORRECTED nulls for the two paired statistics.

🛑 The split-half null in v75_step_rolling.py §6 is MIS-SPECIFIED and is retracted here.
