...
d4_r59_ratchet.py established: engaged hands-off creep 12/19 = 63% at >=1200 counts p-p (quartet
...
(ROOT / "_d4_r59_where.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {ROOT / '_d4_r59_where.json'}")
