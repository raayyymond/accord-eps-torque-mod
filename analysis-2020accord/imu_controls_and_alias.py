#!/usr/bin/env python3
"""imu_controls_and_alias.py -- data-driven IMU controls, and the honest alias verdict.

Supersedes the hand-drawn windows in imu_grind_spectra.py. Every window set here is SELECTED BY THE
