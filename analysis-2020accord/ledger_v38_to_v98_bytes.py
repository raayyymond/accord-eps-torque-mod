...
Successor to `ledger_v38_to_v84_bytes.py` (kept, not overwritten) and `ledger_v94_cells.py`.
...
Usage:
    python ledger_v38_to_v98_bytes.py            # everything: A + B1 + B2 + B3 + C, writes JSON
    python ledger_v38_to_v98_bytes.py diff V97 V98
    python ledger_v38_to_v98_bytes.py matrix | frozen | virgin | delta | mask
"""
import hashlib
import json
import os
