...
Two earlier passes disagreed and both were under-specified:
  * `highway_fast_lane.py` §2 reported implied order p50 = 3.00 AND a Theil-Sen slope of -0.20
  ...
  * `highway_event_hunt.py` §4's per-band "MODE" verdicts are band-censored (a 9 Hz band cannot
...
Usage:  python highway_order_test.py
"""
import json
import sys
