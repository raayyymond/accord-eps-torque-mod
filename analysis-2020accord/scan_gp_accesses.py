#!/usr/bin/env python3
"""scan_gp_accesses.py -- raw-byte census of every gp/tp-relative load and store to a given cell.
...
USAGE
    python scan_gp_accesses.py 0x683c 0x6446 ...        # gp-relative cell offsets (positive number
...
def self_check(img):
    ...
    Every one of these is quoted in build_v65_tva.py / the V64 build note as Ghidra
