#!/usr/bin/env python3
"""T5 -- extends `v78_symptom_dose.py`'s damper dose-response ladder with V76/r65 (k=1.3866).

Method is COPIED, not reinvented, from `v78_symptom_dose.py` DELIVERABLE 2/3 (the log-linear fit of
...
Usage:  python v77sizing_dose.py  ->  writes _v77sizing_dose.json, plots/v77sizing_dose_response.png
"""
import json
import sys
...
with open(ROOT / "_v77sizing_dose.json", "w", encoding="utf-8") as fh:
    json.dump(OUT, fh, indent=1, default=float)
print("wrote _v77sizing_dose.json")
