...
# -*- coding: utf-8 -*-
"""
eps_loop_gain_model.py  --  QUANTITATIVE control-theory model of the 2020 Accord
...
modify the golden model eps_lkas_chain_model.py -- that file was read only for
grounding. Run:  python eps_loop_gain_model.py

=====================================================================================
 PROVENANCE OF INPUTS  --  MEASURED vs MODEL ASSUMPTION (kept strictly separate)
=====================================================================================
MEASURED (route b9 telemetry, V38, raw CAN 399 @ ~100 Hz; see docs/VIBRATION-DOSSIER.md
and eps_lkas_chain_model.py::vibration_hands_off_analysis):
...
LITERATURE (corroboration, docs/VIBRATION-DOSSIER.md sec.8):
...
def task4():
    ...
    # docs/HANDOFF-2026-07-21-v48b-flashed-catastrophic.md):
