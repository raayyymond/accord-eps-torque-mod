...
WHY THIS IS NEEDED.  `studies/acoustic/acoustic_positive_control.py` showed the mic is blind to the 21-28 Hz mode:
...
json.dump({'speed_slopes': SLOPES, 'blinker': OUT},
          open(os.path.join(A.HERE, '_scratch/out/_acoustic_audible_control.json'), 'w'), indent=1)
print("\n  wrote _scratch/out/_acoustic_audible_control.json")
