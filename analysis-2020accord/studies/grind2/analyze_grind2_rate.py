...
Usage:  python studies/grind2/analyze_grind2_rate.py
"""
...
OUTJSON = HERE / "_scratch/out/_grind2_rate.json"
...
def main():
    ...
    import pickle
    with open(HERE.parent / "_scratch/data/_cache_grind2_records.pkl", "rb") as fh:
