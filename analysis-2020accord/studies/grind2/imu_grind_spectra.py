#!/usr/bin/env python3
"""studies/grind2/imu_grind_spectra.py -- does the comma IMU see grind #2, and can its grid break the alias?
...
if __name__ == "__main__":
    ...
    (ROOT / "_scratch/cache/r3a" / "imu_alias.json").write_text(json.dumps(out, default=float))
