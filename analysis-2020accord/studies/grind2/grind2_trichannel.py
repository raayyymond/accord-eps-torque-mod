#!/usr/bin/env python3
"""studies/grind2/grind2_trichannel.py -- the three logged channels on the SAME grind #2 events.
...
WHAT EACH CHANNEL CAN WITNESS (from `model/eps_lkas_chain_model.py` + the post-V38 record)
...
(`env_full`), which is the estimator `studies/grind2/locate_grind2_demos.py` used to define the burst list and the
...
Usage:  python studies/grind2/grind2_trichannel.py [--quick]
"""
...
OUT = HERE / "_scratch/out/_grind2_trichannel.json"
