...
Emits `_scratch/cache/r78/v93_curves.json` for the diagrams.
"""
import json
import struct
import sys
...
if __name__ == "__main__":
    ...
    (ROOT / "_scratch/cache/r78" / "v93_curves.json").write_text(json.dumps(OUT, indent=1, default=float))
    print("\n  wrote _scratch/cache/r78/v93_curves.json")
