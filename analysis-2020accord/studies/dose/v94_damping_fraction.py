...
🛑🛑 SUPERSEDED BY MEASUREMENT, 2026-08-12 — THE NUMBERS BELOW ARE WRONG. DO NOT CITE THEM.
    ...
    See `memory/feedback/builds/feedback-reducing-a-gain-is-not-a-safety-class.md` for why this matters as a rule:
...
THE CLAIM THIS FILE TESTS
    `docs/STATE.md` and `memory/accord/signals/accord-gp6b26-is-inertia-not-damping.md` say `gp-0x6b26 = -K*alpha`
