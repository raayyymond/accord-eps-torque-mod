#!/usr/bin/env python3
r"""DELIVERED-BYTES LEDGER, STOCK -> V99.  Reads the PLAIN IMAGES ON DISK, never the build scripts.
...
Usage:
    python studies/ledger/ledger_v38_to_v99_bytes.py            # everything: A + B1 + B2 + B3 + C, writes JSON
    python studies/ledger/ledger_v38_to_v99_bytes.py diff V98 V99
    python studies/ledger/ledger_v38_to_v99_bytes.py matrix | frozen | virgin | delta | mask
"""
import hashlib
import json
import os
...
TARGET = os.environ.get("LEDGER_TARGET", "V99")
PREV_ON_CAR = "V98"          # what was on the car before TARGET
