...
Usage:
    python studies/ledger/ledger_v94_cells.py diff                 # STOCK vs V94
    python studies/ledger/ledger_v94_cells.py diff V92 V94         # any PAIR, by build tag
    python studies/ledger/ledger_v94_cells.py diff V92 _v95_FOO_plain_image.bin    # or by filename / glob /
                                                    #   absolute path, for a build not yet in BUILDS
    python studies/ledger/ledger_v94_cells.py matrix
    python studies/ledger/ledger_v94_cells.py grid
    python studies/ledger/ledger_v94_cells.py mask
