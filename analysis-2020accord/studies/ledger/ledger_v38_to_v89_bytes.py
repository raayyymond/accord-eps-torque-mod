#!/usr/bin/env python3
"""DELIVERED-BYTES LEDGER, V38 -> V89.  Extends studies/ledger/ledger_v38_to_v84_bytes.py through V85-V89.
...
Written for the 2026-08-10 ARC AUDIT (docs/review/ARC-AUDIT-2026-08-10.md). Extends the V38->V84 reader
