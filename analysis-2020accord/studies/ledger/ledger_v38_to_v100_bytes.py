...
Successor to `studies/ledger/ledger_v38_to_v84_bytes.py`, `studies/ledger/ledger_v94_cells.py` and `studies/ledger/ledger_v38_to_v98_bytes.py`
...
Usage:
    python studies/ledger/ledger_v38_to_v100_bytes.py            # everything: A + B1 + B2 + B3 + C, writes JSON
    python studies/ledger/ledger_v38_to_v100_bytes.py diff V98 V99
    python studies/ledger/ledger_v38_to_v100_bytes.py matrix | frozen | virgin | delta | mask
"""
import hashlib
import json
import os
...
BUILDS = [
    ...
    # ---- V100, added by studies/ledger/ledger_v38_to_v100_bytes.py (V101 arc-map pass, 2026-08-13)
...
_V98 = "builds/v80_v107/build_v98_tva.py FROZEN"
_V96 = "builds/v80_v107/build_v96_tva.py FROZEN"
_V94L = "studies/ledger/ledger_v94_cells.py MATRIX_SCALARS"
_V38B = "builds/v18_v49/build_v38_tva.py"
_V87B = "builds/v80_v107/build_v87_tva.py"
...
SITES = [
    ...
    (0x35A06, 4, "raw", "V103 biquad ARM-SOURCE (ld.bu -0x671a[gp],r9 -> -0x6806[gp],r9)", "builds/v80_v107/build_v103_tva.py"),
    (0x35A12, 2, "raw", "V103 biquad ARM cmp (cmp r12,r9 -> cmp r0,r9)", "builds/v80_v107/build_v103_tva.py"),
    (0x35A18, 4, "raw", "V103 biquad ARM setfnc/setfne", "builds/v80_v107/build_v103_tva.py"),
    ...
    (0xC6158, 2, True, "ceiling tp+0x7158 fallback", "studies/ledger/ledger_v38_to_v84_bytes.py SITES"),
    ...
    (0xC61DA, 2, True, "Q10 integrator scale", "studies/ledger/ledger_v38_to_v84_bytes.py SITES"),
    ...
    (0xC6316, 2, True, "governor vehicle-speed cal ~10 km/h", "studies/ledger/ledger_v38_to_v84_bytes.py SITES"),
    ...
    (0xC6450, 2, True, "V46 lever", "studies/ledger/ledger_v38_to_v84_bytes.py SITES"),
    ...
    (0xC64C8, 1, False, "aggregator mode selector", "studies/ledger/ledger_v38_to_v84_bytes.py SITES"),
    (0xC64C9, 1, False, "blend mux", "studies/ledger/ledger_v38_to_v84_bytes.py SITES"),
    (0xC64DE, 2, False, "legacy re-engage ramp ('RAMPSTEP', label disputed)", _V94L),
    (0xC64FA, 1, False, "CEIL byte cal", "studies/ledger/ledger_v38_to_v84_bytes.py SITES"),
    (0xC649B, 1, False, "biquad ARM byte (Honda dormant FUN_000352b4 notch, 00=disarmed/01=armed)", "builds/v80_v107/build_v103_tva.py"),
    (0xC60A8, 4, "f", "biquad c1 -- pole coeff a1", "builds/v80_v107/build_v103_tva.py + reference_accord_biquad_is_a_notch..."),
    (0xC60AC, 4, "f", "biquad c2 -- pole coeff a2", "builds/v80_v107/build_v103_tva.py + reference_accord_biquad_is_a_notch..."),
    (0xC60B0, 4, "f", "biquad c3 -- zero coeff b1", "builds/v80_v107/build_v103_tva.py + reference_accord_biquad_is_a_notch..."),
    (0xC60B4, 4, "f", "biquad c4 -- overall gain g (proposed lever, records-sweep 2026-08-21)", "builds/v80_v107/build_v103_tva.py + reference_accord_biquad_is_a_notch..."),
...
SITES = [(s if len(s) == 5 else (*s, "studies/ledger/ledger_v38_to_v84_bytes.py SITES")) for s in SITES]
...
SETPOINT_PTR = 0xCB844          # builds/v18_v49/build_v38_tva.py SETPOINT_PTR_ARRAY
MODES = [10, 11, 12, 24, 25, 26, 27]

FLASH_LO, FLASH_HI = 0x13000, 0x100000
# The cave arena.  builds/v80_v107/build_v96_tva.py puts the last real calibration family at [0xC4000, 0xC4B34);
...
# builds/v18_v49/build_v38_tva.py: [u16 n][9 x u16 X][9 x u16 Y][u16 pad], stride 0x28, Y at record + 0x14.
SETPOINT_STRIDE, SETPOINT_Y_OFF, SETPOINT_N, SETPOINT_SELECTORS = 0x28, 0x14, 9, 12
SETPOINT_LIVE_SELECTOR = 1          # builds/v18_v49/build_v38_tva.py: A160 == variant slot 2, key 'TVAA1'
...
def generated_sites(st):
    ...
    (builds/v80_v107/build_v98_tva.py: 'AN ADDRESS IS NOT A MODE'.)"""
    gen = []
