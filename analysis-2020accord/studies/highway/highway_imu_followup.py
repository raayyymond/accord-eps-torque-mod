...
§2 of studies/highway/highway_event_hunt.py found, at threshold 10x the Kd=1 speed-band median:
...
Usage:  python studies/highway/highway_imu_followup.py
"""
...
OUT = HERE / "_scratch/out/_hwy_imu_followup.json"
