...
`studies/highway/highway_imu_followup.py` established that the IMU 30-49 Hz events concentrate ABOVE 28 m/s:
...
Usage:  python studies/highway/highway_fast_lane.py
"""
...
OUT = HERE / "_scratch/out/_hwy_fast_lane.json"
VFAST = 28.0
CIRC = H.CIRC
NFFT = 256
