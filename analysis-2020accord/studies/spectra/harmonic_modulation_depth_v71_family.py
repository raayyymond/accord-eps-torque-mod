#!/usr/bin/env python3
"""
studies/spectra/harmonic_modulation_depth_v71_family.py -- modulation depth (r24/gain_B and r26/gain_A) across
stock + the flown/built rate-lane configs, PARAMETERISED on the operating range of gp-0x6ac0.

Extends analysis-2020accord/studies/sessions/v70/v70_parametric_gain_collapse.py (r24 only) with r26 and the V71 family.
...
_root = Path(_env) if _env else Path(__file__).resolve().parents[4] / "accord-firmwares"
