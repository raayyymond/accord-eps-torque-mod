...
Usage:  python studies/sessions/r4f/r4f_lanechange_dose.py [--rebuild]
"""
...
PKL = ROOT / "_scratch/data/_cache_lanechange_dose.pkl"

# route -> cache, prefix, build image key, and whether the ENGAGED arm is the dosed one
ROUTES = {
    "r2b/V58": ("_scratch/cache/r2b", "r2bs", "V58", True),
    "r2c/V59": ("_scratch/cache/r2c", "r2cs", "V59", True),
    "r35/V64": ("_scratch/cache/r35", "r35s", "V64", True),
    "r31/V61": ("_scratch/cache/r31", "r31s", "V61", True),
    "r37/V62": ("_scratch/cache/r37", "r37s", "V62", True),
    "r3a/V65": ("_scratch/cache/r3a", "r3as", "V65", True),
    "r3b/V65": ("_scratch/cache/r3b", "r3bs", "V65", True),
    "r47/V67": ("_scratch/cache/r47", "r47s", "V67", True),
    "r4a/V67": ("_scratch/cache/r4a", "r4as", "V67", True),
    "4e/V68":  ("_scratch/cache/v68", "4es", "V68", True),
    "4c/V68":  ("_scratch/cache/v68", "4cs", "V68", True),
    "4f/V69":  ("_scratch/cache/r4f", "r4fs", "V69", True),
}
...
def main():
    ...
    ap.add_argument("--json", default=str(HERE / "_scratch/out/_r4f_lanechange_dose.json"))
    a = ap.parse_args()
