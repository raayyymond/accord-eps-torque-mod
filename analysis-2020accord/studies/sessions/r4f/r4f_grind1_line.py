...
Writes `_scratch/out/_r4f_line.json`.  Usage: python studies/sessions/r4f/r4f_grind1_line.py
"""
...
(HERE / "_scratch/out/_r4f_line.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE / '_scratch/out/_r4f_line.json'}")
