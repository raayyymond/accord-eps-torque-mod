...
A. THE POSITIVE CONTROL, DONE PROPERLY. `studies/sessions/r4f/r4f_highway_bands.py` reports the 8-30 Hz peak as the
...
C. THE CREEP MANEUVER CONTRAST. Section 4 of `studies/sessions/r4f/r4f_highway_bands.py` returned ZERO control windows
...
Usage:  python studies/sessions/r4f/r4f_followups.py [--json OUT]
"""
...
def main():
    ...
    ap.add_argument("--json", default=str(HERE / "_scratch/out/_r4f_followups.json"))
    a = ap.parse_args()
