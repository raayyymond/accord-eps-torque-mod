...
Usage:  python studies/sessions/r4f/r4f_highway_bands.py [--json OUT]
"""
...
ROUTES = {
    "4f/V69": dict(cache=ROOT / "_scratch/cache/r4f", pfx="r4fs", segs=list(range(8)), kd_hwy=1.000),
    "4e/V68": dict(cache=ROOT / "_scratch/cache/v68", pfx="4es", segs=[31, 32, 33, 34], kd_hwy=2.000),
}
RES: dict = {}
...
def main():
    ...
    ap.add_argument("--json", default=str(HERE / "_scratch/out/_r4f_highway.json"))
    a = ap.parse_args()
