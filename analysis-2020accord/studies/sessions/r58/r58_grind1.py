...
Writes `_scratch/out/_r58_grind1.json`.  Usage: python studies/sessions/r58/r58_grind1.py [ep|blk]
"""
...
# for any eng/man contrast. (`studies/sessions/r50/r50_grind1.py` ss6 carries this defect; its `eng_vs_man` block is
...
(HERE.parent / "_scratch/out/_r58_grind1.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE.parent / '_scratch/out/_r58_grind1.json'}")
