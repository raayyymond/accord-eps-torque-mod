...
Writes `_scratch/out/_r58_grind2.json`.  Usage: python studies/sessions/r58/r58_grind2.py
"""
...
SKIP = {"_scratch/cache/r54": ("r54s10.npz", "r54s11.npz"),
        "_scratch/cache/r58": ("r58s12.npz", "r58s13.npz", "r58s14.npz", "r58s15.npz"),
        "_scratch/cache/r50": ("r50s0.npz",)}
...
(ROOT / "_scratch/out/_r58_grind2.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {ROOT / '_scratch/out/_r58_grind2.json'}")
