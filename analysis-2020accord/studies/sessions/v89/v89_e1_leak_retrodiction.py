#!/usr/bin/env python3
"""studies/sessions/v89/v89_e1_leak_retrodiction.py -- retrodict the OBSERVER-LEAK hypothesis on already-flown data.
...
OUT = ROOT / "_scratch/cache/r73" / "v89_e1_leak.json"
