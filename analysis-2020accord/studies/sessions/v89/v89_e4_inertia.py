...
OUTJ = ROOT / "_scratch/cache/r75" / "v89_e4_inertia.json"

ARMS = {"V88/r73": (ROOT / "_scratch/cache/r73", "r73s", list(range(11))),
        "V89/r75": (ROOT / "_scratch/cache/r75", "r75s", list(range(16))),
        "V89/r76": (ROOT / "_scratch/cache/r76", "r76s", list(range(13)))}
NFFT, HOP = 256, 128
