#!/usr/bin/env python3
"""studies/sessions/v89/v89_e2_leak_robustness.py -- does the v89_e1 wrong-direction result survive its own controls?
...
OUT = Path(__file__).resolve().parents[3].parent / "_scratch/cache/r73" / "v89_e2_robust.json"
