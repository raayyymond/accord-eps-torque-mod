#!/usr/bin/env python3
"""studies/sessions/v89/v89_f1_residual_probe.py -- does the observer residual `gp-0x6b70` respond to LKAS ENGAGEMENT?
...
OUT = ROOT / "_scratch/cache/r73" / "v89_f1_residual.json"
