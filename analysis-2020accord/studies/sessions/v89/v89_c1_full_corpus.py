#!/usr/bin/env python3
"""studies/sessions/v89/v89_c1_full_corpus.py -- load EVERY usable route since V38, not just the 12 with a whole-route npz.
...
WHAT THIS FIXES
  ...
  * `_scratch/cache/r66` / `_scratch/cache/r66x` are the same route -- deduped by ROUTE key, not by directory
  * `_scratch/cache/v68` holds routes 4c/4e under their own stems
...
OUT = ROOT / "_scratch/cache/r73" / "v89_c1_corpus.npz"
