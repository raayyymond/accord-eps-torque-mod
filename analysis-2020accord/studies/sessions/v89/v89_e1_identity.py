...
ROUTES = {"73": ("_scratch/cache/r73", "r73", "V88 (control -- cave and 427 read the SAME cell)"),
          "75": ("_scratch/cache/r75", "r75", "V89?"),
          "76": ("_scratch/cache/r76", "r76", "V89?")}
...
if __name__ == "__main__":
    ...
    json.dump(res, open(ROOT / "_scratch/cache/r75" / "v89_e1_identity.json", "w"), indent=1, default=float)
