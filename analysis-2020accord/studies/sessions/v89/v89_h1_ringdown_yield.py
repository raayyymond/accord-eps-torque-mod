#!/usr/bin/env python3
"""studies/sessions/v89/v89_h1_ringdown_yield.py -- how many usable ring-down edges exist in the WHOLE corpus?
...
CRITERIA -- taken verbatim from `_scratch/cache/r73/v88_d7_ringdown_speed.py`, with the orchestrator's
...
OUT = ROOT / "_scratch/cache/r73" / "v89_h1_yield.json"
