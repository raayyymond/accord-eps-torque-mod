#!/usr/bin/env python3
"""studies/sessions/v89/v89_c3_friction_relay.py -- is the ENGAGEMENT-gated 6-9 Hz amplification the command-proportional
...
OUT = ROOT / "_scratch/cache/r73" / "v89_c3_friction.json"
