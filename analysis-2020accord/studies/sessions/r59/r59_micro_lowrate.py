...
Episode-clustered CIs throughout. Writes `_scratch/out/_r59_lowrate.json`.
"""
...
json.dump(OUT, open(ROOT / "_scratch/out/_r59_lowrate.json", "w"), indent=1, default=float)
print(f"\nwrote {ROOT / '_scratch/out/_r59_lowrate.json'}")
