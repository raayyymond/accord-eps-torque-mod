...
re-centred. Writes `_scratch/out/_r59_power.json`.
"""
...
json.dump(OUT, open(ROOT / "_scratch/out/_r59_power.json", "w"), indent=1, default=float)
print(f"\nwrote {ROOT / '_scratch/out/_r59_power.json'}")
