...
Writes `_scratch/out/_r59_structure.json`.
"""
...
json.dump(OUT, open(ROOT / "_scratch/out/_r59_structure.json", "w"), indent=1, default=float)
print(f"\nwrote {ROOT / '_scratch/out/_r59_structure.json'}")
