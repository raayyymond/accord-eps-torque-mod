...
Writes `_scratch/out/_r59_alternatives.json`.
"""
...
json.dump(OUT, open(ROOT / "_scratch/out/_r59_alternatives.json", "w"), indent=1, default=float)
print(f"\nwrote {ROOT / '_scratch/out/_r59_alternatives.json'}")
