...
★ WHY THE CHANNEL TEST MATTERS. studies/sessions/r59/d4_r59_ratchet.py says the 7.79 Hz ratchet is UNCHANGED on V72:
...
amplitude at the 6-9 Hz hits, per build, with the identical instrument (`studies/sessions/r58/r58_ratchet.py` §7).
...
Writes `_scratch/out/_d4_r59_feel.json`.
"""
...
(ROOT / "_scratch/out/_d4_r59_feel.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {ROOT / '_scratch/out/_d4_r59_feel.json'}")
