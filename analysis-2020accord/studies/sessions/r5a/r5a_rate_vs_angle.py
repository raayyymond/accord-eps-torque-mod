...
deg/s). This file tests that claim on `_scratch/cache/r5a` WITHOUT assuming it, because a contradiction would
...
with open(ROOT / "_scratch/out/_r5a_rate_vs_angle.json", "w") as fh:
    json.dump(out, fh, indent=1, default=float)
print("\nwrote _scratch/out/_r5a_rate_vs_angle.json")
