...
METHOD A is `studies/sessions/r31/analyze_r31_manual_vs_engaged.py` verbatim (imported, not re-implemented), so the V64
...
POOLS = {"V59  route 2c": str(ROOT / "_scratch/cache/r2c" / "r2cs*.npz"),
         "V61  route 31": str(ROOT / "_scratch/cache/r31" / "r31s*.npz"),
         "V64  route 35": str(ROOT / "_scratch/cache/r35" / "r35s*.npz")}
