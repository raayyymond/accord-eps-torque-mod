...
def arm(build, segs=None, vlo=0.3, vhi=5.35, eff=None, engaged=True, nfft=NFFT, vsel=None,
    ...
    once already (studies/sessions/r31/analyze_r31_matched.py M1).
...
def c5_shift():
    ...
    print("   studies/models/rate_lane_damping_model.py: omega_n^2 = A + B*Kd. V61 is Kd=0, V59/V64 are Kd=1,")
