...
"""V62 route `37` supplement -- the three things the headline script leaves open.
  ...
  2. EFFORT. V62's creep windows sit at different driver effort from V59's, and on this platform
     ...
     Nearest-neighbour matching on (|v|, effort), the method of studies/sessions/r31/analyze_r31_matched.py.
...
Read with studies/sessions/r37/analyze_r37_v62_creep.py; conventions are imported from _r31_common, not restated.
"""
...
ROAD_37 = list(range(0, 13))     # seg 0 INCLUDED -- real driving, see studies/sessions/r37/analyze_r37_v62_creep.py
LOT_37 = [13, 14]
