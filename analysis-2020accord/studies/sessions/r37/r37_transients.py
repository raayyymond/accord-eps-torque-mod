...
Usage:  python studies/sessions/r37/r37_transients.py
"""
...
BUILDS = {
    "V62": ("_scratch/cache/r37", "r37s", list(range(15))),
    "V59": ("_scratch/cache/r2c", "r2cs", [0, 1, 3, 4, 8, 9, 10, 11, 12]),
    "V61": ("_scratch/cache/r31", "r31s", [0, 1, 2, 3]),
    "V64": ("_scratch/cache/r35", "r35s", [0, 1, 2]),
}
