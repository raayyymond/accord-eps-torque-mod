#!/usr/bin/env python3
"""studies/sessions/r47/r47_rate_axis.py -- put grind #1, grind #2-creep and grind #2-HIGHWAY on the r24 gain SURFACE.
...
🛑 This RESOLVES the discrepancy flagged as open in memory/accord/calibration/accord-r24-gain-b-four-pointer-arrays.md
...
Usage:  python studies/sessions/r47/r47_rate_axis.py            # full run, ~2 min
        python studies/sessions/r47/r47_rate_axis.py --quick    # skip the bootstrap CIs
"""
...
def main():
    ...
    print(f"{'=' * 108}\n== studies/sessions/r47/r47_rate_axis.py -- symptoms on the r24 gain SURFACE\n{'=' * 108}")
    _selftest(rng)
    rate_copy_check()
    ...
    print(f"\n   🛑 BUILD TRIPWIRE. builds/v50_v79/build_v62_tva.py's GAIN_B_LERP_MODE10 assertion watches ONLY "
...
def maneuver_axis():
    ...
    standing in for a measurement:
      (a) the maneuver episodes in _scratch/cache/r47/r47_maneuvers.json, read span-by-span;
    ...
    print(f"\n{'=' * 108}\n== ADDENDUM 1 -- THE HIGHWAY MANEUVER OPERATING POINT (the deciding "
          f"coordinate)\n{'=' * 108}")
    p = ROOT / "_scratch/cache/r47" / "r47_maneuvers.json"
    cache = {}
