#!/usr/bin/env python3
"""studies/sessions/r47/analyze_r47_imu.py -- route 47 (V67) on the comma IMU, the kit's only EPS-independent witness.
...
Usage:  python studies/sessions/r47/analyze_r47_imu.py                # every section, ~25 min
        python studies/sessions/r47/analyze_r47_imu.py rate axis hw   # just those
Re-extract the caches first if they are missing (adds r47 to extract/extract_imu_cache.py's tables):
        python extract/extract_imu_cache.py r47          # 26 segments, ~40 s
...
OUT = HERE / "_scratch/out/_r47_imu_results.json"
RESULTS = {}
...
def sec_hw(amap):
    ...
    try:
        ...
        print(f"     rate-lane gain than V65 did. This is a real, pre-documented residual "
              f"(builds/v50_v79/build_v67_tva.py lines 112-115),")
