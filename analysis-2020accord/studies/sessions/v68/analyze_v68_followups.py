#!/usr/bin/env python3
"""Three follow-ups the first V68 pass forced. Run after studies/sessions/v68/analyze_v68_highway_arms.py.
...
def main():
    ...
    Path(HERE / "_scratch/out/_v68_followups.json").write_text(json.dumps(res, indent=1, default=str))
    print(f"wrote {HERE / '_scratch/out/_v68_followups.json'}")
