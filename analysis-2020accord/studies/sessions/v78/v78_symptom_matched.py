...
`studies/sessions/v78/v78_symptom_null.py` matches on speed alone. Grind #1 is documented as occurring "at 5 mph with the
...
Usage:  python studies/sessions/v78/v78_symptom_matched.py   ->  writes _scratch/out/_v78_matched.json
"""
...
with open(ROOT / "_scratch/out/_v78_matched.json", "w", encoding="utf-8") as fh:
    json.dump(OUT, fh, indent=1, default=float)
print("\nwrote _scratch/out/_v78_matched.json")
