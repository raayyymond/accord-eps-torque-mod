...
and `memory/feedback/measurement/feedback-episodes-not-windows.md` requires the resampling unit to be counted before any
...
Usage:  python studies/sessions/v78/v78_symptom_census.py   ->  writes _scratch/out/_v78_census.json
"""
...
with open(ROOT / "_scratch/out/_v78_census.json", "w", encoding="utf-8") as fh:
    json.dump(OUT, fh, indent=1, default=float)
print("\nwrote _scratch/out/_v78_census.json")
