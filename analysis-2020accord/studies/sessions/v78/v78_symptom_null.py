...
`memory/feedback/measurement/feedback-episodes-not-windows.md`: get the noise floor from a split-half null with the
...
Usage:  python studies/sessions/v78/v78_symptom_null.py   ->  writes _scratch/out/_v78_null.json
"""
...
with open(ROOT / "_scratch/out/_v78_null.json", "w", encoding="utf-8") as fh:
    json.dump(OUT, fh, indent=1, default=float)
print("\nwrote _scratch/out/_v78_null.json")
