#!/usr/bin/env python3
"""studies/sessions/v78/v78_surface_blastradius.py -- which modes' FactorC/E records moved, WHY, and by which build.

studies/sessions/v78/v78_surface_tables.py PART 1b reported 18 changed modes for FactorC and FactorE, including five
