#!/usr/bin/env python3
"""studies/sessions/v78/v78_surface_plots.py -- plots for the damper calibration surface, stock / V74 / V75.

Run with an interpreter that has numpy + matplotlib, e.g.
    C:/Users/dudei/anaconda3/envs/analyze-log/python.exe studies/sessions/v78/v78_surface_plots.py
...
OUT = Path(__file__).resolve().parents[3] / "plots"
