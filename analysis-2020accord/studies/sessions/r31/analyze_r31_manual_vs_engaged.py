"""
studies/sessions/r31/analyze_r31_manual_vs_engaged.py -- what the V61 drive (route 31) actually measured.
...
def main():
    ...
    print("=" * 88)
    res = {}
    for label, pat in (("V59  route 2c", "_scratch/cache/r2c/r2cs*.npz"), ("V61  route 31", "_scratch/cache/r31/r31s*.npz")):
    ...
    for label, sel in (("ENGAGED (latActive)", creep), ("MANUAL forward (drive)", fwd),
                       ("MANUAL reverse", rev)):
        arrs, fs = _pool("_scratch/cache/r31/r31s*.npz", sel)
