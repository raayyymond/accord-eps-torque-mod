...
Two things `studies/sessions/ra5/ra5_three_grinds.py` left open, both of which can change the answer:
...
json.dump(OUT, open(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))),
                                 '_scratch/out/_ra5_s2_variants.json'), 'w'), indent=1, default=float)
print("\nwrote _scratch/out/_ra5_s2_variants.json")
