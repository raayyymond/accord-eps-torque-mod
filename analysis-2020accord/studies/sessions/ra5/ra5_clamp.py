...
in `rlog-tools/_scratch/logs/_ra5_clampdose.log` and `_scratch/logs/_ra5_clamprate.log`.  `.gitignore:44` eats `*.log`, and a
...
Usage:  python studies/sessions/ra5/ra5_clamp.py            # both tables
        python studies/sessions/ra5/ra5_clamp.py dose       # TABLE 1 only
        python studies/sessions/ra5/ra5_clamp.py rate       # TABLE 2 only
"""
...
if __name__ == '__main__':
    ...
    if not a:
        ...
        json.dump(OUT, open(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))),
                                         '_scratch/out/_ra5_clamp.json'), 'w'), indent=1, default=float)
        print("wrote _scratch/out/_ra5_clamp.json")
