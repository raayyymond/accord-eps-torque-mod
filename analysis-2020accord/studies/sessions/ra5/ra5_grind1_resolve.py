...
`studies/sessions/ra5/ra5_grind1_line.py` produced the centre estimates but TWO of its controls did not do their job.
...
json.dump(OUT, open(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))),
                                 '_scratch/out/_ra5_grind1_resolve.json'), 'w'), indent=1, default=float)
print("\nwrote _scratch/out/_ra5_grind1_resolve.json")
