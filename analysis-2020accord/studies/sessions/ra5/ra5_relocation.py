...
test AFTER I had already computed 18-33 Hz peak frequencies with CIs (`studies/sessions/ra5/ra5_pole_moved.py`, reported
...
json.dump(OUT, open(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))),
                                 '_scratch/out/_ra5_relocation.json'), 'w'), indent=1, default=float)
print("\nwrote _scratch/out/_ra5_relocation.json")
