...
`studies/sessions/r5d/r5d_ratchet.py` produced the point estimates. Three of them are decision-bearing and were quoted
...
Usage:  python studies/sessions/r5d/r5d_falsifiers.py   ->  writes _scratch/out/_r5d_falsifiers.json
"""
...
with open(ROOT / "_scratch/out/_r5d_falsifiers.json", "w", encoding="utf-8") as fh:
    json.dump(OUT, fh, indent=1, default=float)
print("\nwrote _scratch/out/_r5d_falsifiers.json")
