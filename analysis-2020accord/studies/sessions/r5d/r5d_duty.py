...
one. The instrument is `studies/nearcentre/nearcentre_relay.py` UNCHANGED: T = 600 counts of the 18-22 Hz p99 envelope
...
Usage:  python studies/sessions/r5d/r5d_duty.py [ep|blk]   ->  writes _r5d_duty.json
"""
...
PKL = ROOT / "_scratch/data/_cache_r5d_nearcentre.pkl"
if PKL.exists():
