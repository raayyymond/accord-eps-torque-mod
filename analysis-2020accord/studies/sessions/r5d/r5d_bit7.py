...
`studies/sessions/r5d/r5d_duty.py`'s first pass matched on a (rate x speed) grid and only ONE cell survived with >= 6
...
Usage:  python studies/sessions/r5d/r5d_bit7.py   ->  writes _scratch/out/_r5d_bit7.json
"""
...
with open(ROOT / "_scratch/out/_r5d_bit7.json", "w", encoding="utf-8") as fh:
    json.dump(OUT, fh, indent=1, default=float)
print("\nwrote _scratch/out/_r5d_bit7.json")
