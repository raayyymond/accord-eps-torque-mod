...
BANDS, per the standing rule that BOTH symptoms are scored on every build:
    ...
    18-22  grind #1 -- 🛑 a LIMIT CYCLE, so DUTY is the primary metric (see `studies/sessions/r5d/r5d_duty.py`)
    24-28  the pre-declared negative control
    40-49  grind #2
    1-4    driver input -- the exposure-matching validity check

Usage:  python studies/sessions/r5d/r5d_bands.py   ->  writes _scratch/out/_r5d_bands.json
"""
...
print("\nwrote _scratch/out/_r5d_bands.json")
