#!/usr/bin/env python3
"""studies/sessions/v70/v70_surface_vs_rate.py -- V69's delivered gain_B over BOTH axes, from the image bytes.
...
# The default in lib/firmware_paths.py is stale; honour ACCORD_FIRMWARE_ROOT, then fall back to the
