#!/usr/bin/env python3
"""studies/sessions/v74_v75/v75fault_analysis.py -- the forensic reconstruction of the V75 mid-drive hard fault (route 5e).
...
C5E = ROOT / "_scratch/cache/r5e"
C5D = ROOT / "_scratch/cache/r5d"
...
print("\n  --- V74 comparison (route 5d, _scratch/cache/r5d) ---")
try:
