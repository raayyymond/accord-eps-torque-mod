#!/usr/bin/env python3
"""studies/sessions/v74_v75/v75fault_final.py -- corrected numbers (strict index split at the fault) + the route inventory.
...
EV = json.loads((ROOT / "_scratch/cache/r5e" / "r5e_events.json").read_text())
t = D["t"]
