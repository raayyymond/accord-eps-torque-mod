...
Deliberately written from the instruction addresses, NOT by importing studies/sessions/v70/v70_rate_lane_gain_model.py,
...
def main():
    ...
    print()
    print("=" * 112)
    print("STEP 1d -- CROSS-CHECK against studies/sessions/v70/v70_rate_lane_gain_model.py (must agree exactly)")
    print("=" * 112)
