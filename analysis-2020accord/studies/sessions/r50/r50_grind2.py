...
Writes `_scratch/out/_r50_grind2.json`.  Usage: python studies/sessions/r50/r50_grind2.py
"""
...
POOLS = {
    ...
    "Kd=2x<50 (V70 r50) *** THIS ROUTE ***":  ["_scratch/cache/r50"],
}
...
(HERE / "_scratch/out/_r50_grind2.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE / '_scratch/out/_r50_grind2.json'}")
