...
THE PROBLEM. `studies/sessions/r50/r50_discriminator.py` ss4 shows the ratchet going 173 -> 4,894 counts p-p across the
...
Writes `_scratch/out/_r50_handsoff.json`.  Usage: python studies/sessions/r50/r50_handsoff_deconfound.py
"""
...
(HERE / "_scratch/out/_r50_handsoff.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE / '_scratch/out/_r50_handsoff.json'}")
