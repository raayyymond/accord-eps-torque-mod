...
Usage: python studies/nearcentre/nearcentre_strict.py [ep|blk] -> writes _scratch/out/_nearcentre_strict.json
"""
...
print("  Engaged creep. Compare against `studies/nearcentre/nearcentre_grind1.py` ss3, which binned on the MEAN and")
...
(HERE.parent / "_scratch/out/_nearcentre_strict.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE.parent / '_scratch/out/_nearcentre_strict.json'}")
