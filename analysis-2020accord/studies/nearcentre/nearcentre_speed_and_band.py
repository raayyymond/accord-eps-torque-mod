...
Usage: python studies/nearcentre/nearcentre_speed_and_band.py [ep|blk]  -> writes _scratch/out/_nearcentre_speed_band.json
"""
...
(HERE.parent / "_scratch/out/_nearcentre_speed_band.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE.parent / '_scratch/out/_nearcentre_speed_band.json'}")
