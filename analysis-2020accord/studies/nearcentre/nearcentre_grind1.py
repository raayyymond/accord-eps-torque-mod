...
Usage:  python studies/nearcentre/nearcentre_grind1.py [ep|blk]     ->  writes _scratch/out/_nearcentre_grind1.json
"""
...
(HERE.parent / "_scratch/out/_nearcentre_grind1.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE.parent / '_scratch/out/_nearcentre_grind1.json'}")
