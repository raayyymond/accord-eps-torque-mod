...
`studies/nearcentre/nearcentre_grind1.py` ss4 showed the marginal near-centre ladder is NOT monotone (0-5 deg is
...
Usage:  python studies/nearcentre/nearcentre_deconfound.py [ep|blk]   ->  writes _scratch/out/_nearcentre_deconfound.json
"""
...
(HERE.parent / "_scratch/out/_nearcentre_deconfound.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE.parent / '_scratch/out/_nearcentre_deconfound.json'}")
