"""
studies/caves/v50_cave_asm.py -- the V50 first-order EMA low-pass code cave, assembled from byte-verified V850E2
encodings (the SAME encoders as studies/caves/v48b_cave_asm.py, which were cross-validated against real code.bin
instructions and Ghidra-re-disassembled from the built V48B image).

WHY A LOW-PASS, NOT V48B's NOTCH (see studies/models/eps_v50_gate2_lowpass.py + the 2026-07-22 handoff):
...
# ---- Format encoders (identical to studies/caves/v48b_cave_asm.py; verified vs real code.bin) ----
