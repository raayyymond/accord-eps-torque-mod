"""
studies/caves/v52_cave_asm.py -- the V52 first-order EMA low-pass code cave. IDENTICAL to studies/caves/v50_cave_asm.py except
...
V52 = V50 with THREE deltas (this file carries two of them; the 8th repoint lives in builds/v50_v79/build_v52_tva.py):
  ...
  (2) ROUND-TO-NEAREST on the EMA step: y += (74*d + 512) >> 10  (was (74*d) >> 10 in V50).
      ...
      studies/models/eps_v50_gate2_lowpass.py carries and is strictly improved (bias removed, no new dynamics).
  (3) [in builds/v50_v79/build_v52_tva.py] an 8th carrier repoint: FUN_0002eda8's raw gp-0x4f60 read, a live
...
# ---- filter parameters ----
ALPHA = 74          # Q10 EMA coefficient -> fc ~= 11.9 Hz at 1 kHz (studies/models/eps_v50_gate2_lowpass.py)
...
# ---- Format encoders (identical to studies/caves/v50_cave_asm.py; verified vs real code.bin) ----
