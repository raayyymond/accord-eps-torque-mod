#!/usr/bin/env python3
"""studies/models/v72_lane_model.py -- the r24 / r26 aggregator lanes, mirroring the DECOMPILED arithmetic exactly.
...
USAGE
    python studies/models/v72_lane_model.py                 # stock surfaces + the flown ladder + V72 candidates
    python studies/models/v72_lane_model.py --image PATH    # evaluate one image
"""
