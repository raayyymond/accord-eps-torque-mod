"""
studies/models/eps_v48b_notch_design.py -- design + validate the V48B 21.4 Hz notch biquad and its fixed-point form.
...
DESIGN TARGET (from the loop-gain model, docs/research/VIBRATION-DOSSIER.md):
