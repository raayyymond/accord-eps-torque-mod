...
# -*- coding: utf-8 -*-
r"""
studies/models/eps_v50_gate2_lowpass.py -- GATE 2 (closed-loop stability) for V50 = a FIRST-ORDER EMA LOW-PASS on the
shared torsion-bar signal gp-0x4f60, chosen over V48B's notch for three reasons this session established:

  1. FREQUENCY-ROBUST. Fresh manual-drive data (studies/spectra/analyze_manual_vibration.py + studies/telemetry/manual_speed_split.py)
...
Also RE-FITS the loop-gain calibration. studies/models/eps_v48c_gate2_closed_loop.py is anchored to the FALSIFIED
...
Reuses the verified Nyquist/stability machinery from studies/models/eps_v48c_gate2_closed_loop.py (positive-feedback
convention, full signed-w contour). NO new measurements introduced here.

Run:  python studies/models/eps_v50_gate2_lowpass.py
"""
import cmath
import math
