#!/usr/bin/env python3
r"""
studies/probes/decode_v51p_gate1.py -- read V51P (gp-0x1300 "B" + gp-0x1100 "D" -> CAN 330 spare bits) telemetry
out of rlog 7 (V51P drive), and compare against a STOCK (non-probe) manual drive to determine
whether B and/or D are RAM-clean, per the packing in builds/v50_v79/build_v51probe_tva.py (lines 47-59):
...
Mirrors studies/probes/decode_v50p_gate1.py's parsing/checksum/bus-split structure but:
