#!/usr/bin/env python3
"""studies/probes/decode_v85_probe.py -- decode V85's `0x14A` byte-4 probe field, and REFUSE anything that is not V85.
...
Usage:
    python studies/probes/decode_v85_probe.py --selftest
"""
...
try:
    ...
    raise SystemExit(f"decode_v85_probe must sit beside builds/v80_v107/build_v85_tva.py: {exc}")
