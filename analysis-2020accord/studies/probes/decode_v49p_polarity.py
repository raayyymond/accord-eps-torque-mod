#!/usr/bin/env python3
r"""
studies/probes/decode_v49p_polarity.py -- read the V49P read-only polarity telemetry out of the manual rlog.

V49P (builds/v18_v49/build_v49p_tva.py) flashed V38 + a READ-ONLY cave that packs two RAM bytes into CAN 330's
