...
`ra5_burst_conditional.py` (a 2-line delta on `ra4_burst_conditional.py`: `TAGS`/`NAMES` only) runs
...
json.dump(OUT, open(os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                 '_ra5_prereg.json'), 'w'), indent=1, default=float)
print("wrote _ra5_prereg.json")
