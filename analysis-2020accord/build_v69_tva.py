...
DECODER = os.path.join(HERE, "..", "rlog-tools", "decode_v69_ratchet.py")
...
def build():
    ...
    if assert_decoder_matches(cave_bytes):
        print("    ✅ rlog-tools/decode_v69_ratchet.py CAVE_HEX matches the built cave byte-for-byte,")
    ...
    if mx > 2.001:
        print(f"    🛑 GATE 2 MAGNITUDE: {mx:.3f}x is OUTSIDE the flown bracket "
              ...
              "instruction 2026-08-04. See docs/V69-DESIGN.md §5.2.")
