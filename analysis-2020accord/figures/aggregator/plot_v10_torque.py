...
Two candidate torque Y-axis lists (notes/TORQUE_PATH_AND_TABLE.md §3c), 12 x int16, in the
...
ANALYSIS_DIR = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
