...
PKL = ROOT / "_scratch/data/_cache_r50_records.pkl"
...
G.BUILDS["V70/r50"] = dict(cache=ROOT / "_scratch/cache/r50", pfx="r50s", segs=[0, 1, 2], kd=2.0)
...
# ------------------------------------------------------------------ the V70 probe ----------------
# Channel names as written by `extract/extract_r50_cache.py`. Kept here so an analysis script never has to
