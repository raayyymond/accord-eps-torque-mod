...
Cache schema: see extract/extract_r31_cache.py. Key additions over route 2c: cs_gear (car.capnp
...
CACHE = ROOT / "_scratch/cache/r31"
CACHE_2C = ROOT / "_scratch/cache/r2c"
CACHE_2B = ROOT / "_scratch/cache/r2b"   # relocated into the repo 2026-07-31; it previously hard-coded a
