#!/usr/bin/env python3
"""v89_b1_damper_surface.py -- read the base-assist damper surface off the FLOWN V88 image.
...
and the point of this script is a claim about the KIT'S OWN TEST HISTORY, not about Honda:
  ...
  * the `FactorE X[0]` lever was WITHDRAWN AS "STRUCTURALLY VACUOUS" (build_v86b_tva.py header)
