#!/usr/bin/env python3
"""v89_e3_leak_profile.py -- the BAND-PROFILE shape test, with a PER-BAND wheel-order veto.
...
OUT = Path(__file__).resolve().parent.parent / "_cache_r73" / "v89_e3_profile.json"
FS_FW = 1000.0
