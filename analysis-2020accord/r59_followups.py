#!/usr/bin/env python3
"""ROUTE 59 (V72) FOLLOW-UPS -- the checks the headline in `r59_grind1.py` demands.

`r59_grind1.py` put V72 at median `e_18-22` = 614 engaged creep, i.e. in the STOCK region and not
...
Writes `_r59_followups.json`.  Usage: python r59_followups.py
"""
import json
import sys
...
(HERE.parent / "_r59_followups.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE.parent / '_r59_followups.json'}")
