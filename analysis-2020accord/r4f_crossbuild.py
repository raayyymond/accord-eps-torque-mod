...
Writes `_r4f_crossbuild.json`.  Usage: python r4f_crossbuild.py [ep|blk]
"""
import json
import sys
...
(HERE / "_r4f_crossbuild.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE / '_r4f_crossbuild.json'}")
