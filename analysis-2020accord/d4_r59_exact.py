...
§3  THE HIGHWAY COMPARISON, EXCITATION-MATCHED. §3 of d4_r59_power.py found route 59's highway
...
(ROOT / "_d4_r59_exact.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {ROOT / '_d4_r59_exact.json'}")
