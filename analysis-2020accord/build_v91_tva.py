#!/usr/bin/env python3
r"""build_v91_tva.py -- V91 = the FLOWN V90 + 12 CALIBRATION BYTES. No cave change, no code change.
...
Verified from the images, not from the build scripts (this script re-verifies it at run time):
    ...
    (build_v74_tva.py's own header comment says "13 modes". The IMAGE says 14. The image wins.)
