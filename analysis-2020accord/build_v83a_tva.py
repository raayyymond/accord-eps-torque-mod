#!/usr/bin/env python3
"""build_v83a_tva.py -- V83a = THE FLOWN V81, with three dosed cells reverted to HONDA. CAL-ONLY.
...
Usage:
    python build_v83a_tva.py                            # DRY RUN, verifies everything, writes nothing
    ACCORD_V83A_WRITE=rwd python build_v83a_tva.py      # writes the plain image AND the flashable .rwd
"""
import hashlib
import os
import struct
