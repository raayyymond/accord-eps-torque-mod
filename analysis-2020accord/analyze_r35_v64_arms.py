...
Three jobs the main script (analyze_r35_v64_grinding.py) leaves open:
...
POOLS = {"V59  route 2c": ROOT / "_cache_r2c", "V61  route 31": ROOT / "_cache_r31",
         "V64  route 35": ROOT / "_cache_r35"}
PFX = {"V59  route 2c": "r2cs*", "V61  route 31": "r31s*", "V64  route 35": "r35s*"}
# each build's own located engaged-creep f0, from analyze_r35_v64_grinding.py Method A
