...
1. THE CREEP 5xf0 NUMBER, PROPERLY. `r5d_falsifiers.py` found the engaged v<12.5 arm clear (2.23,
...
Usage:  python r5d_gate.py   ->  writes _r5d_gate.json
"""
import json
import pickle
import sys
...
with open(ROOT / "_r5d_gate.json", "w", encoding="utf-8") as fh:
    json.dump(OUT, fh, indent=1, default=float)
print("\nwrote _r5d_gate.json")
