#!/usr/bin/env python3
"""v89_c2_powered_discriminator.py -- the rate x engagement x LEVER-B test, on the FULL corpus.

v89_a6 ran this on 12 routes / 93 blocks and returned an underpowered non-answer. The corpus is
~2.4x bigger than that glob saw (v89_c1_full_corpus.py): 30 routes, 284 min, 10 Lever-B routes
...
OUT = ROOT / "_cache_r73" / "v89_c2_powered.json"
