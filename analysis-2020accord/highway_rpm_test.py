...
`highway_order_test.py` established, with a razor-sharp positive control (the 8-30 Hz line reads
...
Usage:  python highway_rpm_test.py
"""
import json
import sys
...
def main():
    ...
    if not rows:
        print("no rows -- run extract_rpm_cache.py first")
        return
