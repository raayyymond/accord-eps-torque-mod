#!/usr/bin/env python3
r"""
reanalyze_b9_vibration.py -- FROM-SCRATCH re-derivation of the ~21 Hz EPS steering
...
Requires: numpy, pycapnp, zstandard, and rlog-tools/rlog_parse.py (added to sys.path below).
