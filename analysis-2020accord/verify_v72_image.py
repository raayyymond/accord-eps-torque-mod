#!/usr/bin/env python3
"""verify_v72_image.py -- VALUE-ANCHORED verification of a built V72 image.
...
value below is re-declared here as a LITERAL, from `docs/V72-DESIGN.md`, and then CROSS-CHECKED
against `build_v72_tva.py`'s own tables. A divergence between the two independent statements is a
failure -- so a typo in either file is caught, which importing alone could never do.

Usage:  python verify_v72_image.py [IMAGE]        (default: _v72_plain_image.bin)
        python verify_v72_image.py --rwd PATH     (decode a .rwd and verify the payload)
"""
...
# =====================================================================================================
# THE EXPECTATION, RE-DECLARED AS LITERALS FROM docs/V72-DESIGN.md -- not imported
# =====================================================================================================
...
def cross_check_against_builder():
    ...
    print("\n  CROSS-CHECK -- this file's literals vs build_v72_tva.py's tables:")
    ok = True
