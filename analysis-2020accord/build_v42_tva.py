"""
build_v42_tva.py -- V42 = V38 + TWO changes: kill the state-4 governor ratchet (1 byte of CODE)
...
See lkas_iir_quantization_analysis() and _inline_torque_rate_a() in eps_lkas_chain_model.py.
