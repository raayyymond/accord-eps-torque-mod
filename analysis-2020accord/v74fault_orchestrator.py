#!/usr/bin/env python3
"""v74fault_orchestrator.py -- the orchestrator's own verification of route 61 (V74's hard fault).

Route `75604b0a432fdc89_00000061--3b8f2f9278`, segments 0..12, extracted by
`v74fault_extract.py` to `_cache_r61/r61.npz`.
...
Usage:  python v74fault_orchestrator.py
...
R61 = ROOT / "_cache_r61" / "r61.npz"
R5E = ROOT / "_cache_r5e" / "r5e.npz"
