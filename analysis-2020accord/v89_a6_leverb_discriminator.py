#!/usr/bin/env python3
"""v89_a6_leverb_discriminator.py -- does the engagement x rate interaction depend on LEVER B?
...
OUT = ROOT / "_cache_r73" / "v89_a6_leverb.json"
...
# 🛑 r66 is present in BOTH _cache_r66 and _cache_r66x -- the same route. Loaded ONCE.
