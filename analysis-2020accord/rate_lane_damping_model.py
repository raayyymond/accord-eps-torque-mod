"""
rate_lane_damping_model.py -- size the torsion-bar RATE lane as a DAMPER, post-V61.
...
That is a SIGNED result, and it inverts the record. eps_lkas_chain_model.py framed r26 as an
