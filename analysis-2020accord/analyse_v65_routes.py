#!/usr/bin/env python3
"""analyse_v65_routes.py -- flight-clean inventory + V65 ladder decode for routes 3a / 3b.

Reads the .npz caches written by extract_r3a_cache.py / extract_r3b_cache.py. All ladder semantics
are V65's (see those docstrings); the raw byte4 is re-decoded here from `probe`, never from a
pre-baked flag.

Usage:  python analyse_v65_routes.py r3a r3b
"""
import json
import sys
import time
