#!/usr/bin/env python3
r"""build_v86b_tva.py -- V86B = the flown V85 + FactorC `Y[0]` lifted on modes 26 AND 27.
...
Usage:
    python build_v86b_tva.py                        # DRY RUN, verifies everything, writes nothing
    ACCORD_V86B_WRITE=rwd python build_v86b_tva.py  # cuts the artefacts
"""
import hashlib
import os
import struct
