...
Usage: python nearcentre_boundary.py [ep|blk] -> writes _nearcentre_boundary.json
"""
import json
import sys
...
(HERE.parent / "_nearcentre_boundary.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE.parent / '_nearcentre_boundary.json'}")
