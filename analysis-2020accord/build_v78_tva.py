#!/usr/bin/env python3
"""build_v78_tva.py -- V78 = V76 + ONE u16 damper cell + a RE-CUT probe. UNFLASHED.
...
# 🛑 V78, NOT V77: `build_v77_tva.py` exists and V77/V77B .rwds are on disk (renamed SUPERSEDED-...).
...
def main():
    ...
    assert bytes(base[CAVE_BASE:CAVE_BASE + CAVE_EXTENT]) == v76_cave, \
        "the base's cave is not the one build_v76_v38base_tva.py emits -- WRONG BASE"
