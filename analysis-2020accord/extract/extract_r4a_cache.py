...
Decode is byte-for-byte the same as `extract/extract_r47_cache.py` -- 0x14A src1 arrivals carry the probe
...
Usage:  python extract/extract_r4a_cache.py 20 21 22 23 24 25
"""
import json
import os
import sys
...
OUT = Path(os.environ.get("R4A_CACHE", ROOT / "_scratch/cache/r4a"))
TAG = "r4a"
