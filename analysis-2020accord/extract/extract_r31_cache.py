...
Same grid and decode conventions as rlog-tools/decode/extract_r2c_cache.py -- V61 carries V59's probe
...
Usage:  python extract/extract_r31_cache.py 0 1 2 3
"""
import json
import os
import sys
...
OUT = Path(os.environ.get("R31_CACHE", ROOT / "_scratch/cache/r31"))
