...
`t0 = d["t"][0]` in extract/extract_r35_cache.py. Verified against route 37, whose cache does store
...
Usage:  python extract/extract_imu_controls.py            # everything
        python extract/extract_imu_controls.py r2c r31
"""
import sys
