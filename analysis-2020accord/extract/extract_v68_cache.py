...
Decode is byte-for-byte extract/extract_r4a_cache.py's, with ONE substantive change: the byte4 decoder.

🛑 BYTE4 IS BUILD-SPECIFIC -- six builds, six meanings. This decoder is the REVISED V68's, taken
from builds/v50_v79/build_v68_tva.py's CELLS list (GATE_DISP 0x6806 / FSM_DISP 0x67DF / DETECT_DISP 0x671A at
...
Usage:  python extract/extract_v68_cache.py            # both routes, all segments
        python extract/extract_v68_cache.py 4c 4 5     # one route, chosen segments
"""
...
OUT = Path(os.environ.get("V68_CACHE", ROOT / "_scratch/cache/v68"))
