...
🛑 READ-ONLY on `_scratch/cache/r5e/` -- a sibling agent owns the FAULT forensics there. This writes a
SEPARATE cache, `_scratch/cache/r5e_sym/`, for the SYMPTOM question only.

What it does, and nothing else:
  1. loads `_scratch/cache/r5e/r5e.npz`, the route-GLOBAL extract (39,961 frames, 401.2 s, 7 segments);
  ...
  3. splits by `seg` and writes `r5es{seg}.npz` with the `_scratch/cache/r5d` field names, so
...
Usage:  python extract/v78_symptom_cache.py
"""
import json
import sys
...
SRC = ROOT / "_scratch/cache/r5e" / "r5e.npz"
DST = ROOT / "_scratch/cache/r5e_sym"
