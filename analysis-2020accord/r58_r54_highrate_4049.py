...
Writes `_r54_highrate_4049.json`.  Usage: python r58_r54_highrate_4049.py
"""
import json
import sys
...
POOLS = {
    "stock (V58+V59+V64)": ["_cache_r2b", "_cache_r2c", "_cache_r35"],
    "V70 r50 (r24 x2, plateau only)": ["_cache_r50"],
    "V69 r4f (r24 x4, plateau only)": ["_cache_r4f"],
    "V62+V65 (r24+r26 x2 flat)": ["_cache_r37", "_cache_r3a", "_cache_r3b"],
    "V71B r54 (r26 x2 ALL RATE) ***": ["_cache_r54"],
    "V71C r58 (gated flat arms)": ["_cache_r58"],
}
SKIP = {"_cache_r54": ("r54s10", "r54s11"), "_cache_r58": ("r58s12", "r58s13", "r58s14", "r58s15"),
        "_cache_r50": ("r50s0",)}
...
(ROOT / "_r54_highrate_4049.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {ROOT / '_r54_highrate_4049.json'}")
