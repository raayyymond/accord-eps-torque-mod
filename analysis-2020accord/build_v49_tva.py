"""
build_v49_tva.py -- V49 = V38 + the state-4 ratchet fix + a COLLOCATED TORQUE-RATE DAMPER made by
...
WHY (topology + closed-loop model, 2026-07-22; eps_v49_a382_stagec_flip_model.py, disasm-exact)
...
GATE 2 (closed-loop): PASSED for the flip+band-limit (pole 64) -- see eps_v49_a382_stagec_flip_model.py.
