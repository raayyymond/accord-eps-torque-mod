...
try:
    pc = json.load(open(os.path.join(A.HERE, '_acoustic_poscontrol.json')))
...
json.dump({'item4': B4, 'item6': I6}, open(os.path.join(A.HERE, '_acoustic_346.json'), 'w'),
          indent=1, default=float)
print("\n  wrote _acoustic_346.json")
