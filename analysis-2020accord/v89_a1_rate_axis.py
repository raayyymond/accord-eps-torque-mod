#!/usr/bin/env python3
"""v89_a1_rate_axis.py -- test the OPERATOR'S OWN AXIS for micro-ratcheting / ratcheting.
...
CACHE = ROOT / "_cache_r73" / "r73.npz"
OUT = ROOT / "_cache_r73" / "v89_a1_rate_axis.json"
