...
computed from `_cache_r75` / `_cache_r76` / `_cache_r73`.  READ-ONLY on all three caches.
...
OUTJ = ROOT / "_cache_r75" / "v89_f2_requests.json"
R = {"73": ("_cache_r73", "r73", "r73s", 11), "75": ("_cache_r75", "r75", "r75s", 16),
     "76": ("_cache_r76", "r76", "r76s", 13)}
K1 = 204
WIRE_RAIL = 1023
CT_PER_WIRE = 8.0 / 5.0
OUT = {}
