...
Usage: python nearcentre_two_modes.py [ep|blk] -> writes _nearcentre_two_modes.json
"""
import json
import sys
...
(HERE.parent / "_nearcentre_two_modes.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE.parent / '_nearcentre_two_modes.json'}")
