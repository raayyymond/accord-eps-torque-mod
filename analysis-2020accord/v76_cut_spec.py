#!/usr/bin/env python3
"""v76_cut_spec.py -- the FINAL V76 mode-26 FactorC/FactorE arrays, ready to cut.
...
try:
    import numpy as np
    cache = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "_cache_r61", "r61.npz")
