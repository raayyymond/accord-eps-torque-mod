...
PKL = ROOT / "_cache_nearcentre_records_v72.pkl"

CREEP = 20 / 3.6            # 5.556 m/s -- the kit's standing creep cut for grind #1
NFFT = G.NFFT

# The ladder in the record's own order (r58_grind1.py ss1), plus their r24/r26 creep prices.
...
PRICE = {"V61/r31": (0.000, 1.000), "V59/r2c": (1.000, 1.000), "V64/r35": (1.000, 1.000),
         ...
         "V72/r59": (1.862, 0.169)}
# Arms as `r58_grind1.py` groups them -- so a number here is comparable to one already on record.
