...
Why this exists: `studies/ledger/ledger_v94_cells.py` hand-lists MATRIX_SCALARS, so a cell that no build ever
...
Also fixes two defects in studies/ledger/ledger_v94_cells.py (REPORTED, not patched there):
