...
3. **Mode 24 and mode 26 are NOT byte-identical in this table family** — rec[0], rec[3], rec[4],
   ...
   `accord/calibration/accord-stock-mode24-equals-mode26-damper-is-ours.md` asserts byte-identity but is scoped to the
...
measured the lane and its gate. Decoded with the kit's own `studies/probes/decode_v86_probe.py` (self-test PASS),
