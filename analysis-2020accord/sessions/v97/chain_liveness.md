...
own elicitation episodes (`_scratch/out/_r7e_r7f_elicitations.json`) intersected with engagement.
...
1. **`damp_nz`, `thermo_128/288/448`, `g6ac2`, `v84_*` are stale bit-map decodes.** They are the
   V75/V81/V84 interpretations applied to V96's bits by `probe/decode_v84_probe_r6d.py`, which decodes
