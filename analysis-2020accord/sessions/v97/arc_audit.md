...
outside `analysis-2020accord/sessions/v97/`. A separate agent is checking the same questions against the
...
`docs/review/ARC-AUDIT-2026-08-10.md` (the prior V38→V89 audit — this file **extends** it, it does not
replace it), `docs/traces/TRACE-2026-08-11-return-to-centre-gate.md`,
`docs/handoffs/2026-08/HANDOFF-2026-08-11-routes-78-79-and-the-inertia-reversal.md`,
`docs/handoffs/2026-08/HANDOFF-2026-08-11-v90-flew-and-the-lever-search-closed.md`,
`docs/handoffs/2026-08/HANDOFF-2026-08-12-v94-aborted-and-the-override-regime.md`,
`docs/review/REDTEAM-2026-08-11-term0-verdict.md`, `memory/MEMORY.md` + `MEMORY-PART2.md` +
`accord/firmware/accord-return-centre-and-detent-dead-engaged.md` + `accord/firmware/accord-r26-is-structurally-inert.md`,
`analysis-2020accord/builds/v80_v107/build_v96_tva.py`, and a grep of all 92 `build_v*_tva.py`.
...
### 3.1 The lane, end to end [EVIDENCE — full disasm, `traces/TRACE-2026-08-11-return-to-centre-gate.md`]
...
`memory/accord/firmware/accord-return-centre-and-detent-dead-engaged.md`, tool `rlog-tools/decode/extract_r78_r79.py health 79`.
...
(`memory/accord/firmware/accord-r26-is-structurally-inert.md`). So the gate opens only when driver torque sits *at* the
...
|---|---|---|
| `0xC63BE` | return-lane gain (×1024 on the LERP product) | **NEVER** — appears only in `builds/v80_v107/build_v92_tva.py`, read-only |
| `0xC695C` | the 5-knot LERP table (count, 5 X knots, 5 Y knots) = **the outer gate's shape** | **NEVER** — V92 reads it *from the image* |
| `0xC618A` = 1024 | dwell **ARM** threshold *and* the snap **CEILING** | **NEVER** — `builds/v80_v107/build_v92_tva.py:524` marks it 🛑 READ-ONLY |
| `0xC627E` = 20 | dwell **SNAP** threshold (~20 ms at 1 kHz) | **NEVER** — `builds/v80_v107/build_v92_tva.py:525` READ-ONLY |
...
1. ⭐⭐ **The rate-adaptive governor ceiling** [EVIDENCE for the mechanism; **BELIEF** for the
   ...
   LKAS-specific — but `research/FEASIBILITY-8X-LKAS.md` item 10 already found that **at today's 4× gain,
...
> `docs/handoffs/2026-08/HANDOFF-2026-08-11-v90-flew-and-the-lever-search-closed.md:478-483` —
...
> `docs/traces/TRACE-2026-08-11-return-to-centre-gate.md` §3.3 — the same closure, derived independently by
...
> `docs/review/REDTEAM-2026-08-11-term0-verdict.md:362-364` — *"`gp-0x6b4e ≡ gp-0x6afe` **CONFIRMED
...
> `docs/handoffs/2026-08/HANDOFF-2026-08-11-routes-78-79-and-the-inertia-reversal.md` §7.5:
...
5. **`gp-0x6733` identity**, **task 5's true rate** (the 100 Hz claim is RETRACTED and nothing replaces
   it; `memory/accord/firmware/accord-task5-is-100hz-damper-cannot-damp-21hz.md` carries a **DISPUTED — DO NOT SIZE A
