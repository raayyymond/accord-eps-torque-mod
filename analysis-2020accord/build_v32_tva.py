"""build_v32_tva.py - V32 = V31 (UNCHANGED) + raise the GENTLE-EME disengage threshold 320 -> 1280.
...
un-pinned scale (see docs/HANDOFF-2026-06-30-sensorA-identity-gate-scale.md), so whether 1280 fully clears
