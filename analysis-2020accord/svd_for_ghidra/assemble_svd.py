...
Each subagent wrote one fragment file in _svd_parts/section*.svd containing one or
...
PARTS = os.path.join(HERE, "_svd_parts")
OUT = os.path.join(HERE, "svd_for_ghidra", "UPD70F3508_V850E2Px4.svd")
