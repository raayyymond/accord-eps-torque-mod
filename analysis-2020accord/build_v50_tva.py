"""
build_v50_tva.py -- V50 = V38 + the state-4 ratchet fix + a first-order EMA LOW-PASS on Sensor-B torque
...
WHY V50 IS SAFER THAN THE BRICKED V48B  (both mandatory gates, applied without being asked)
    * GATE 2 (closed-loop stability): eps_v50_gate2_lowpass.py -- the EMA is STABLE under both the
...
THE FILTER  [v50_cave_asm.py -- all encoders cross-verified vs real code.bin instructions]
