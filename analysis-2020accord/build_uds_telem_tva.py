"""build_uds_telem_tva.py - UDS-over-CAN RAM telemetry for the gentle-EME (39990-TVA-A160).
...
*** SUPERSEDED 2026-07-10 -- DO NOT USE. This build has an off-by-one-ENTRY bug: it patches DID 0x4800's
    ...
    Use build_v31u_uds_telem_tva.py (correct handler_ptr @0xB7820, WORKING/FLASHED). See
    docs/HANDOFF-2026-07-10-v31u-uds-telemetry-working.md. ***
...
rearm was invisible on-car, 2026-07-08 scan). Full design + evidence: docs/SPEC-uds-can-ram-telemetry-a160.md.
