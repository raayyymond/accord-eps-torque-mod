#!/usr/bin/env python3
r"""build_v93_tva.py -- V93 = the FIRST build in the kit's history to LOWER the 0xCBE74 term.
...
Usage:
    ...
    ACCORD_V93_WRITE=bin python build_v93_tva.py
    ACCORD_V93_WRITE=rwd python build_v93_tva.py
"""
import hashlib
import os
import struct
