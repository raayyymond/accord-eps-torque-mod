...
Writes `_r4f_knee.json`.  Usage: python r4f_knee_and_manual.py [ep|blk]
"""
import json
import sys
...
(HERE / "_r4f_knee.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE / '_r4f_knee.json'}")
