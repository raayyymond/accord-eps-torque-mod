"""
v48b_cave_asm.py -- the V48B notch code cave, assembled from byte-verified V850E2 encodings.

Standalone so the riskiest artifact (the cave bytes) can be inspected and Ghidra-re-disassembled in
isolation before it is embedded in build_v48b_tva.py. Every encoding here was cross-validated by the
...
# Q12 notch coefficients (eps_v48b_notch_design.py) and the folded mulhi immediates.
