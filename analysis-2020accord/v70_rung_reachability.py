#!/usr/bin/env python3
"""v70_rung_reachability.py -- CAN V69's bit5 and bit4 rungs fire at all? Two questions, from bytes.

The V69 probe read 0.0000% on all three rungs through a MEASURED 7.56 Hz / 2,823-count-p-p ratchet
(route 4f, `r4f_v69_readout.py`). Before that null can be called informative, two things must be
