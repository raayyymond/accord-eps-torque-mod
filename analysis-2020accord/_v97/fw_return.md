...
`build_v92_tva.py`, and every hit there is read-only (lines 524-525 say verbatim
...
`memory/accord-return-centre-and-detent-dead-engaged.md` indicts `byte7 b6` as a dead rung because
...
places: `docs/BUILD-LINEAGE.md` (this note), `memory/accord-return-centre-and-detent-dead-engaged.md`,
