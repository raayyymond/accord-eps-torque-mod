...
READING 1  DIRECT ACOUSTIC CONTENT at 21.0-22.5 Hz, now at 0.9766 Hz resolution.
           ⚠ This is a NARROWER test than the one already run.  `extract_audio_env.py` measured a
...
json.dump({'reading1': R1, 'reading2': R2},
          open(os.path.join(A.HERE, '_acoustic_grind1.json'), 'w'), indent=1, default=float)
print("\n  wrote _acoustic_grind1.json")
