#!/usr/bin/env python3
"""build_v71c_tva.py -- V71C = V67/V68's control path with the r26 CUT REMOVED, + the ratchet byte.
...
Usage:  python build_v71c_tva.py
"""
import hashlib
import os
import re
...
def build():
    ...
    if assert_decoder_matches(cave_bytes):
        print("    ✅ rlog-tools/decode_v71_probe.py matches this cave and names V71C")
    ...
    print(f"  EXACT DIFF vs STOCK: {len(d_stock)} bytes -- run `python diff_build_vs_stock.py v71c`")
