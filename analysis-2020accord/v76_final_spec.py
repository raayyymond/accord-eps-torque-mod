#!/usr/bin/env python3
"""v76_final_spec.py -- the four items team-lead asked for on top of v76_surface.py.
...
All arithmetic via the validated mirror in v76_surface.py (FUN_00034350, 23/23 rows PASS).
"""
...
d=np.load(os.path.join(os.path.dirname(os.path.abspath(__file__)),'..','_cache_r61','r61.npz'),allow_pickle=True)
