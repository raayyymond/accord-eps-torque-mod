...
Writes `_r4f_final.json`.  Usage: python r4f_final_checks.py
"""
import json
import sys
...
try:
    coh = json.loads((HERE / "_r4f_sat_coh.json").read_text())["coherence"]
except Exception:
    coh = {}
...
(HERE / "_r4f_final.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE / '_r4f_final.json'}")
