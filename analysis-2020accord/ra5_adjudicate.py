r"""V105 / route `a5` -- ADJUDICATION.  The controls that decide whether ra5_prereg_primary.py's
numbers are quotable, plus the absolute spectra behind the ratios.

Six questions, each of which can kill a headline:

A  ABSOLUTE SPECTRA, not ratios.  `ra5_prereg_primary.py` found a fine-grain V105/V104 trough at
...
json.dump(OUT, open(os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                 '_ra5_adjudicate.json'), 'w'), indent=1, default=float)
print("\nwrote _ra5_adjudicate.json")
