#!/usr/bin/env python3
r"""Follow-up to speed_status_engagement.py (team-lead request): does the EPS actually
REFUSE to steer at low speed, or does it merely LABEL the status while still complying?

Uses two EPS-transmitted signals on CAN 399 (0x18F) that speed_status_engagement.py did not
