...
WHY. `d4_macro_ratchet.py` measured the UNWIND and returned 45/45 comparisons inside null. Before
...
(ROOT / "_d4_macro_windup.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {ROOT / '_d4_macro_windup.json'}")
