...
Usage:  python highway_exposure_inventory.py
"""
import json
import sys
...
ROUTES = [
    ("2b", "_cache_r2b", "r2bs", list(range(0, 14)), "V58", 1.00),
    ("2c", "_cache_r2c", "r2cs", [0, 1, 3, 4, 8, 9, 10, 11, 12], "V59", 1.00),
    ("31", "_cache_r31", "r31s", [0, 1, 2, 3], "V61", 0.00),
    ("35", "_cache_r35", "r35s", [0, 1, 2], "V64", 1.00),
    ("37", "_cache_r37", "r37s", list(range(0, 15)), "V62", 2.00),
    ("3a", "_cache_r3a", "r3as", list(range(0, 7)), "V65", 2.00),
    ("3b", "_cache_r3b", "r3bs", list(range(0, 14)), "V65", 2.00),
    ("47", "_cache_r47", "r47s", list(range(0, 26)), "V67", 2.44),
    ("4a", "_cache_r4a", "r4as", list(range(0, 40)), "V67", 2.44),
]
