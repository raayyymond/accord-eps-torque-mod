#!/usr/bin/env python3
"""v75fault_flags.py -- route-wide history of every byte that LATCHED at the fault.

`v75fault_buschange.py` found the latched bytes inside +/-8 s. This walks the WHOLE route so the
