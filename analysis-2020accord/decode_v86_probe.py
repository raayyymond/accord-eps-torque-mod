#!/usr/bin/env python3
"""decode_v86_probe.py -- decode V86's `0x14A` byte-4 probe field, and REFUSE anything that is not V86.
...
Usage:
    python decode_v86_probe.py --selftest
"""
import sys
...
try:
    ...
    raise SystemExit(f"decode_v86_probe must sit beside build_v86_tva.py: {exc}")
