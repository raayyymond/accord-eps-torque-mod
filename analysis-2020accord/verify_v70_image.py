#!/usr/bin/env python3
"""verify_v70_image.py -- EXACT-VALUE anchors for V70, independent of the builder.
...
`build_v70_tva.py` beyond the addresses.
...
Usage:  python verify_v70_image.py [path-to-_v70_plain_image.bin]
"""
import struct
import sys
...
def main(path=None):
    ...
    print("   🛑 This checks VALUES. Run diff_build_vs_stock.py v70 for SPAN coverage. Both, always.")
