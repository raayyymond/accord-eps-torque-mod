...
`r58_followups.py` §A found f_hi/f_lo = 2.003 [1.997, 2.009]. That is either a major structural
...
Writes `_r58_harmonic.json`.  Usage: python r58_harmonic.py
"""
import json
import sys
...
(ROOT / "_r58_harmonic.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"wrote {ROOT / '_r58_harmonic.json'}")
