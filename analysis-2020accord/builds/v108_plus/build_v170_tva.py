#!/usr/bin/env python3
r"""
V170 -- BASE-ASSIST SLOPE CAP at 1280 (4.5x).  Base = V158.  DOSE LADDER member.
...
--------------------
the next step UP, if V168 reads clean and the ratchet is reduced but not gone

PREDICTED EFFECT, on the GATE 2 anchoring in build_v168_tva.py:
    cap 1280 => s = 1.250 => |L| = 2.075 => |1-P.L| = 0.3169 => Q ratio 3.16
    = 4.5x more damped than stock (cap 2048, Q ratio 14.29)
...
def build():
    return V168.build(cap_new=CAP_NEW, vnum=170, write_env="ACCORD_V170_WRITE")
