...
WRITE_MODE = os.environ.get("ACCORD_V121_WRITE", "").strip().lower()
...
def build():
    print("=" * 102)
    print("  V121 -- THE MAXIMAL GAIN-MATCHED KNEE.  KNEE 1800->3000, K1 612->1020, GAIN HELD EXACTLY.")
    print("=" * 102)
    ...
    FF.assert_x31_checksum(rwd, "V121 output")
    dec = bytearray(base)
    ...
    tag = "V121-V112BASE-RELAY.KNEE3000.K1.1020.MAXSAFE"
    img_out = plain_image_path(f"_v121_{tag}_plain_image.bin")
    ...
    if WRITE_MODE == "rwd":
        ...
        print("\n  [9] NOT WRITTEN -- set ACCORD_V121_WRITE=rwd to emit the files")
