#!/usr/bin/env python3
r"""
V132 -- LIFT THE DAMPER'S CEILING.  0xC407E 511 -> 1023 AND its FLOAT TWIN 0xC4004 0.5 -> 1.0.
...
WRITE_MODE = os.environ.get("ACCORD_V132_WRITE", "").strip().lower()
...
def build():
    print("=" * 102)
    print("  V132 -- V131 + the gp-0x6b26 CEILING raised as a MATCHED int/float PAIR (511/0.5 -> 1023/1.0).")
    print("=" * 102)
    ...
    tag = "V132-V131BASE-B26.CEILING.1023"
    img_out = plain_image_path(f"_v132_{tag}_plain_image.bin")
    ...
    if WRITE_MODE == "rwd":
        ...
        print("\n  [9] NOT WRITTEN -- set ACCORD_V132_WRITE=rwd to emit the files")
