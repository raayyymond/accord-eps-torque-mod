...
WRITE_MODE = os.environ.get("ACCORD_V123_WRITE", "").strip().lower()
...
def build():
    ...
    FF.assert_x31_checksum(rwd, "V123 output")
    dec = bytearray(base)
    ...
    if WRITE_MODE == "rwd":
        ...
        print("\n  [9] NOT WRITTEN -- set ACCORD_V123_WRITE=rwd to emit the files")
