...
V126 -- THE OSCILLATION-BRANCH FIX.  0xC640A -8192 -> -3277.  Base = V124.
...
THE EDIT
--------
    0xC640A   -8192 -> -3277    the oscillation-branch Y

-3277 is not invented: it is the value Honda already ships at 0xC640C for THIS SAME VARIABLE in
THIS SAME FUNCTION (the implausible-sensor branch), so it is inside the calibrated range by
construction.  New ratios: creep 0.37x, 24 km/h 0.59x, 44 km/h 0.74x, 64 km/h 0.97x, 90 km/h
...
WRITE_MODE = os.environ.get("ACCORD_V126_WRITE", "").strip().lower()
...
YFB_CAL, YFB_OLD, YFB_NEW = 0xC640A, -8192, -3277  # THE EDIT -- the oscillation branch
YFB_ALT_CAL, YFB_ALT_VAL = 0xC640C, -3277          # Honda's own value for this variable
...
def build():
    print("=" * 102)
    print("  V126 -- V124 + 0xC640A -8192->-3277 (the OSCILLATION BRANCH) + 427 probe on gp-0x6B26.")
    print("=" * 102)
    ...
    tag = "V126-V124BASE-C640A.-3277-427.6B26.SAR2"
    img_out = plain_image_path(f"_v126_{tag}_plain_image.bin")
    ...
    if WRITE_MODE == "rwd":
        ...
        print("\n  [9] NOT WRITTEN -- set ACCORD_V126_WRITE=rwd to emit the files")
