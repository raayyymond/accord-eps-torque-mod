...
WRITE_MODE = os.environ.get("ACCORD_V122_WRITE", "").strip().lower()
...
SCALE = 5
KNEE_CAL, KNEE_OLD, KNEE_NEW = 0xC40BC, 1800, 3000            # THE EDIT (x5 on stock)
K1_CAL, K1_OLD, K1_NEW = 0xC40D2, 612, 1020                    # cancels the gain change EXACTLY
...
ALPHA2_CAL, ALPHA2_V111, ALPHA2_NEW = 0xC40DC, 14, 8   # THE SECOND EDIT -- the selective lever
...
def build():
    print("=" * 102)
    print("  V122 -- BEST AVAILABLE.  KNEE 1800->3000 + K1 612->1020 + ALPHA2 14->8.")
    print("=" * 102)
    ...
    for a, nm in ((OFF_CAL, "0xC4080 relay offset K0 -- NEVER RAISE"),
    ...
    FF.assert_x31_checksum(rwd, "V122 output")
    dec = bytearray(base)
    ...
    tag = "V122-V112BASE-KNEE3000.K1.1020-ALPHA2.8-BEST"
    img_out = plain_image_path(f"_v122_{tag}_plain_image.bin")
    ...
    if WRITE_MODE == "rwd":
        ...
        print("\n  [9] NOT WRITTEN -- set ACCORD_V122_WRITE=rwd to emit the files")
