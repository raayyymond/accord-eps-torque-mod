#!/usr/bin/env python3
r"""
V163 -- GIVE THE RESONANCE PID ITS AUTHORITY BACK IN THE RATCHET'S OWN BAND.
        0xC67C4 : 1280 -> 512.  Base = V160BASE.  ONE HALFWORD.  A VIRGIN CELL.
...
WRITE_MODE = os.environ.get("ACCORD_V163_WRITE", "").strip().lower()

BASE_NAME = "_v160_V160-V158BASE-LEVERB.5244.TO.6553_plain_image.bin"
BASE_SHA = "5277005735a5b2e42bf38860a7a82d1bed14126207cb376e16d0cf137f921594"
...
LB_CAL, LB_HELD = 0xC6446, 6553                # Lever B -- carried from the V160 base
...
def build():
    print("=" * 102)
    print("  V163 -- resonance-PID ceiling X[1] 1280 -> 512.  ONE halfword.  V160BASE")
    print("=" * 102)

    print("\n  [1] BASE = V122, THE LAST FLOWN KNOWN-GOOD BUILD")
    base = bytearray(Path(plain_image_path(BASE_NAME)).read_bytes())
    check(hashlib.sha256(bytes(base)).hexdigest() == BASE_SHA,
          f"  base image is V160 ({BASE_SHA[:16]}...)")
    ...
    check(u16(code, LB_CAL) == LB_HELD,
          f"  0x{LB_CAL:05X} Lever B carried at {LB_HELD} from the V160 base -- V163 STACKS damper + Lever B + this")
    ...
    tag = "V163-V160BASE-RESPID.CEILING.X1.1280.TO.512"
    img_out = plain_image_path(f"_v163_{tag}_plain_image.bin")
    ...
    if WRITE_MODE == "rwd":
        ...
        print("\n  [10] NOT WRITTEN -- set ACCORD_V163_WRITE=rwd to emit the files")
