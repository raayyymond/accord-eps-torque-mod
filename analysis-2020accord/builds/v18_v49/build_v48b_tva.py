"""
builds/v18_v49/build_v48b_tva.py -- V48B = V38 + the state-4 ratchet fix + a 21.4 Hz NOTCH on Sensor-B torque (code cave).
...
WHY A NOTCH  [docs/research/VIBRATION-DOSSIER.md, studies/models/eps_loop_gain_model.py, studies/models/eps_v48b_notch_design.py]
...
THE FILTER  [studies/models/eps_v48b_notch_design.py + studies/models/eps_v48b_cave_model.py, both runnable + validated]
...
THE CAVE  [studies/caves/v48b_cave_asm.py -- every encoding cross-validated vs >=2 real code.bin instructions]
