"""
builds/v18_v49/build_v49p_tva.py -- V49P = V38 + READ-ONLY POLARITY TELEMETRY (no cal/logic change).
...
TECHNIQUE (identical mechanics to builds/v18_v49/build_v31p_v2_tva.py, verified there)
