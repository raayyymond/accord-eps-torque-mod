"""builds/v18_v49/build_v38_tva.py - V38 = V37 + 4x-stock LKAS gain, matched 5120/5.0 soft-EME walls,
...
# but do NOT reason about it as a command ramp step. See memory/reference/firmware/reference_accord_watchdog_fault_sm_fun43e44.md
CAL_BYTE_PATCHES = [
