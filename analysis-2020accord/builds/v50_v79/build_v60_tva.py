#!/usr/bin/env python3
"""builds/v50_v79/build_v60_tva.py -- V60 = V59 + ONE halfword: the boost-amplitude BLEND coefficient 102 -> 43.
...
def build():
    ...
    print("     population is worth a pass too. Decode with rlog-tools/probe/decode_v59_boostindex.py --")
