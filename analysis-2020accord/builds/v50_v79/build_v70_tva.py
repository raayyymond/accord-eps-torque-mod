#!/usr/bin/env python3
"""builds/v50_v79/build_v70_tva.py -- V70 = V69's TOPOLOGY at HALF the dose, + a REPAIRED probe.
...
All three opcodes are asserted BY VALUE here and independently in `verify/verify_v70_image.py`.
...
Usage:  python builds/v50_v79/build_v70_tva.py
"""
...
DECODER = os.path.join(HERE, "..", "rlog-tools", "probe/decode_v70_probe.py")
...
def build():
    ...
    if assert_decoder_matches(cave_bytes):
        print("    ✅ rlog-tools/probe/decode_v70_probe.py CAVE_HEX matches the built cave byte-for-byte,")
