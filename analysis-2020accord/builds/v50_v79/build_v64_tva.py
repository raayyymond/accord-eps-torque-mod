#!/usr/bin/env python3
"""builds/v50_v79/build_v64_tva.py -- V64 = V63's two calibration edits + a cave that INSTRUMENTS V63'S OWN MECHANISM.
...
---------------------------------------------------------------------------
builds/v50_v79/build_v63_tva.py's docstring says `gp-0x671a = min(revcount, CEIL)` and "sits at 0 during smooth
...
Decoder: rlog-tools/probe/decode_v64_detector.py
"""
...
def build():
    ...
    if os.path.exists(v63_bin):
        ...
        print("  V64 vs V63: _v63_plain_image.bin absent -- run builds/v50_v79/build_v63_tva.py for that comparison")
