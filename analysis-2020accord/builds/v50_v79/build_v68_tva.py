#!/usr/bin/env python3
"""builds/v50_v79/build_v68_tva.py -- V68 = V67's CONTROL PATH, BYTE-IDENTICAL, with a re-aimed probe.
...
Decoder: rlog-tools/probe/decode_v68_probe.py
"""
...
DECODER = os.path.join(os.path.dirname(HERE), "rlog-tools", "probe/decode_v68_probe.py")
...
def build():
    ...
    print(f"\n  decoder link: rlog-tools/probe/decode_v68_probe.py CAVE_HEX "
    ...
    print("     Decode with rlog-tools/probe/decode_v68_probe.py.")
    return code
