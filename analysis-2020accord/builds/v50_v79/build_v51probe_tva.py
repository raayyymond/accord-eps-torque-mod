"""
builds/v50_v79/build_v51probe_tva.py -- V51P = V38 + READ-ONLY telemetry that reads TWO candidate RAM cells,
...
TECHNIQUE (identical mechanics to builds/v50_v79/build_v50probe_tva.py / builds/v18_v49/build_v49p_tva.py)
...
CAVE ENCODING (pack_bd_nz16, 86 bytes @0xC4B34). The two ld.bu/st.b read-modify-write pairs on
    ...
    Ghidra-round-tripped cave (studies/caves/v50_cave_asm.py, the V50 low-pass cave):
      ...
      0040 / a741 / bf42 / c8460100 -- mov r0,r8 ; sub r7,r8 ; sar 0x1f,r8 ; andi 0x1,r8,r8: the
          ...
          the V50 low-pass cave (studies/caves/v50_cave_asm.py), sar additionally cross-checked here vs a real
