"""
builds/v50_v79/build_v53_tva.py -- V53 = FOURFRAME2 (V38 + the fixed four-frame telemetry cave) + the low-speed steer
...
PROVENANCE OF THE CAVE  [why this file is thin]
    The 853-byte cave is NOT re-typed here -- it is IMPORTED from `builds/telemetry/build_vfourframe_tva.py`, the file
