"""
builds/v50_v79/build_v61_tva.py -- V61 = V59 + KILL THE TORSION-BAR RATE LANE, BOTH HALVES, AT ONCE.
...
**Every prior test killed ONE tap and left the other carrying the signal:**
  ...
  - V42 zeroed r26 (RATE_A gain tables + the two override cals).  -> NULL on-car.
    builds/v18_v49/build_v42_tva.py says it outright: "WHY r26 AND NOT r24: r24 was already zeroed by V39".
...
tp+0x74be = 0xC64BE = 0 (byte-verified). See memory/accord/firmware/accord-torque-rate-lane-v52c-structurally-blind.md.
...
def build():
    ...
    print("     pass. Decode with rlog-tools/probe/decode_v59_boostindex.py.")
