#!/usr/bin/env python3
"""builds/v50_v79/build_v74_tva.py -- V74 = V73 CARRIED, with every lever moved onto the ENGAGED COLUMN OF EVERY ROW.
...
Usage:  python builds/v50_v79/build_v74_tva.py
"""
...
DECODER = os.path.join(HERE, "..", "rlog-tools", "probe/decode_v74_probe.py")
...
def build():
    ...
    if assert_decoder_matches(cave_bytes):
        print("    ✅ rlog-tools/probe/decode_v74_probe.py CAVE_HEX matches the built cave byte-for-byte.")
