"""
builds/v50_v79/build_v54_tva.py -- V54 = V38 + minimum steer speed 0 + a 5-bit AUTHORITY probe piggybacked into CAN 330.
...
DECODE (rlog side) -- `rlog-tools/probe/decode_v54_authority.py`
...
def cmp_rr(reg1, reg2):
    ...
    Verified against the real `cmp lp,r10` @0x290D2 = ff51, recorded in builds/v50_v79/build_v53_tva.py as the
