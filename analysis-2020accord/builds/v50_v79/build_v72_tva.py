#!/usr/bin/env python3
"""builds/v50_v79/build_v72_tva.py -- V72 = V67/V68's creep rate lane, delivered UNGATED and speed-shaped.
...
Spec: `docs/specs/design/V72-DESIGN.md` + the team-lead's routes-54/58 revisions (whole-axis Lever A; Lever B at
...
Usage:  python builds/v50_v79/build_v72_tva.py
"""
...
DECODER = os.path.join(HERE, "..", "rlog-tools", "probe/decode_v72_probe.py")
...
def build():
    ...
    if assert_decoder_matches(cave_bytes):
        print("    ✅ rlog-tools/probe/decode_v72_probe.py CAVE_HEX matches the built cave byte-for-byte.")
    ...
    print("\n  THE DELIVERED MULTIPLIER, re-derived from the BUILT image via studies/models/v72_lane_model.py:")
