#!/usr/bin/env python3
"""builds/v50_v79/build_v66_tva.py -- V66 = V65 with the rate lane back at STOCK, plus a GATE PROBE cave.
...
LKAS-only gain override for r24 (`docs/specs/design/V66-V67-DESIGN.md`). Every bit below measures one load-bearing
...
-------------------------------------------------------------------------------------------
    ...
    ⚠ 100 Hz sampling => NYQUIST 50 Hz. The 15-60 Hz kill band is NOT fully observable: a true 58 Hz
      ...
      This is the same alias `docs/specs/design/V66-V67-DESIGN.md` states up front for the 41.64/58.86 Hz pair.
...
Decoder: rlog-tools/probe/decode_v66_gateprobe.py
"""
...
def build():
    ...
    print("     Decode with rlog-tools/probe/decode_v66_gateprobe.py.")
    return code
