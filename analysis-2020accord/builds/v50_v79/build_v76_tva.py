#!/usr/bin/env python3
"""builds/v50_v79/build_v76_tva.py -- V76 = V74 + V67/V68's RATE-LANE RESTORE, and a probe that watches THE GATE.
...
Usage:  python builds/v50_v79/build_v76_tva.py
"""
...
DECODER = os.path.join(HERE, "..", "rlog-tools", "probe/decode_v76_probe.py")
...
def build():
    ...
    if assert_decoder_matches(cave_bytes):
        print("    ✅ rlog-tools/probe/decode_v76_probe.py CAVE_HEX matches the built cave byte-for-byte.")
