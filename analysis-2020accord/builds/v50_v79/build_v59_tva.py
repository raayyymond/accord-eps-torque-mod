#!/usr/bin/env python3
"""builds/v50_v79/build_v59_tva.py -- V59 = V58 with the cave payload replaced by the BOOST-INDEX DEPTH probe.
...
----------------------------------------------------------------------------------------------
builds/v50_v79/build_v58_tva.py says `gp-0x6b9a` "indexes boost's NON-flat table (0xD28DC)". *** THAT IS WRONG. ***
...
Decoder: rlog-tools/probe/decode_v59_boostindex.py
"""
