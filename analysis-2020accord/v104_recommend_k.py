...
Inputs, all reproduced upstream in this session:
  K = a.(k_cross-1) = 0.02507   [v104_dose_vs_speed.py sec 1; verified constant to 4 s.f.]
  a_filt = 0.0457 [-0.0047, 0.0816]   [v103_filter_natural_experiment.py, REPRODUCED bit-exact]
  s(v) from the ROM assist map + the measured (v, |tq|) joint duty   [v104_dose_vs_speed.py sec 2]
  the direct a_filt speed split                                       [v104_afilt_by_speed.py]
...
# exposure shares and ROM shape, from v104_dose_vs_speed.py sec 2/3.3
