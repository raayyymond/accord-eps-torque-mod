...
INSTRUMENT is `r58_ratchet.py`, unchanged in every numeric respect (6-9 Hz analytic envelope p99,
...
print("   This is the criterion `r58_ratchet.py` used to call the ratchet PRESENT. Fisher vs route 59.\n")
...
json.dump(OUT, open(ROOT / "_r59_ratchet_hist.json", "w"), indent=1, default=float)
print(f"\nwrote {ROOT / '_r59_ratchet_hist.json'}")
