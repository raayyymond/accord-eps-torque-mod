"""model/eps_chain_control.py -- SECTIONS 4-6 of the golden model: the engage/disengage decider, steer
...
# drives fault-free. Full table: analysis-2020accord/sessions/v97/chain_liveness.md.
...
#     Detail: memory/accord/calibration/accord-c6200-clamps-the-pid-reference.md · docs/traces/TRACE-2026-08-13-v100-6ad6-and-ivar6.md
...
def openpilot_command_slew_invariance(cal: Calibration, steer_delta: float = 3.0,
    ...
    See analysis-2020accord/studies/models/rate_lane_frequency_response.py and docs/specs/design/V66-V67-DESIGN.md.
    ...
    never been correlated). `analysis-2020accord/verify/validate_gp6806_gate.py`:
    ...
    Reproduce: analysis-2020accord/studies/sessions/r47/r47_orchestrator_checks.py.
    ...
    sub-stock damping. See analysis-2020accord/studies/sessions/v70/v70_rail_describing_function.py.
    ...
    ⚠ MECHANISM NOT UNIQUELY DETERMINED [BELIEF]. Two candidates fit the dose-response equally:
      ...
      (b) PARAMETRIC GAIN COLLAPSE -- gp-0x6ac0 is loaded `ld.hu` (UNSIGNED) @0x3AAC4, so the gain
          ...
          See studies/sessions/v70/v70_parametric_gain_collapse.py and studies/sessions/v70/v70_surface_vs_rate.py.
    ...
    See docs/specs/design/V69-DESIGN.md and docs/handoffs/2026-08/HANDOFF-2026-08-04-v69-flew-grind1-back-at-creep.md.
    ...
    See studies/models/rate_lane_damping_model.py, builds/v50_v79/build_v62_tva.py, builds/v50_v79/build_v63_tva.py, builds/v50_v79/build_v64_tva.py. Motor ripple is ruled out (hand steering
