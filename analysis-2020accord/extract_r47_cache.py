...
Same grid and decode conventions as extract_r3b_cache.py: 0x14A src1 arrivals carry the probe and
...
Usage:  python extract_r47_cache.py 0 1 2
"""
import json
import os
import sys
...
OUT = Path(os.environ.get("R47_CACHE", ROOT / "_cache_r47"))
TAG = "r47"
