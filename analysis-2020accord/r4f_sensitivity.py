...
Writes `_r4f_sensitivity.json`.  Usage: python r4f_sensitivity.py
"""
import json
import pickle
import sys
...
OUT["rows"] = rows
(HERE / "_r4f_sensitivity.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE / '_r4f_sensitivity.json'}")
