...
Usage: python nearcentre_v72.py [ep|blk] -> writes _nearcentre_v72.json
"""
import json
import sys
...
(HERE.parent / "_nearcentre_v72.json").write_text(json.dumps(OUT, indent=1, default=float))
print(f"\nwrote {HERE.parent / '_nearcentre_v72.json'}")
