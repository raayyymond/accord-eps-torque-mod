...
Usage:  python v88_stock_delta.py            # both tables
        python v88_stock_delta.py runs       # just the stock delta
        python v88_stock_delta.py matrix     # just the cross-build matrix
"""
import os
import struct
import sys
