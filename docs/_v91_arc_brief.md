...
`docs/ARC-AUDIT-2026-08-10.md` §2 already builds this for V38→V89 and is correct where I can check it
...
weight lanes with no damping story). `docs/TRACE-2026-08-10-damping-axis-hunt.md:276` independently
records *"zero mentions, ever"*.

**[RECORD — `TRACE-2026-08-10-lkas-command-visibility.md:161-168`, NOT my own decompile]** the arithmetic is
```python
...
`analysis-2020accord/ledger_v38_to_v84_bytes.py` extended to V90 (a `ledger_v38_to_v89_bytes.py` also
...
**all of them are `FROZEN_CELLS` guards asserting stock, not edits**: `build_v90_tva.py:175-179`
(`0xC63A6: (2, 1024, "loop-gain family")`), `build_v79_tva.py:146` / `build_v80_tva.py:129`
...
3. **`0xC644A`'s V43 dose is 32 in the image**, not the 64 recorded in `memory/v43-dirty-derivative-pole-built.md`.
