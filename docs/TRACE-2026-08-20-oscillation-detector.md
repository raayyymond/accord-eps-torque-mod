...
`accord-ratchet-is-a-lightly-damped-resonance.md`) and the split-half-stable **21.73 Hz** line. The
...
`build_v103_tva.py`'s docstring figure ("~18 in-code readers"), which this session initially could not
