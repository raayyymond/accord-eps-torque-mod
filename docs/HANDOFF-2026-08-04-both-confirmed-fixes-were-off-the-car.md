...
**Predecessors:** `docs/HANDOFF-2026-08-04-v69-flew-grind1-back-at-creep.md` (route `4f`, the ×4 dose,
the non-monotone ladder) → `docs/HANDOFF-2026-08-04-v69-recut-4x-and-ratchet-probe.md` →
`docs/HANDOFF-2026-08-04-v69-built-speed-shaped-rate-lane.md` →
`docs/HANDOFF-2026-08-03-v68-flew-the-lane-change-is-28hz.md`. Read the V69-flew handoff for the dose
