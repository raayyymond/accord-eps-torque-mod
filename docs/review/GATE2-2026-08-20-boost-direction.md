...
Extends `docs/review/GATE2-2026-08-20-notch-sign.md`, which killed the *notch*. This file examines the
...
Scripts: `analysis-2020accord/lib/_gate2_boost_lib.py` (frozen method) plus `studies/grind2/_g2b_pc.py` (positive
control), `studies/grind2/_g2b_band217.py`, `studies/grind2/_g2b_design.py`, `studies/grind2/_g2b_verdict217.py`, `studies/grind2/_g2b_kappa.py`,
`studies/grind2/_g2b_kappa_robust.py`, `studies/grind2/_g2b_boostcurve.py`, `studies/grind2/_g2b_sweep2d.py`, `studies/grind2/_g2b_final.py`, `studies/grind2/_g2b_within.py`.
