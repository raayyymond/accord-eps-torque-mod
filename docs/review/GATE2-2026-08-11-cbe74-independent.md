...
| alphaP | `0xC6450` (`tp+0x7450`) | **1024/1024 = 1.0** | scalar | 1 real reader (`0x3a7f0`, matches `builds/v18_v49/build_v46_tva.py`'s own independent note) |
...
- **`0xC644A`**: touched by V43 and V49. 🛑 **Resolved the discrepancy you flagged.** Read
  `builds/v18_v49/build_v43_tva.py` directly (not just its print statements, which disagree with each other): the
...
## N1 — the frequency sweep (2026-08-11, using `docs/scoring/SCORING-2026-08-11-v90-flight.md` §4.1)
