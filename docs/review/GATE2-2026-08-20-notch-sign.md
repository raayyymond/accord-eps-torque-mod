...
3. **Extractor**: `decode/extract_r29_cache.py` and the whole `extract_r7d` chain apply `× −1.0` to the raw
   BE int16 (`probe/v86_probe_consolidate.py` PROV block states it explicitly).
