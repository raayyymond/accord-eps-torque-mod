...
`analysis-2020accord/eps_lkas_chain_model.py`'s comments and docstrings, which had grown far past their
purpose over many sessions.

**Predecessor:** `HANDOFF-2026-07-29-v57-decouple-and-the-angle-rate-turn.md`. Nothing in that handoff's
...
2. **Behavioral check.** `python analysis-2020accord/eps_lkas_chain_model.py` runs `_self_check()` +
