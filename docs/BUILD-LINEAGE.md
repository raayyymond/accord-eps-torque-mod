...
## CATCH-UP: V76 → V84  (Part 1 had fallen five builds behind; 2026-08-08, extended 2026-08-08 late)
...
| **V84** | flown V83a | **Lever B** `0x3AA96` `C5`→`FB` + `0xC6446` 512→**5244** · **damper → Honda** in BOTH engaged columns: FactorC `Y[0]` 566→0 at `0xD77DA` (m26) and `0xD77EE` (m27), FactorE m27 `0xD7822`/`0xD7824`/`0xD782C` → **60/400/140** | **BUILT, VERIFIED, UNFLASHED.** 7 control cells, 13 bytes, + a probe repoint inside the proven 68-byte cave. CRC 50/50 |
