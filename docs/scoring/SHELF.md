...
## 🛑 THE LIVE CARD IS `DRIVE-CARD-V238.md`. EVERYTHING BELOW THIS BLOCK IS OLDER.
...
```
  ...
  THEN  V236  (ratchet via the slope cap -- costs steering effort)
...
⚠ **Direction structural, SIZE unmeasured.** How much V238 is worth depends on the clip duty -- how
