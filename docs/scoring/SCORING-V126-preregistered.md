# SCORING V126 — pre-registered BEFORE the drive, 2026-08-28

🛑 **Written and committed before any V126 flight exists.** Endpoints, bands and decision rules
...
| addr | old | new | what |
|---|---|---|---|
| `0xC640A` | −8192 | **−3277** | the oscillation-branch `Y` for `gp-0x6b26` |
...
| **2–10 %** | **PARTIAL** | consider the next rung, `0xC640A` → **−1966** |
| **> 10 %** | **STILL RAILING** | go to **−1966** |
...
3. **LKAS authority** — 🛑 **V126 is the FIRST build since V112 to change authority** (V122 carried
...
- **V126 changes authority AND the oscillation branch.** They are not separable on one drive. The
