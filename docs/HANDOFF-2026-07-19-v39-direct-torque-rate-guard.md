...
**Supersedes:** the opposing-only V39 draft in `HANDOFF-2026-07-18-v39-opposing-torque-rate-guard.md`.
...
`analysis-2020accord/eps_lkas_chain_model.py` is the live golden reference and was updated with the exact
