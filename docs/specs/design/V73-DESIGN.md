...
Read with `docs/STATE.md`, `docs/BUILD-LINEAGE.md` (**RULES 3/4/5 first**), and `docs/specs/design/V72-DESIGN.md`.
...
`BUILD-LINEAGE.md`, never a measurement**, and `builds/v18_v49/build_v44_tva.py` has patched modes 10 **and** 11 since
...
cal values** (`analysis-2020accord/lib/_grind2_delivered_lib.py`). The withdrawal is recorded in
`docs/STATE.md` and `memory/accord/mechanism/accord-grind1-is-a-limit-cycle.md`.
