...
`docs/GATE2-2026-08-11-cbe74-independent.md` (N5, folded in per instruction, not re-derived) makes the
...
while the EPS's live on bus 1 (checked via `rlog-tools/_can_inventory.py` against an existing local
...
entirely and are excluded by other means already established in `SPEC-2026-08-10-v90-cave.md`).
