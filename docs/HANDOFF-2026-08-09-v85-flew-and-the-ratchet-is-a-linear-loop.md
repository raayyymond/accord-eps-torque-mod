...
**Predecessor:** `HANDOFF-2026-08-09-v84-flew-and-the-command-scaled-relay.md`.
**Current state:** `docs/STATE.md` (rewritten in place this session). **Lever ledger:** `docs/BUILD-LINEAGE.md`.
**Arc map for this session:** `docs/_session_v86_arc_map.md`. **Cumulative non-stock delta:**
`docs/_session_v86_nonstock_delta.md`.
...
`75604b0a432fdc89_0000006e--649c462a6e`, cache `_cache_r6e/`.
...
1. 🛑 **`_cache_r6e/r6e.npz` carries `probe_build = ['V80']`.** That field is a **stale extractor
...
Now folded into `analysis-2020accord/eps_lkas_chain_model.py`.
