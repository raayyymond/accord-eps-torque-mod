...
**Read after:** `docs/HANDOFF-2026-08-12-v97-the-loop-pole.md`.
**Session outputs:** `docs/AUDIT-2026-08-12-dead-levers-and-liveness.md` (54 KB) ·
`docs/SPEC-2026-08-12-next-telemetry.md` (108 KB) · `docs/SCORING-2026-08-12-v97-route80.md` ·
`docs/TRACE-2026-08-12-v97-liveness.md` · `docs/TRACE-2026-08-12-stage2-lerp-knots.md` ·
`docs/VERIFY-2026-08-12-v97-image.md` · cache `analysis-2020accord/_cache_r80/`.
...
| # | reason | evidence |
|---|---|---|
| 1 | **NO INSTRUMENT** | V96's cave carried unchanged; regressor **34× over-range**. `M ≡ 0` on **10,749/10,749** frames — third replication (7e 99.90 %, 7f 99.97 %, r80 **100 %**). `Mlo` duty 0.0000. S1/S2 **VOID — conceded in `build_v97_tva.py:99-100` BEFORE the flash** |
...
`docs/AUDIT-2026-08-12-dead-levers-and-liveness.md`. Classes T1–T11; **T10 is new**:
...
| `0xC6194` reason *"output ×0"* **WRONG** (~2 weeks) — that is `0xC6196` | corrected in `memory/reference-accord-lkas-friction-is-viscous-not-a-rate-limit.md`. Real reason: partition `0xC4118` is all-1 ⇒ 100 % bypasses it |
...
| **`SPEC-2026-08-11-telemetry-budget.md` still allocated 427 to `gp-0x6bbe`** — a lever closed as dead | SUPERSEDED banner |
...
| file | KB | contents |
|---|---|---|
| `eps_lkas_chain_model.py` | 31 | **FACADE** — re-exports all 87 symbols; existing imports unchanged |
| `eps_chain_core.py` | 37 | SECTIONS 0–1 |
| `eps_chain_lanes.py` | 119 | SECTIONS 2–3 |
| `eps_chain_control.py` | 90 | SECTIONS 4–6 |
| `eps_chain_delivery.py` | 33 | SECTIONS 7–9 + `control_task` + `_self_check` + `_demo` |
...
`analysis-2020accord/_golden_contract_syms.json` / `_golden_contract_baseline.txt`.
...
`_r5d_lib.py:191`, `build_v62_tva.py:17`, `rlog-tools/decode_v70_probe.py:67`). **Grep the symbol name.**
