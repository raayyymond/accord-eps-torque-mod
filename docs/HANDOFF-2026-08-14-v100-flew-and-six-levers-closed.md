...
**Full working: `docs/_v101_arc_map.md` (~135 KB).**
...
5. **The hands-on `dCMD/dt` arm is the one open measurement worth money**, and it needs no drive —
   just ~40–60 min of re-extraction on 3–4 large uncached routes, then `rlog-tools/dcmd_dt_corpus_pool.py`.
...
**New analysis scripts** — `rlog-tools/`: `extract_r85.py` · `score_r85_v100.py` ·
`dcmd_dt_hypothesis.py` · `dcmd_dt_spectrum.py` · `dcmd_dt_grip.py` · `gp6ac0_operating_point.py` ·
`mask_reconciliation.py` · `lkas_command_band_content.py` · `dcmd_dt_corpus_pool.py`
**New reader** — `analysis-2020accord/ledger_v38_to_v100_bytes.py` (90 images, anchors pass, zero
unattributed bytes).
**New caches/results** — `analysis-2020accord/_cache_r85/` (12 files) · `analysis-2020accord/_v100/` (9 files).
**New doc** — `docs/_v101_arc_map.md`.
