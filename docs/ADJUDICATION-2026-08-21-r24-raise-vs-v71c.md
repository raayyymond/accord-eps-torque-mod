...
The source of the error is identifiable and benign: `docs/TRACE-2026-08-21-r24-r26-as-active-damping.md`
...
`TRACE-2026-08-21-r24-r26-as-active-damping.md` §2.2 says the r26 skip *"needs BOTH `gp-0x6b5e != 0`
...
**[EVIDENCE, from `BUILD-LINEAGE.md` / `LEDGER-V38-TO-V84.md` / the handoff chain]**
...
**[EVIDENCE, `LEDGER-V38-TO-V84.md:236`]** the operator's V71c report is
...
Reproduced by running `analysis-2020accord/_g2b_kappa_robust.py` **[EVIDENCE]**.
...
**[EVIDENCE — `_cache_r85/r85_identity.json` = "build": "V100"; `_cache_r95/r95_identity.json` =
...
1. **`TRACE-2026-08-21-r24-r26-as-active-damping.md` §1.2/§2.3** — "`FUN_0003aa2c` contains ZERO
...
3. **`STATE.md` §5 / `BUILD-LINEAGE.md:55`** — *"At `a = 0`, V88 and V71c are ARITHMETICALLY IDENTICAL"*
   ...
   the control law.
4. **`memory/accord-v42-ratchet-fix-lost-since-v53.md`** — *"`0x454FE` byte-stock V53–V70, lost at a
...
5. **`STATE.md` §5 / `BUILD-LINEAGE.md`** call V71c *"the worst build ever recorded on all three
   ...
   #1** and `LEDGER-V38-TO-V84.md:236` records the operator's own words as **"attenuated but still
...
cd analysis-2020accord && python _g2b_kappa_robust.py
