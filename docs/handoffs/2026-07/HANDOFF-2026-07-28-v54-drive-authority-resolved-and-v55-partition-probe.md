...
**Predecessor:** `handoffs/2026-07/HANDOFF-2026-07-27-v53-drive-result-and-v54-authority-probe.md`.
...
Corroboration: `memory/builds/v44-built-handsoff-damping.md` cites the deadzone edge as **2240**, a number that
...
1. **Flash V55**, one parking-lot loop. Decode with `rlog-tools/probe/decode_v55_motorcmd.py`.
...
- `analysis-2020accord/model/eps_lkas_chain_model.py` — V54 block rewritten with the MEASURED result and the
...
- `analysis-2020accord/builds/v50_v79/build_v55_tva.py`, `rlog-tools/probe/decode_v55_motorcmd.py` — new.
