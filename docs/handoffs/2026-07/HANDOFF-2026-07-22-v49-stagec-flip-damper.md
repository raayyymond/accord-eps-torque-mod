...
produced a build candidate with a hard pre-flash gate. **Read `memory/reference/builds/reference-accord-v49-stagec-flip-collocated-damper.md`
first.**
...
`analysis-2020accord/studies/spectra/reanalyze_b9_vibration.py` (re-runnable; dumps `reanalyze_b9_vibration.npz`) re-derived
...
## 3. V49 — the candidate (`analysis-2020accord/builds/v18_v49/build_v49_tva.py`, BUILT + VERIFIED, UNFLASHED)
Model: `analysis-2020accord/studies/models/eps_v49_a382_stagec_flip_model.py` (re-runnable).
...
- **Golden models stale:** `studies/models/eps_loop_gain_model.py` / `studies/models/eps_v48c_gate2_closed_loop.py` are calibrated to the
...
- `analysis-2020accord/studies/spectra/reanalyze_b9_vibration.py` (+ .npz) — the re-derivation (comma-passenger, shelf).
- `analysis-2020accord/studies/models/eps_v49_a382_stagec_flip_model.py` — the GATE-2 model (flip + band-limit).
- `analysis-2020accord/builds/v18_v49/build_v49_tva.py` (+ `_v49_plain_image.bin`, `…-V49-…rwd`) — the candidate.
- `memory/reference/builds/reference-accord-v49-stagec-flip-collocated-damper.md`, `memory/feedback/process/feedback-default-maximal-thoroughness.md`,
  `memory/MEMORY.md`.
