...
Model: `analysis-2020accord/studies/models/rate_lane_damping_model.py`.
...
- `analysis-2020accord/builds/v50_v79/build_v62_tva.py` — new, the build.
- `analysis-2020accord/studies/models/rate_lane_damping_model.py` — new, the sizing/physics model mirroring the integer
  arithmetic.
- `analysis-2020accord/model/eps_lkas_chain_model.py` — the "excitation-to-amplifier" framing struck and
...
- `docs/STATE.md`, `docs/BUILD-LINEAGE.md` — V61's result, V62's entry, direction corrections on the
  V39/V42 rows.
- `memory/accord/firmware/accord-rate-lane-is-the-damper-not-the-amplifier.md`,
  `memory/accord/builds/accord-v62-doubles-the-rate-lane.md`, `memory/MEMORY.md`.
