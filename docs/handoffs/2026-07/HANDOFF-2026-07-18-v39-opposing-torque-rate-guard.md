...
> `handoffs/2026-07/HANDOFF-2026-07-19-v39-direct-torque-rate-guard.md` and the golden chain model for current behavior.
...
`analysis-2020accord/model/eps_lkas_chain_model.py` is the canonical executable source of truth. This session
updated it with:
