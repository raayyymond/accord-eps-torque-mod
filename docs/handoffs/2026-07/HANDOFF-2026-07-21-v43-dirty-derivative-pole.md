...
**Supersedes:** the vibration narrative in `handoffs/2026-07/HANDOFF-2026-07-20-v42-state4-ratchet.md`. Its ratchet narrative stands and is now **confirmed on-car**.
...
Builder: `analysis-2020accord/builds/v18_v49/build_v43_tva.py`. To fall back to the conservative corner, change the
