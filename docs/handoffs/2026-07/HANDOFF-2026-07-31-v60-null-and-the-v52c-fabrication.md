...
**Predecessor:** `handoffs/2026-07/HANDOFF-2026-07-30-v59-drive-and-the-loop-hypothesis.md`.
...
`memory/reference/firmware/reference_accord_loop_through_torque_sensor_uncompensated.md` as the retrodiction that made the
loop compelling.
...
driving feel."* Also `builds/v50_v79/build_v55_tva.py:24` (*"ALL NULL"*), `builds/v50_v79/build_v56_tva.py:78`, and
`archive/ARCHIVE-CLAUDE-MD-2026-07-27.md:56` (*"a fair test of the `gp-0x4f60` lane ⇒ real evidence AGAINST that
lane"*).
...
(`builds/telemetry/build_vfourframe_tva.py:198`), V53 on FOURFRAME2, V54/V55 on V38, then V57←V55, V58←V57, V59←V58,
...
- **`0xC63BA` is pre-falsified by V60's null.** It looked ideal (cal-only, 512 = 2-stage EMA α=0.5,
  ...
  `builds/v50_v79/build_v59_tva.py:444`). But readers of `gp-0x6b9a` (8) / `gp-0x6ba6` (7) are confined to
