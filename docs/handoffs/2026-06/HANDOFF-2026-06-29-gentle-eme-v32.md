...
Read alongside: `docs/handoffs/2026-06/HANDOFF-2026-06-03-v31.md` (soft-EME lineage), and the three agent-memory files written
...
`…_00000036--…--5--rlog.zst` (ROUTE36). Decoders: `analysis-2020accord/studies/gates/analyze_gentle_eme.py` +
`studies/gates/analyze_torque_thresholds.py`. **msg 399 is on CAN src/bus == 1.** Motorola hand-decode:
```
...
- **Copy `analysis-2020accord/builds/v18_v49/build_v31_tva.py` → `builds/v18_v49/build_v32_tva.py`.** V31's structure: `HERE` =
...
| decoders | `analysis-2020accord/studies/gates/analyze_gentle_eme.py`, `studies/gates/analyze_torque_thresholds.py` |
| V31 build script (copy this) | `analysis-2020accord/builds/v18_v49/build_v31_tva.py` |
