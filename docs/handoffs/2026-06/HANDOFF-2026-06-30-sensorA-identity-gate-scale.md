...
Supersedes the open questions in `docs/handoffs/2026-06/HANDOFF-2026-06-29-gentle-eme-v32.md`. Read that first for the road data
...
not a sensor-A-modulated cap. (Matches the existing repo memory `reference/firmware/reference_accord_arbitration_limit_family.md`,
...
### STEP 3 — Build V32
`builds/v18_v49/build_v32_tva.py` = copy `builds/v18_v49/build_v31_tva.py` + **one new cal edit: `0xC6312` (2-byte LE) 320 → chosen value.**
...
| rlogs + decoders | see `docs/handoffs/2026-06/HANDOFF-2026-06-29-gentle-eme-v32.md` §4 (`analysis-2020accord/rlogs/…`, `studies/gates/analyze_gentle_eme.py`) |
| V31 build script (copy) | `analysis-2020accord/builds/v18_v49/build_v31_tva.py` |
