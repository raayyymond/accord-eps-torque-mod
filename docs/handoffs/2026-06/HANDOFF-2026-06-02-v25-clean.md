...
**Supersedes `handoffs/2026-06/HANDOFF-2026-06-02.md` (the V24 build).** Read with `memory/MEMORY_CONSTELLATION.md`
(Era 19) and `memory/reference/firmware/reference_accord_corridor_vs_envelope.md` (the load-bearing model below).
...
- Build artifact (STUDY ARTIFACT — no flash until operator names file + bus):
  ...
  Build: `analysis-2020accord/builds/v18_v49/build_v25_tva.py` · plain image `../accord-firmware/analysis-2020accord/_v25_plain_image.bin` · plot
...
Full record: `memory/reference/firmware/reference_accord_corridor_vs_envelope.md`. In brief — there are **three** distinct
...
## V25 CLEAN exact edit set (in `builds/v18_v49/build_v25_tva.py`)
...
1. Re-read this + `memory/reference/firmware/reference_accord_corridor_vs_envelope.md` + constellation Era 19.
