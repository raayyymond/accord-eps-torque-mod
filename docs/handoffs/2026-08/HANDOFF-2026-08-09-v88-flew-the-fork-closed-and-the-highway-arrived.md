...
`75604b0a432fdc89_00000073--9380c74d52`, **11 segments**, cache `_scratch/cache/r73/`. 61,161 frames / 613.4 s,
...
**It does not.** [EVIDENCE, `_scratch/cache/r73/v88_d6_dose_and_protocol.py`]
...
```
z["t"]     == z["raw14_t"][1:]        confirmed in ALL 13 caches, _scratch/cache/r5e .. _scratch/cache/r73
...
Δphase 0.000° (`analysis-2020accord/studies/models/orch_c63ac_phase.py`): at 7.79 Hz, a = 51 → −42.38°, **a = 102
...
`analysis-2020accord/studies/models/orch_c6446_clamp_headroom.py`. The lane, from `FUN_0003aa2c` (4 independent
...
- `analysis-2020accord/model/eps_lkas_chain_model.py` — the fork closure, Lever B's measured mechanism, and the
  `raw14` defect.
...
- New: `analysis-2020accord/studies/ledger/v88_stock_delta.py` (cumulative delta + cross-build matrix, read from the
  images), `verify/orch_cell_check.py`, `studies/models/orch_c63ac_phase.py`, `verify/audit_raw14_offbyone.py`,
  `rlog-tools/decode/extract_r73.py`, and the `_scratch/cache/r73/` scoring scripts.
