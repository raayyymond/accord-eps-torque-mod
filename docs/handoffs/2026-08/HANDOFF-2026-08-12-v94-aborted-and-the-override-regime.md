...
**Predecessor:** `handoffs/2026-08/HANDOFF-2026-08-11-routes-78-79-and-the-inertia-reversal.md`
...
`analysis-2020accord/studies/dose/v94_damping_fraction.py` now carries a SUPERSEDED header; its pole coefficients,
integer mirror and cross-build gain table survive, its central numbers do not.

### 1.5 The process failure — filed in full
`memory/feedback/builds/feedback-reducing-a-gain-is-not-a-safety-class.md`. Five compounding failures, of which the
sharpest for future builds:

- **GATE 2 was answered by a sentence that assumes its conclusion** — *"a scalar on an existing term
  adds ZERO phase at any frequency and strictly REDUCES that lane's loop gain"* (`builds/v80_v107/build_v94_tva.py:117`).
...
🛑 **AND A FOURTH, WHICH IS NOT FIXED: `analysis-2020accord/model/eps_lkas_chain_model.py` is 297 KB.**
...
`hyphen-case` (`reference/firmware/reference_accord_corridor_lockstep.md` exists; links say
...
Reproducible reader: **`analysis-2020accord/studies/ledger/ledger_v94_cells.py`** (`diff` · `matrix` · `grid` · `mask`).
...
**Analysis / tooling**
`rlog-tools/decode/extract_r7d.py` · `studies/v91-v94-dose/v94_r7d_dose.py` · `studies/v91-v94-dose/v94_r7d_symptom.py` · `studies/v91-v94-dose/v94_r7d_fork_version.py` ·
`lib/v95_rez_lib.py` · `studies/impedance/v95_rez_polarity_and_mask.py` · `studies/impedance/v95_rez_2x2.py` · `studies/v95-override/v95_lane_decomposition.py` ·
`studies/impedance/v95_crossbuild_rez_ledger.py` · `studies/v95-override/v95_427_aliasing_and_cadence.py` · `studies/v95-override/v95_override_exposure.py` ·
`studies/v95-override/v95_override_authority_chatter.py` · `studies/v95-override/v95_override_onset_ringing.py` ·
`analysis-2020accord/studies/dose/v94_damping_fraction.py` (**SUPERSEDED header**)
...
`docs/archive/STATE-ARCHIVE-2026-08-11-v90-flight-session.md` (new, 30 KB, verbatim) ·
`docs/BUILD-LINEAGE.md` (V94 row now carries its on-car result) ·
`analysis-2020accord/model/eps_lkas_chain_model.py` (the `gp-0x6b26` and `gp-0x6bbe` corrections)
