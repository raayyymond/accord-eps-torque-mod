...
**Flight** [EVIDENCE, `scorer-v99`, `docs/traces/TRACE-2026-08-13-v99-flight-score.md`]: route `0x82`,
...
0.9119) — a route-wide offset, not a rate-selective effect. `builds/v80_v107/build_v99_tva.py` pre-registered the
...
⇒ This is a landmine catch this session: `docs/traces/TRACE-2026-08-13-path2-authority.md` §6–7 was still
...
handoff, the source `path2-authority` trace, and `analysis-2020accord/sessions/v97/fw_loop.md`'s phase-budget
...
of the aggregator's ten other summands; `builds/v80_v107/build_v97_tva.py`'s "Path 1 is unweighted, unaffected by A"
claim SURVIVES.
...
`scorer-v99` [EVIDENCE, `docs/traces/TRACE-2026-08-13-v99-flight-score.md`]:
...
(`score/v98_r81_score.py:541`) and inherited by **V99** (`score/v99_r82_score.py:672,718`) — a one-line omission
...
`memory/feedback/measurement/feedback-exposure-law-contiguous-blocks-not-total-seconds.md`.
...
- **`memory/accord/calibration/accord-base-assist-damper-cannot-reach-the-micro-regime.md` REFUTED, corrected in
...
- 🛑 **Landmine catch**: `docs/traces/TRACE-2026-08-13-path2-authority.md` §6–7 was still actively
...
- **V98's engaged/manual `b6` headline corrected**: the raw contrast (0.4235 engaged vs 0.8041
  manual, `docs/scoring/SCORING-2026-08-13-v98-route81.md:169`) asserted it *"survives speed matching...not a
...
- **`docs/STATE.md` shrunk 177 KB → 126 KB**: four self-labelled-superseded flight headlines (V96,
  V94, routes 78/79, V88) moved verbatim to `docs/archive/STATE-ARCHIVE-2026-08-13-v96-to-v99.md` (55 KB),
...
- **Two durable facts promoted from private tracer agent-memory** (no home in the shared record
  ...
  audible reports yet; `memory/reference/measurement/reference-accord-cabin-microphone-instrument-and-jitter-trap.md`),
  plus the aggregator/rectification facts (§5, §8a) as
  `memory/reference/firmware/reference-accord-aggregator-unweighted-and-427-rectification-trap.md`.
...
builder analysis-2020accord/builds/v80_v107/build_v100_tva.py   139/139   BASE = V99 (on the car)
...
`memory/accord/firmware/accord-v850-scan-traps-formatv-and-storezero.md`.
...
in `memory/reference/firmware/reference-accord-fun45a20-monitor-and-shadow-lockstep-pairs.md`.
...
with `python analysis-2020accord/studies/ledger/ledger_v38_to_v99_bytes.py delta`.)*
...
`traces/TRACE-2026-08-13-4x-gain-to-term0.md` · `…-variable-ratio-rack.md` · `…-measured-steering-ratio.md`.
...
`model/eps_chain_control.py` models `gp-0x6ad4` as a lane and **does not model the PID's internals at all**, so
