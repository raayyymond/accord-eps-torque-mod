...
`analysis-2020accord/studies/sessions/v89/v89_a5_engagement_model.py`. 400 windows, 12 routes, 93 episode blocks.
...
🛑 **This number changed mid-session.** With `_scratch/cache/r66`/`_scratch/cache/r66x` double-counting route `66` it
...
`analysis-2020accord/studies/sessions/v89/v89_a6_leverb_discriminator.py`. Both flags **byte-derived from each build's own
...
- **`docs/STATE.md` — 494.7 KB → 88.1 KB**, and it is now current. 47 superseded sections were split
  out **verbatim** to `docs/archive/STATE-ARCHIVE-pre-V89.md` (432.8 KB) by the reproducible
  `analysis-2020accord/archive/shrink_state_md.py`. **Nothing was deleted:** 506,564 B in → 90,231 + 443,142.
...
- New scripts, all under `analysis-2020accord/`: `studies/sessions/v89/v89_a1_rate_axis.py` · `studies/sessions/v89/v89_a2_rate_mechanism.py` ·
  `studies/sessions/v89/v89_a3_excitation.py` · `studies/sessions/v89/v89_a4_rate_x_engagement.py` · `studies/sessions/v89/v89_a5_engagement_model.py` ·
  `studies/sessions/v89/v89_a6_leverb_discriminator.py` · `studies/sessions/v89/v89_b1_damper_surface.py` · `archive/shrink_state_md.py`.
  JSON outputs in `_scratch/cache/r73/`.

## 10. Two instrument defects found, both recorded

1. **`_scratch/cache/r66` and `_scratch/cache/r66x` hold the SAME route** (`r66`, V80, n = 89,997 both). A naive
...
(`r<NN>s<K>.npz`) — ~180 min of the ~417 min on disk. `studies/sessions/v89/v89_c1_full_corpus.py` loads **30 routes,
...
### What changed with 2.4× the data (`studies/sessions/v89/v89_c2_powered_discriminator.py`)
...
`studies/sessions/v89/v89_c3_friction_relay.py`, identified **within-route**:
