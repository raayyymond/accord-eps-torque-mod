...
```
Cache `analysis-2020accord/_scratch/cache/ra4/ra4.npz`, 99 keys, 93,624 rows. Identity passes both legs.
...
- **Turn a rule into an assertion.** `builds/v80_v107/build_v105_tva.py` asserts **against** the lossy 6-dp encodings —
