...
**Predecessors:** `docs/handoffs/2026-08/HANDOFF-2026-08-04-v69-recut-4x-and-ratchet-probe.md` (the ×4 re-cut and the
ratchet probe, same day) → `docs/handoffs/2026-08/HANDOFF-2026-08-04-v69-built-speed-shaped-rate-lane.md` (the ×2 cut) →
`docs/handoffs/2026-08/HANDOFF-2026-08-03-v68-flew-the-lane-change-is-28hz.md`. Read the ×4 handoff for *why the build
...
🛑 `docs/STATE.md` and `docs/specs/design/V69-DESIGN.md` both describe bit4 as *"40% of its ±0x2800 ZERO gate"* —
...
`rlog-tools/probe/decode_v69_ratchet.py`: a **128-sample floor replaces a 256** that made its own null
...
The claim, as it stood in `memory/accord/firmware/accord-r26-is-structurally-inert.md`, `memory/MEMORY.md`,
`docs/BUILD-LINEAGE.md` and `docs/specs/design/V69-DESIGN.md`:
...
See `memory/accord/instruments/accord-mic-negative-carries-almost-nothing.md`,
`memory/accord/instruments/accord-highway-acoustic-budget-bound.md`, `memory/accord/instruments/accord-both-instruments-blind-above-50hz.md`.
...
**Reproduce:** `rlog-tools/probe/decode_v69_ratchet.py` (fixed this session — 128-sample floor),
`analysis-2020accord/studies/sessions/v68/v69_surface_math.py`, and the route caches for `4f--61171e660d`.
