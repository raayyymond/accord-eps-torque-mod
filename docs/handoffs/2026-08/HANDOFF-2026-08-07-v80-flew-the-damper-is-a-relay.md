...
⊕ `builds/v80_v107/build_v80_tva.py`'s own header reads, verbatim: *"GATE 2 (magnitude AND phase) is NOT satisfied by
...
1. 🛑 **`rlog-tools/probe/decode_v76_probe.py` is the WRONG decoder for route 65.** It documents the
   *superseded* V74-base V76, whose bit7 is `gp-0x6bd0 != 0` — the damper, not the friction lane. The
   ...
   `analysis-2020accord/studies/sessions/v76/v76flight_extract.py` → `_scratch/data/_cache_r65_records.pkl` (**not** `_scratch/cache/r65/`).
...
3. **`builds/v50_v79/build_v75_tva.py`'s default lever set does NOT produce the flown V75** — pass
...
- `analysis-2020accord/builds/v80_v107/build_v81_tva.py`
- `rlog-tools/probe/decode_v80_probe.py` (+ `_scratch/cache/r66/`, gitignored, with `r66_report.txt`)
- `rlog-tools/studies/grind/compare_v75_v76_v80_grind.py` (+ `_scratch/cache/r66x/`)
- `rlog-tools/studies/grind/friction_lane_duty_r65.py`
