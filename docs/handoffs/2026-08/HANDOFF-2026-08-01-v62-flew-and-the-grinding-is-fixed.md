...
`0x87` is **9.24% of route 37**. The V64 handoff primes every reader to see it as a null. `extract/extract_r37_cache.py`
...
**Cache/extraction:** `extract/extract_r37_cache.py`, `studies/sessions/r37/r37_wallclock.py`, `studies/sessions/r37/r37_inventory.py` · cache
`_scratch/cache/r37/r37s0..14.npz`, `r37s*_events.json`, `r37_candidate_windows.json`.
**Analysis:** `studies/sessions/r37/r37_load_scaling.py`, `studies/sessions/r37/r37_transients.py`, `studies/sessions/r37/analyze_r37_final3.py`, `lib/_r37_ratchet_lib.py`,
and the `analyze_r37_*.py` set.

**Predecessor:** `handoffs/2026-07/HANDOFF-2026-07-31-v64-the-null-is-on-the-gate.md`.
