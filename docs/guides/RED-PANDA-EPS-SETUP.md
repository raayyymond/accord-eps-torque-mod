...
- Comma Bosch harness installed in the car — the red panda connects **through** it, and the comma powers the harness (operator's rig; see `memory/reference/tooling/reference_operator_flash_hardware_topology.md`)
...
3. Flash bootstub:
```bash
# Needs the openpilot panda library installed — see guides/EPS-FLASH-RUNBOOK.md for full setup
