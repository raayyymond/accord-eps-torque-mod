...
> `docs/handoffs/2026-07/HANDOFF-2026-07-10-v31u-uds-telemetry-working.md` and
...
>    leave `0xB780C` (0x4800) stock. Built + flashed by `analysis-2020accord/builds/telemetry/build_v31u_uds_telem_tva.py`.
...
`docs/handoffs/2026-07/HANDOFF-2026-07-08-tier1-telemetry-and-visibility-correction.md`.
...
absent — see `analysis-2020accord/reference/can-scans/2026-07-08-*`). The **diagnostic** channel, however, crosses
...
`analysis-2020accord/builds/telemetry/build_tier1_telem_tva.py` (`TOUCHED_BLOCKS` + `recompute_crc`). Emit the `.rwd` via
