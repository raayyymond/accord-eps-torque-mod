...
> **Topology correction (2026-05-28, per operator):** the red panda connects **through the comma Bosch harness** (installed in the car; the comma powers it), NOT directly into the OBD-II port. OBD-II-direct wording below has been corrected. See `memory/reference_operator_flash_hardware_topology.md`.
