...
`analysis-2020accord/v89_e1_leak_retrodiction.py`, `v89_e2_leak_robustness.py`,
`v89_e3_leak_profile.py`, `v89_e4_leak_placebo.py` → `_cache_r73/v89_e{1,2,3,4}_*.json`
...
4. **It had already been scored, and was already null.** `_cache_r6f/score_v86_bands.json`
...
Scripts: `analysis-2020accord/v89_f1_residual_probe.py`, `v89_f2_residual_pooled.py`
→ `_cache_r73/v89_f1_residual.json`, `_cache_r73/v89_f2_pooled.json`.
