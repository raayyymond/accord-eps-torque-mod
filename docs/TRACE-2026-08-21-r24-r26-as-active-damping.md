...
(`docs/HANDOFF-2026-08-20-v103-f0-is-the-endpoint.md` §8.1: *"G (r24's gain, 1–3× range) never
...
— **[RELAYED]**, `memory/reference-accord-car-is-tvca4-mode-24-26.md`: V73's own on-car probe,
...
and extending, `accord-stock-mode24-equals-mode26-damper-is-ours.md`'s finding for the other
...
the 8×-era amplitude (`docs/HANDOFF-2026-08-20-v103-f0-is-the-endpoint.md` §6.3, "rejected suggestion"
...
`docs/HANDOFF-2026-08-20-v103-f0-is-the-endpoint.md` O31: *"GATE 1 and GATE 2 have NOT been run for
...
(`docs/HANDOFF-2026-08-20-v103-f0-is-the-endpoint.md` §6.3, `b6` comparator — **[RELAYED]**, not
...
(route 77, `v92_rez.log`) `= −40.9°`, then the polarity flip (`gp-0x6752=−1`, `+180°`) gives
