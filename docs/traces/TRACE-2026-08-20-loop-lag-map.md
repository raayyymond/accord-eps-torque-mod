...
`flagA`. This kit's own measurement (`memory/accord/firmware/accord-return-centre-and-detent-dead-engaged.md`,
...
- **The old repo-committed `studies/models/eps_loop_gain_model.py` (V38-era) was read and explicitly NOT reused**:
...
- **Did NOT independently verify any route-`0x9e` telemetry claim** — IMU coherence figures, the
  ...
  These require the rlog cache (`analysis-2020accord/_scratch/cache/r9e/`), outside this agent's toolset
