...
same-day loop identification (`review/GATE2-2026-08-20-boost-direction.md`) bounds the **assist loop's own
...
(`analysis-2020accord/builds/v80_v107/build_v102_tva.py:698-700`, `builds/v80_v107/build_v103_tva.py:555`, reproduced verbatim in
`specs/SPEC-2026-08-20-v104.md` §2.1):
```python
...
| 3 | `arb_setpoint_limit` LERP | `0xCB844`→ this car's record `0xE51A8` | **cal**, per-part-number | this car: raised, 16384 (8/12 records raised; [prior EVIDENCE, fully traced §4 of `research/FEASIBILITY-8X-LKAS.md`]) | selects a per-mode ceiling on the pre-gain setpoint | no — headroom already spent, doesn't change with gain |
...
`specs/SPEC-2026-08-20-v104.md` §2.1 — V87/V99/V100 (4×), V101 (8×), V102/V103 (6×), all reproduce the rule
exactly]**
...
in ONE CRC block, `[0xC6000,0xC6FFC)`, trailer `0xC6FFC` — [EVIDENCE, `specs/SPEC-2026-08-20-v104.md` §2.3]
...
2. **`V101`'s own stated premise was measured false.** Its build header (`builds/v80_v107/build_v101_tva.py`) argued:
...
3. **The loop margin is quantified, and it shrinks with gain.** `review/GATE2-2026-08-20-boost-direction.md`
...
4. **Motor current / thermal hardware limit downstream of the governor and FOC chain** — flagged
   **[OPEN]** in `research/FEASIBILITY-8X-LKAS.md` and not investigated further this session (out of scope
...
`analysis-2020accord/builds/v80_v107/build_v101_tva.py`, `builds/v80_v107/build_v102_tva.py`, `builds/v80_v107/build_v103_tva.py` (headers, EME audit,
gain/clamp arithmetic); `docs/research/FEASIBILITY-8X-LKAS.md` (Parts 1-2, prior clamp-chain trace at 4×/8×);
`docs/specs/SPEC-2026-08-20-v104.md` §§0.1-0.3, 2.1, 2.3, 3 (5-image ladder validation, cross-build cell
matrix, operator's V103 verbatim report, V101 re-run risk); `docs/review/GATE2-2026-08-20-boost-direction.md`
§§0, 3 (`|κG|` identification); `docs/STATE.md` (V101-V103 headline results, corrections list,
f0/gain-confound finding); `analysis-2020accord/model/eps_chain_core.py`, `model/eps_chain_delivery.py` (golden
