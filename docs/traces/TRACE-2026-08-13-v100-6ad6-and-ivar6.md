...
|---|---|---|
| 1 | Can the 100 Hz `0x14A` builder preempt a partial 1 kHz pass? Decides whether Q2's skew is 0 or ≤1 tick. | Read the INTC priority registers for the two task vectors from the boot init, against `reference/svd_for_ghidra/UPD70F3508_V850E2Px4.svd`. |
