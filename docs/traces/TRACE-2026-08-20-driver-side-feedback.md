...
Read (in order): `CLAUDE.md`, `firmware-decompile` skill, then targeted memory: `accord/signals/accord-gp6b26-is-inertia-not-damping.md`,
`accord/signals/accord-gp6bbe-is-viscous-plus-dc-pedestal.md`, `reference/firmware/reference-accord-c646c-shared-gain-not-lkas-only.md`,
`accord/mechanism/accord-engagement-amplifies-6-9hz-via-coulomb-relay.md`, `accord/firmware/accord-fun3b8f6-coulomb-relay-proportional-to-command.md`,
`accord/calibration/accord-c616c-never-raise-driver-torque-relay.md`, `accord/mechanism/accord-firmware-adds-torque-to-bar-engaged-at-low-speed.md`,
`accord/calibration/accord-mode-27-is-a-second-engaged-column.md`, `accord/mechanism/accord-ratchet-scales-with-wheel-rate.md`,
`accord/mechanism/accord-ratchet-is-engagement-required.md`, `accord/firmware/accord-aggregator-reaches-motor-via-gp6acc-bridge.md`,
`accord/mechanism/accord-two-ratchets-micro-is-the-779hz-line.md`, `accord/mechanism/accord-f0-crossover-is-the-endpoint.md`,
`accord/signals/accord-gp6752-is-negative-one.md`, and from my own agent-memory:
...
Then `docs/STATE.md` lines 1–294 (latest block), `analysis-2020accord/builds/v80_v107/build_v103_tva.py` (header + cal
...
- Lineage greps of `build_v*_tva.py` for every cal cell named below, and full read of `builds/v18_v49/build_v39_tva.py`'s
...
[EVIDENCE, verified 3 ways per `accord/signals/accord-gp6752-is-negative-one.md`, independently re-confirmed by a sister
...
Countervailing: on-car V92 telemetry (`accord/signals/accord-gp6bbe-is-viscous-plus-dc-pedestal.md`) measured
...
2.8–6.58× engagement amplification of 6–9 Hz (`accord/mechanism/accord-engagement-amplifies-6-9hz-via-coulomb-relay.md`).
...
`analysis-2020accord/builds/v18_v49/build_v39_tva.py` header (full read, not just its cal table): V39 was a **cave**
...
Flashed 2026-07-19: **neither symptom improved.** `builds/v18_v49/build_v42_tva.py`/`v42-flashed-...md`: r26 zeroed
...
carried forward on the current lineage (`accord/builds/accord-v42-ratchet-fix-lost-since-v53.md`, restored V80-on).
