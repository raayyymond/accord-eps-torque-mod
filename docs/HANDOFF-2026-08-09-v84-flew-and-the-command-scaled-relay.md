...
**Read `docs/STATE.md` first.** Predecessor: `HANDOFF-2026-08-08-v83a-flew-and-r24-is-the-actor.md`.
...
67/68 are perfect thermometers containing neither value. Orchestrator-verified from `_cache_r6d/`.
...
| 13 | `decode_two_angles.py`'s premise is void — the two `0x14A` angles are byte-identical on 280,598/280,598 frames. ⊕ `0x14A` angle/rate is **BELOW the bar**. `tq` LSB is **8**, not 1 |
