...
> `HANDOFF-2026-07-20-v41-ratecap-flat.md`.
>
...
> carried forward correctly in `HANDOFF-2026-07-20-session-v40-fault-investigation.md`.
...
`verify_bootloader_crc.py` now exposes both walks, with the bridge restored and documented so it is
...
Builder: `analysis-2020accord/build_v41_tva.py`. **CAL-ONLY — zero code edits, zero caves.**
