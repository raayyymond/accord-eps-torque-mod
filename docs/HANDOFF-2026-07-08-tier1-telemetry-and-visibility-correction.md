...
**Supersedes** the same-lineage `docs/HANDOFF-2026-07-07-visibility-resolved-and-ram-telemetry.md` — that doc's
...
Builder: `analysis-2020accord/build_tier1_telem_tva.py` (plain image `../accord-firmware/analysis-2020accord/_tier1_plain_image.bin`).
...
`analysis-2020accord/analyze_telem_0x660.py` (byte positions identical to V31T; rename the middle/third fields).
...
## 7. Artifacts & commit
Commit `512a11a` on `main` (fast-forwarded from `5358444`): `build_tier1_telem_tva.py`, `_tier1_plain_image.bin`,
