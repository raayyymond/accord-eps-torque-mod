...
session, cited from `docs/BUILD-LINEAGE.md` / `docs/STATE.md` / `analysis-2020accord/model/eps_lkas_chain_model.py`,
...
— see `memory/reference/firmware/reference-accord-damping-clamp-dtc1d-trap.md`), consistent with V73's finding that most
...
`model/eps_lkas_chain_model.py:2232`]**. Measured directly on-car (route 5d, teammate relay): a hard slew cap
...
with V40's brick (`memory/reference/tooling/reference-crc-chain-is-50-blocks-c5000-not-a-gap.md`: "the causal link to V40's
...
5. **Whether any 8× stage is worth pursuing at all given §2.0/§2.4** — a firmware-only fix cannot address
   ...
   modifications (`memory/feedback/builds/feedback-no-openpilot-side-modifications.md`).
...
`docs/STATE.md`, `docs/BUILD-LINEAGE.md` (RULES 3-7), `analysis-2020accord/model/eps_lkas_chain_model.py`
...
clamp-dtc1d-trap.md`, `memory/reference/tooling/reference-crc-chain-is-50-blocks-c5000-not-a-gap.md`,
