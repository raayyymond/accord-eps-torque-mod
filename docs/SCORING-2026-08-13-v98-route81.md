...
Artifacts: cache `analysis-2020accord/_cache_r81/` · extractor `rlog-tools/extract_r81.py` ·
scorer `rlog-tools/v98_r81_score.py` · outputs `analysis-2020accord/_v99/v98_r81_score.{json,log}`.
...
### The freeze detector (pre-registered in `build_v98_tva.py` §VAL) [EVIDENCE, and it is WEAK]
