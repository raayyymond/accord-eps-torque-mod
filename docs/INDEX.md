...
| [FIRMWARE-DECOMPILE-GUIDE.md](./FIRMWARE-DECOMPILE-GUIDE.md) | Agent-driven decompilation reference: **radare2/rizin** first, **capstone Python** for scripted iteration, **Ghidra** last for full decompilation. Pair with the `.claude/skills/firmware-decompile.md` skill. |
