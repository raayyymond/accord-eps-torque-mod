...
`memory/accord-telemetry-conventions-that-produced-wrong-answers.md`.
...
- **The `0xC61D6` "fresh" rate limiter.** Surfaced as the ratchet's cause. It is **REJECTED** — an
  ...
  pre-V18 `old_tools/` build), and an agent-memory still closed with *"FIX = set 0xC61D6 to 14."* Both
  fixed.
