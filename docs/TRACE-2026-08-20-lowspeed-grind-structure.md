...
manual — see `accord-return-centre-and-detent-dead-engaged.md`) is explained structurally: **normal
...
(`reference_accord_gp4f60_is_sensor_b_column_torque.md`) that characterized this exact branch in an
