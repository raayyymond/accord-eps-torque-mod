...
`builds/v80_v107/build_v85_tva.py` declares **10 `FROZEN_CELLS` + 2 `FROZEN_BYTES` = 12** items. All 12 verified from
...
`analysis-2020accord/lib/verify_bootloader_crc.py`. CRC primitive = HW DCRA @`0xFF836020` = Ethernet
