...
(rows V85→V98) · `docs/archive/arc-maps/_v87_symptom_ladder.md` (the 2026-08-08 ladder — **extended here, not
...
`memory/accord/calibration/accord-base-assist-damper-cannot-reach-the-micro-regime.md` (★★ in `MEMORY.md`) asserts
...
📋 **ACTION FOR CLOSE-OUT: `memory/accord/calibration/accord-base-assist-damper-cannot-reach-the-micro-regime.md` must be
  ...
  **Why it could not be scored — three reasons, none of them the lever:**
  1. **NO INSTRUMENT.** V96's cave carried unchanged; its regressor is **34× over-range** — `M ≡ 0` on
     **10,749/10,749** frames, `Mlo` duty **0.0000**. S1/S2 **VOID** — *conceded in
     `builds/v80_v107/build_v97_tva.py:99-100` **before the flash.***
...
`analysis-2020accord/studies/ledger/ledger_v38_to_v98_bytes.py`; output `ledger_v38_to_v98_out.txt`;
...
1. **Correct `memory/accord/calibration/accord-base-assist-damper-cannot-reach-the-micro-regime.md`** — four of its claims
