...
> **READER** [EVIDENCE]: `analysis-2020accord/studies/ledger/arc_map_v87_reader.py` — extends
> `analysis-2020accord/studies/ledger/ledger_v38_to_v85_bytes.py` to **V86 and V86B** (the old reader stops at V85 and
...
> **Relationship to `docs/archive/arc-maps/_session_v86_arc_map.md`:** that document is verified and largely correct; this
...
Operator quotes are verbatim from `docs/archive/LEDGER-V38-TO-V84.md` §2.1–2.3 and `docs/STATE.md`.
