...
`_*_plain_image.bin` snapshots on disk** via `analysis-2020accord/studies/ledger/ledger_v38_to_v99_bytes.py`
(new file this session, extends `studies/ledger/ledger_v38_to_v98_bytes.py` by exactly one build, V99), **never
from the build scripts.** Reproduce with:
```
ACCORD_FIRMWARE_ROOT=C:/Users/dudei/Desktop/Projects/accord-firmwares
python analysis-2020accord/studies/ledger/ledger_v38_to_v99_bytes.py            # everything
python analysis-2020accord/studies/ledger/ledger_v38_to_v99_bytes.py frozen     # the matrix below (B2)
python analysis-2020accord/studies/ledger/ledger_v38_to_v99_bytes.py delta      # the V99 cumulative table below (C)
```
...
a separate, parallel pass this session (`rlog-tools/decode/extract_r82.py`, `rlog-tools/score/v99_r82_score.py`
