# STATE ARCHIVE — the V279-era standing reference and the 84 finding/correction blocks (2026-08-30 → 2026-09-11)

Moved out of `docs/STATE.md` on 2026-09-13 at the V291 close-out to keep that file under its ~150 KB target.
**A record of what was believed when each block was written, not an instruction.** Nothing was retracted by the move;
every decision-bearing correction was already folded into the STATE decision box before the move.
