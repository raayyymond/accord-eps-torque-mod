...
[[reference-accord-v50-gp4f60-repoint-asymmetry-carryover-and-completeness-gap]] — 2026-07-23: this
matched-shadow argument is filter-shape-agnostic (holds for any strictly-attenuating, non-peaking filter)
and was re-applied to V50's EMA low-pass, which uses the identical hook/repoint topology.
