...
description: "Slew/rate-of-change limiter in s_motor_torque_rate_shaper (FUN_00042af8) for 39990-TVA-A160; step constant tp+0x71d6 = ABS 0xC61D6 = 0 (DISABLED in stock; the 0xC71D6/14 reading was an off-by-0x1000 address error). accumulator gp-0x356c, SYMMETRIC. step=0 = NO recovery ramp => the EME amplifier (hard cut+hold+jump). FIX = set 0xC61D6 to 14 (V16)."
metadata:
  type: reference
---
