...
(`builds/v18_v49/build_v39_tva.py`) replaced `ld.h -0x6bd0[gp],r9` with `jr 0xC4B34` (4-byte trampoline), ran a 44-byte
...
zero faults** (`memory/builds/v39-flashed-no-improvement.md`: "neither symptom fixed" — it falsified its own
...
postmortem (`memory/reference/builds/reference-accord-v48b-flashed-catastrophic-ram-collision.md`) explicitly
...
wrong) · `memory/reference/builds/reference-accord-v48b-flashed-catastrophic-ram-collision.md`,
`memory/builds/v39-flashed-no-improvement.md`.
