...
- [★★★★★ 4x gain cal 0xC646C: 6-reader enumeration + feedback classification — REVISED: real feedback path but NOT the 21Hz driver](reference_accord_c646c_gain_feedback_vs_forward_classification.md) — FUN_00036682/28 chain into gp-0x6b98 but is slow (2.18Hz)/small-authority(±512); its saturation nonlinearity (18830→4707 threshold shift, verified) never fires on 62,547 active-LKAS CAN399 frames across 2 confirmed-21Hz on-car routes. Free cal word found (0xC6CD0); no LKAS-only upstream gain substitute exists — recommended fix retargets only 0x2a1ee. ⚠ addendum: tp+0x73d2 re-read as 6 not 14, unresolved discrepancy.
- [★★★★★ Full gp-0x6b98 aggregator lane inventory: 9 lanes ranked by 20Hz bandwidth; gp-0x6bbe/gp-0x6bd0 NEW near-transparent (-1.2dB) carriers; gp-0x6b86 largest lane (±12288) at -3.9dB adaptive-worst-case; gp-0x67ac gate zeroes 5/9 lanes wholesale — its own trigger still unresolved](reference_accord_gp6b98_aggregator_full_lane_inventory.md) — gp-0x6ad4 (FUN_0003a382) is the only confirmed 0dB/fully-wideband lane; LKAS lane -12dB; FUN_00036682 weakest at -26.6dB.
- [★★★★★ DECISIVE: 0xC6AF0 mute UNCONDITIONALLY zeroes gp-0x6ad4's final output — branch-agnostic kill, register-trace verified](reference_accord_gp6ad4_engagement_gate_and_36682_closed_loop_math.md) — 0x3a7aa (ceiling=LERP-derived) never overwritten through 0x3a88c-0x3a8a0's compare/select/store; both branches store 0 when ceiling=0, regardless of Stage A/B/C's combine result. Settles the build question independent of which branch produces the measured gain. ⚠ ALSO CORRECTED: gp-0x67fe==0 gate is EPS-assist-DOWN not openpilot-disengaged (V31P telem); gp-0x6ad4 live in manual driving too, mute touches manual feel (GATE 2). FUN_00036682 separately ruled out as 21Hz carrier (0.005-0.011 counts/count, closed-loop math not simple EMA).
- [★★★★★ V56 damping-sign task: FUN_0003a382 is a real P/I/D (Stage A=proportional, B=integral anti-windup, C=raw derivative); gp-0x6ad4 disasm-PROVEN ADDED (never subtracted) into the aggregator, polarity gp-0x6752 boot-init'd to +1 (no inversion); z-domain freq response P-dominated 3-8Hz, D grows to rival P by 21Hz (+42..+55° lead); Q4 CLOSED 2 ways — sole reader of 0xC6AF0 image-wide](reference_accord_fun3a382_pid_structure_aggregator_addsign_and_freqresponse.md) — corrects "residual=sensor-minus-continuous-model" framing: ERR's bias is a 2-state ±8192 selector, so AC content = raw torque sensor at unity/zero-phase. Phase numbers diverge from the engagement-gated-loop memory's "-3.3 to -5.4° net lag" estimate — flagged open, not silently overwritten. gainD (L4) inherited unverified this session.
