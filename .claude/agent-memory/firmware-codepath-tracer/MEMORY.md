...
- [r26 adaptive lane: full trace + sign proof](reference_accord_r26_adaptive_lane_full_trace_and_sign.md) — V39 theory falsified. ⚠ its gp-0x6b5e "hard zero-force gate" characterization is likely BACKWARDS/imprecise — see the V61 entry below, not independently re-confirmed, flagged not overwritten.
- [🛑★★★★★★ V61 taps confirmed on stock; sign is polarity-INDEPENDENT lead-shape; gain-arm priority decoded incl. a NEW dead gp-0x683c gate; all 6 gain cals FUN_0003aa2c-exclusive; gp-0x4f62 fully enumerated, 0xC64BE=0 dead branch VERIFIED in C](reference_accord_v61_taps_gain_priority_and_sign_apples_to_apples.md) — headroom: r24 has ~7-22x before clipping at the measured ±1400ct/21Hz bar oscillation; r26's headroom blocked on avg(gp-0x69a4)'s magnitude, still OPEN. Session-2 addendum: r24's default gain arm is MODE-INDEXED via gp+0x63fd (0xD2AEC/D2B28=mode10, 0xD6AEC=mode22, NOT a dead mirror) while r26's is not — this asymmetry is why V62 doubles both lanes via sar 0xa→0x9 code edits, not a cal edit; 0xC6C42(D) lockstep-desync concern RETRACTED (single-reader), D held as a V63 phase-lever fallback instead.
