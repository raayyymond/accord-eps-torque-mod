...
**This contradicts `docs/RED-PANDA-EPS-SETUP.md`** (and the EPS-FLASH-RUNBOOK), which state the red panda plugs **directly into OBD-II with the comma harness unplugged**. The docs are wrong/generic for his actual practice. (Doc-fix offered; not yet applied as of writing.)
