...
these three facts had no home in the shared record. Full trace: `docs/TRACE-2026-08-13-c63ae-lever.md`
...
⊕ Confirms `build_v97_tva.py`'s "Path 1 is unweighted" claim.
...
|---|---|---|
| `v87_probe_6b98.py` | made rectification a MEASUREMENT — screens each window, reports screened AND unscreened | ✅ |
| `decode_v90_probe.py`, `v92_boost_lane_and_rez.py`, `v95_lane_decomposition.py`, `v96_probe_vs_ratchet.py`, `v97_r80_vs_v96.py` | all use the SIGNED lane for spectra | ✅ |
| **`v98_r81_score.py:541`** | feeds the RECTIFIED lane into D4b | ❌ |
| **`v99_r82_score.py:672,718`** | feeds the RECTIFIED lane into AUDIBLE + CROSSBUILD | ❌ |
...
`v98_r81_score.py` or `v99_r82_score.py`.
