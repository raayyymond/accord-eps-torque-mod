...
- **V46 FLASHED → vibration unchanged → LEVER A FALSIFIED.** V46 = V38 + ratchet + Stage A carrier
  ...
  falsified vibration lever. Builder `analysis-2020accord/builds/v18_v49/build_v46_tva.py` retained as the record.
...
- **V47 = ratchet + DAMPING RESTORE ONLY, BUILT + verified, UNFLASHED.** The current candidate. Opens
  ...
  Builder `analysis-2020accord/builds/v18_v49/build_v47_tva.py`. RWD SHA `1421ca1b…afb7bc34`; 23 bytes vs V38 in 2 CRC
...
Handoff: `docs/handoffs/2026-07/HANDOFF-2026-07-21-v46-v47-vibration.md`.
