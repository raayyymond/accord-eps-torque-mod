...
## 🛑 THE REUSABLE LESSON
`docs/GATE2-2026-08-11-cbe74-independent.md` uses a sign convention **opposite** to the kit's canonical
`Re(Z)` tool (`rlog-tools/decode_v90_probe.py::_band_transfer`). Each is internally consistent; reading
