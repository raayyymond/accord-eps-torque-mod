...
top lever — WRONG, verified against `build_v46_tva.py`/`build_v47_tva.py`; that agent's structural aggregator
...
"filter the root feeding 7+ carriers." The four-frame telemetry (`build_vfourframe_tva.py`, logs the
