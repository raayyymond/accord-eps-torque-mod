...
description: "V69 built 2026-08-04 (unflashed), RE-CUT the same day to ×4 dose + a ratchet-aimed probe — reverts V67's flat LKAS-gated arm and scales the low-speed end of Honda's own gain surface, so highway returns to exactly stock."
metadata:
  node_type: memory
  type: project
