...
**V48A — cal-only, BUILT + VERIFIED + FLASHED → did NOT fix the vibration.** `build_v48a_tva.py` =
...
`analysis-2020accord/build_v48b_tva.py` + `v48b_cave_asm.py` + `eps_v48b_cave_model.py`. V38 + ratchet +
...
[[reference-accord-v48b-notch-cave-build]] and `docs/HANDOFF-2026-07-21-v48b-notch-build.md`.
...
Read `docs/VIBRATION-DOSSIER.md` + `docs/HANDOFF-2026-07-21-v48-vibration-loopgain-notch.md`.
