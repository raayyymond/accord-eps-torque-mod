...
description: "Standing instruction — every EPS investigation or firmware-fix session must be grounded in the full eps_lkas_chain_model.py and the whole post-V38 build arc, and every subagent primed with both."
metadata: 
  node_type: memory
  type: feedback
...
(`analysis-2020accord/eps_lkas_chain_model.py`, the golden reference) and **(b)** all recent effort
