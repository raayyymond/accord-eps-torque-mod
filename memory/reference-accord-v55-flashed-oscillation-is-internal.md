...
- Analysis scripts: `rlog-tools/decode_v55_motorcmd.py`; the session's Welch/H1/rail scripts are described
  in `docs/HANDOFF-2026-07-28-v55-drive-oscillation-is-internal-and-v56-mute.md`.
