...
**Audited 2026-08-21 with `analysis-2020accord/check_427_alias.py` — EVIDENCE, byte-identity check
...
## THE GUARD
`analysis-2020accord/check_427_alias.py`:
...
`build_v102_tva.py` / `build_v103_tva.py`.]
