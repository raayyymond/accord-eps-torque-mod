...
| 3 | the same table, re-proposed 2026-08-13 as *"the speed LERP on the PID reference"* | vehicle speed | **`gp-0x69aa` = a Q15 governor DERATE product, unity `0x8000`, MIN-only, sole writer `0x45342`** (`mulu` / `shr 0xf` / `st.h`) | instance 2's own correction-of-record, `docs/TRACE-2026-08-10-damping-axis-hunt.md:257`, found by grep |
