...
independent ways; carried as `RATE_SCALE_CTS_PER_DEGS` in `rlog-tools/probe/decode_v72_probe.py` and
`RATE_SCALE` in `analysis-2020accord/studies/sessions/r59/analyze_r59_probe.py`.
