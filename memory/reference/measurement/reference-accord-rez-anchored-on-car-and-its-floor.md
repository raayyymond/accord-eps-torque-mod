...
## REPRODUCE
`python rlog-tools/studies/impedance/v95_rez_polarity_and_mask.py` (both anchors and the mask pricing) ·
`python rlog-tools/studies/impedance/v95_crossbuild_rez_ledger.py` (the ledger and the floor panel).
