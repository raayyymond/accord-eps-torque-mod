...
## REPRODUCE
`rlog-tools/studies/impedance/v95_rez_polarity_and_mask.py` (§1) · `rlog-tools/studies/v95-override/v95_override_exposure.py` (exposure) ·
`rlog-tools/studies/v95-override/v95_override_onset_ringing.py` §2 (the hands-on amplitude contrast).
