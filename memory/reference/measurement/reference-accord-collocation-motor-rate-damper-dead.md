...
3. The loop-gain model quantifies it: **bare-plant Q≈1.7, but the 4× gain drives the derivative
   ...
   hard edge 4.57×). See `analysis-2020accord/studies/models/eps_loop_gain_model.py`.
...
Master reference: `docs/research/VIBRATION-DOSSIER.md`. Related: [[reference-accord-damper-two-deadzones-factorC-factorE]]
