...
`CTL` +0x9038 (arm/trigger), `MID0W` +0x11028 (ID<<18, IDE bit29). SVD: `reference/svd_for_ghidra/UPD70F3508_V850E2Px4.svd`.
...
`builds/telemetry/build_vcantx_test_tva.py` = V38 + a cave at 0xC4B34 (hook 0x55C0E, the proven 330-packer site, 62.5 Hz) that
