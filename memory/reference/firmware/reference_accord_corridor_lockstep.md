...
= `builds/v18_v49/build_v31_tva.py`** = V30 + a matched FLAT BOOST FLOOR (int `0xC6768/6A/6C`→4096, float `0xC65C4/C8/CC`→4.0,
...
> **V30 = `builds/v18_v49/build_v30_tva.py`** = V29 with the corridor at **×4 (4096 / float 4.0)** instead of ×2, to ALSO
...
> via `gp-0x6ac0` trace). 49/49 CRC, 0 code edits, UNFLASHED. Handoff `docs/handoffs/2026-06/HANDOFF-2026-06-03-v30.md`.
...
### V29 = `builds/v18_v49/build_v29_tva.py` (BUILT, cal-only, UNFLASHED)
...
handoff `docs/handoffs/2026-06/HANDOFF-2026-06-03-v29.md`.
...
- **Build:** cipher round-trips, **49/49 CRC PASS**, all readbacks pass (widened constants decode
  ...
  tolerance sites; road test is the arbiter. Full handoff: `docs/handoffs/2026-06/HANDOFF-2026-06-03-v28.md`.
...
## V27 build (current, UNFLASHED) — `builds/v18_v49/build_v27_tva.py`
