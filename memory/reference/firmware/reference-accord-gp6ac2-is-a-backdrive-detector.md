...
## What this corrects
- **`reference/firmware/reference_accord_corridor_lockstep.md`** describes the corridor's boost arm as
...
- **`reference/firmware/reference-accord-damper-two-deadzones-factorC-factorE.md`** calls the clamp
