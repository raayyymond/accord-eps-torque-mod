...
`builds/v18_v49/build_v25_tva.py` = **GAIN** (V18: `0xC646C` 891→1782, clamps `0xC61B4`/`0xC61B2` 512→1024, ramp
...
`analysis-2020accord/figures/aggregator/v25_corridor_before_after.png`. STUDY ARTIFACT — unflashed.
