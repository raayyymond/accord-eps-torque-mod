...
`analysis-2020accord/studies/models/eps_v48c_gate2_closed_loop.py` (pure stdlib; reuses the calibrated loop-gain model
`studies/models/eps_loop_gain_model.py` — MEASURED f0=21.4 Hz, Q(4x)=13.6, anchor |L(4x,w0)|=0.875, zeta_bare=0.294).
