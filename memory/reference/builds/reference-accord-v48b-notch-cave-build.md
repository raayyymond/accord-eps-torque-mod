...
`analysis-2020accord/builds/v18_v49/build_v48b_tva.py` + `studies/caves/v48b_cave_asm.py` (cave source of truth) +
`studies/models/eps_v48b_cave_model.py` (bit-exact integer model) + `studies/models/eps_v48b_notch_design.py` (DSP design). BUILT +
Ghidra-verified, **UNFLASHED**. V38 baseline + the confirmed state-4 ratchet fix (`0x454FE` bne→br) +
the notch. Read with [[project-v48-loopgain-v48a-failed-notch-next]] and `docs/research/VIBRATION-DOSSIER.md`.
