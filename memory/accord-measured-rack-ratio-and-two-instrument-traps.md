...
[EVIDENCE — `rlog-tools/measure_steering_ratio.py`, `ratio_two_sided.py`; cache
`analysis-2020accord/_cache_ratio/`; trace `docs/TRACE-2026-08-13-measured-steering-ratio.md`.]
