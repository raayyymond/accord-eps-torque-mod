...
`build_v53_tva.py` **imports the 774-byte cave from `build_vfourframe_tva.py`** instead of re-typing it, so
...
- **LERP-masquerade check passed** (the trap in `docs/HANDOFF-2026-07-24-low-speed-steer-lockout.md` §4e):
