# ★★ `gp-0x6ba6 == |gp-0x6b9a|` is the boost AMPLITUDE index — and `build_v58_tva.py` was wrong
...
`build_v58_tva.py` said `gp-0x6b9a` *"is the FIR chain's output and indexes boost's NON-flat table
