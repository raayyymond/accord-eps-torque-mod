...
**Do not propose it.** From `memory/project/project_accord_torque_mod_v0.md` (the V18 block, 2026-05-27), after an
...
built (`archive/old_tools/build_v16_tva.py:61`) but **never flashed**; there is no V16 `.rwd` or plain image on
disk.
...
1. **`0xC61D6` appears nowhere in `docs/BUILD-LINEAGE.md`** — that file covers V9→V58, and V16 is a
   pre-V18 `archive/old_tools/` build. The lineage doc now carries the pre-V18 rejections and a rule saying so.
...
Check `docs/BUILD-LINEAGE.md`, `analysis-2020accord/build_v*_tva.py`, **and** `archive/old_tools/` +
`project/project_accord_torque_mod_v0.md` before calling any address untested.
