...
`_v*_plain_image.bin` snapshots (`analysis-2020accord/studies/ledger/ledger_v38_to_v99_bytes.py`, `PTRS["FactorC"|
...
the V99 close-out — do not re-derive them.** Computed surface: `docs/archive/arc-maps/_v101_arc_map.md` §5.2c.
