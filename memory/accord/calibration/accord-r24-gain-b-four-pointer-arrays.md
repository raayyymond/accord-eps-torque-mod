...
`_v65_plain_image.bin`. Corrects a provenance gap in `model/eps_lkas_chain_model.py`.
...
⚠ **`builds/v50_v79/build_v62_tva.py`'s `GAIN_B_LERP_MODE10` tripwire watches only `0xD2AEC` and `0xD2B28`** — it is
