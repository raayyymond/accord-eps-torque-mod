...
`0xCBE74`'s LERP has exactly **one** documented output (`builds/v80_v107/build_v91_tva.py` §"THE LANE"):
...
rung (`\|b26\| ≥ 15`, r79). Tools: `rlog-tools/studies/v91-v94-dose/v91_v92_dose_in_force.py`, `studies/v91-v94-dose/v91_v92_dose_threeway.py`.
