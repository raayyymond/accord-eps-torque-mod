...
✅ `rlog-tools/probe/decode_v69_ratchet.py` was **fixed in place** the same session — a **128-sample floor
...
2026-08-04. Decoder `rlog-tools/probe/decode_v69_ratchet.py`, linked mechanically — the build **fails** if
