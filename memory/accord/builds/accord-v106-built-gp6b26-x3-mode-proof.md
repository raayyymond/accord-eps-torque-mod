...
2026-08-22. `analysis-2020accord/builds/v80_v107/build_v106_tva.py`, **50/50 assertions**, base = V105 (which flew as `a5`).
```
...
```
Each record base occurs **exactly once** as an LE32 literal image-wide. `builds/v80_v107/build_v100_tva.py`'s
`DOSE_FAMILY_Y` lists **three** (`builds/v80_v107/build_v105_tva.py` already had four). **Mode 24 is MANUAL** ⇒ dosing it
...
Drive card: `docs/handoffs/2026-08/HANDOFF-2026-08-22-v106-the-damper-and-the-one-mode.md` §5, nine numbered questions.
