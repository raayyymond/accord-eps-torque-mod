...
worst case)**. Doubling keeps ≥3.6× margin under every arm. Model: `analysis-2020accord/studies/models/rate_lane_damping_model.py`.
...
at all. Probe unchanged (`rlog-tools/probe/decode_v59_boostindex.py`), secondary readout only.
