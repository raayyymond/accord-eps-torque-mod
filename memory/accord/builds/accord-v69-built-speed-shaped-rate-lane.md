...
[[accord-aggregator-lane-mirrors-6ada-6adc]]. Spec `docs/specs/design/V69-DESIGN.md` §0; builder
`builds/v50_v79/build_v69_tva.py`; verifier `verify/verify_v69_image.py`; decoder `rlog-tools/probe/decode_v69_ratchet.py`.
