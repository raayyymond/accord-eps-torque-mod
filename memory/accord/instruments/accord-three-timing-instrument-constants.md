...
`extract/extract_imu_cache.py` maps each of `at` and `gt` to the CAN base by its **own** median
...
⇒ `analysis-2020accord/studies/grind2/grind2_trichannel.py` §0/§3/§3c · `_scratch/out/_grind2_trichannel.json`.
