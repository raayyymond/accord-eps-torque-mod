...
times**, not a build contrast. Tool: `rlog-tools/studies/v91-v94-dose/v92_boost_lane_and_rez.py`.
...
scoreable windows — a census artefact, not a null; `rlog-tools/studies/v91-v94-dose/v92_micro_regime.py`), pooled over
all three routes:
