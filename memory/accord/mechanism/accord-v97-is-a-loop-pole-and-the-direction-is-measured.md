...
39990-TVA,A160-V97-V96BASE-C63AC.102to150-0x13000-0x100000.rwd
  ...
  builder analysis-2020accord/builds/v80_v107/build_v97_tva.py   131/131   BASE = V96 (on the car)
```
...
1. **`Q = −d(gp-0x6b70)/d(T)`** — 427 magnitude + sign bit vs `0x18F` STEER_TORQUE_SENSOR, hands-off
   engaged returns, episode-bootstrapped (`rlog-tools/studies/damping-q/v97_measure_Q.py`):
