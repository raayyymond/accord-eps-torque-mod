...
- The kit's caches (`decode/extract_r67_v81.py`, and `extract66`'s schema **verbatim**, so *every* `_cache_*`)
...
Method and code: `rlog-tools/studies/loop-causality/v81loop_alias.py` (S0.6b), `rlog-tools/lib/v81loop_lib.py::native_18f`.
