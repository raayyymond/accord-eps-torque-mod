...
per-opcode displacement rules (`analysis-2020accord/studies/firmware_scan/scan_gp_accesses.py`, self-check pinned on
`gp-0x6b94`). This closes the *"single-method, wants a raw byte scan"* residual `builds/v50_v79/build_v62_tva.py`
