...
Recovered from **V72's flown cave on route `59`** (87,940 frames, `_scratch/cache/r59/r59s*.npz`), where
...
(`analysis-2020accord/studies/models/assist_map_mirror.py`) that was **not fitted to this cell**. It is a simultaneous
