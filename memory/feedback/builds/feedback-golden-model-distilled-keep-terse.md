...
`analysis-2020accord/model/eps_lkas_chain_model.py` had ballooned to 4,709 lines / 347 KB — comments and
...
model/eps_lkas_chain_model.py` (`_self_check()` + `_demo()`) produced byte-identical stdout before and after.
...
See `docs/handoffs/2026-07/HANDOFF-2026-07-29-golden-model-distillation.md` for the session narrative.
