...
- **Keep records current AS YOU GO**, not only at close-out: the golden models `model/eps_lkas_chain_model.py` /
  `studies/models/eps_loop_gain_model.py`, the relevant `memory/` files + `MEMORY.md` index, and a `docs/HANDOFF-*.md`.
