...
`analysis-2020accord/reference/fw_inventory/decompilation/disasm_v850.py` (a CLI-disassembler
wrapper, now retired).
...
`.claude/agents/firmware-codepath-tracer.md`, and `docs/guides/FIRMWARE-DECOMPILE-GUIDE.md`
