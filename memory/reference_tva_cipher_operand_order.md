...
**Root-caused 2026-05-24; CONFIRMED by successful V9b flash same day.** Full writeup now: `analysis-2020accord/HOW_TO_BUILD_ACCORD_TVA_RWD.md` §2 (was `CIPHER_KEY_ORDER_BUG.md`, since distilled). This was the cause of the V8 `0xFF01` → NRC `0x72` failure (see [[reference-tva-bootloader-crc-scheme]] for the check it tripped).
