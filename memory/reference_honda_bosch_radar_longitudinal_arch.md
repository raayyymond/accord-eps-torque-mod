...
**Established 2026-05-28** (code-first audit of `analysis-2020accord/opendbc_reference/honda/` for the addon-radar spec). Corrects an earlier research-agent mislabel that called these cars "radarless."
