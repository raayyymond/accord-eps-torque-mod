...
The base power-steering path (the always-on assist that responds to the driver's own hand torque), traced end to end 2026-07-18. Supersedes the abstract placeholder that previously stood in for it in `analysis-2020accord/eps_lkas_chain_model.py`.
