...
**V44 = V43 + 12 bytes: revert the falsified pole (`0xC644A` 32→1024) + raise the hands-off damping gate (`0xD27C6` 0→235 mode 10, `0xD27DA` 0→234 mode 11).** Cal-only, dual-verified, NOT flashed. Builder `analysis-2020accord/build_v44_tva.py`; handoff `docs/HANDOFF-2026-07-20-v44-handsoff-damping.md`. Carries the confirmed ratchet fix (`0x454FE`) unchanged.
