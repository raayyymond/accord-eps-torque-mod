...
hypothesis — it can only confirm or fail to confirm what the prediction already assumes.** `r5d_falsifiers.py`'s
...
([[accord-v60-null-closes-parametric-pump]] / `accord-v59-parametric-pump-marginal.md`). V74 has the
...
1. **Cross-build tracking regression** [EVIDENCE, `analysis-2020accord/r5d_tracking_test.py`,
   `_r5d_tracking_test.json`]. Regress the un-anchored wideband peak's location against `5 x f0` and
...
2. **Odd-harmonic-series completeness** [EVIDENCE, `r5d_3xf0_check.py`, `_r5d_3xf0_check.json`]. A
...
- the UN-anchored wideband peak search + cross-build tracking regression
  (`analysis-2020accord/r5d_tracking_test.py` is the reference instrument, keep it),
