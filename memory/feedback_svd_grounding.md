...
- The canonical SVD for the 2020 Accord EPS is
  `analysis-2020accord/svd_for_ghidra/UPD70F3508_V850E2Px4.svd` — for the exact chip **Renesas µPD70F3508 /
...
The SVD is also loaded into Ghidra (the `svd_for_ghidra/` path) so peripheral registers appear by name in
