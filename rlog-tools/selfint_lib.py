...
CHANNEL CHOICES -- deliberately the SAME ones `compare_r67_v81_grind.py` /
`compare_v75_v76_v80_grind.py` use, so every number here is commensurable with the kit's record:
...
ROUTES = {
    "V84/r6d":  ("_cache_r6d",  "r6ds",  12),
    "V83a/r68": ("_cache_r68x", "r68xs",  8),
    "V81/r67":  ("_cache_r67x", "r67xs", 14),
    "V80/r66":  ("_cache_r66x", "r66xs", 15),
}
