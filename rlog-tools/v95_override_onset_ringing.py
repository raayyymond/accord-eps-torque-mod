#!/usr/bin/env python3
r"""v95_override_onset_ringing.py -- the follow-up the crossing-rate test does NOT settle.

🛑 WHY THIS FILE EXISTS.  `v95_override_authority_chatter.py` refutes the authority curve as a 6-9 Hz
...
Usage:  python v95_override_onset_ringing.py
"""
import sys
