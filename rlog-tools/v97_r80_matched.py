...
Fixes two defects in the first pass (`v97_r80_phase.py`), both found by running the control first:
...
def main():
    ...
    (AN / "_cache_r80" / "r80_matched.json").write_text(json.dumps(out, indent=1, default=float))
    print(f"\nwrote {AN/'_cache_r80'/'r80_matched.json'}")
