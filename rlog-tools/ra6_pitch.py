...
`ra6_peak.py` measured the 18-30 Hz ARGMAX and it went **DOWN** at low speed (22.73 -> 17.98) and
essentially nowhere at highway (26.97 -> 27.22).  That looks like a contradiction, and it is not:
`ra6_peak.py` section 4 shows the 30-45 / 18-30 energy SHARE **rose in all four regimes**.  The
...
json.dump(OUT, open(os.path.join(ROOT, 'analysis-2020accord', '_ra6_pitch.json'), 'w'),
          indent=1, default=float)
print("\nwrote analysis-2020accord/_ra6_pitch.json")
