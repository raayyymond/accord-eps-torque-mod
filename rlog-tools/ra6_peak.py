...
=================================================================================================
METHOD -- FROZEN, IDENTICAL TO `ra5_relocation.py` SO THE LADDER IS COMPARABLE
=================================================================================================
...
json.dump(OUT, open(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                                 'analysis-2020accord', '_ra6_peak.json'), 'w'),
          indent=1, default=float)
print("\nwrote analysis-2020accord/_ra6_peak.json")
