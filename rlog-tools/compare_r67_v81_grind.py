...
Usage:
    python compare_r67_v81_grind.py records   # build/refresh the 5-build window records
    python compare_r67_v81_grind.py analyze   # S0-S6 over five rungs
"""
import json
import pickle
import sys
