...
`_cache_r6d/records_v84_score.pkl` -- read-only.  That pickle is a REPORTED artefact, so this file
never writes it; V85's records are merged in memory and saved to `_cache_r6e/records_v85_score.pkl`.
...
Usage:
    python score_v85_r6e_bands.py records   # build V85's window records (slow, ~2 min)
    python score_v85_r6e_bands.py analyze   # B0-B7
"""
import json
import pickle
import sys
