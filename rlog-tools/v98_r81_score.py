...
Deliverables, in the orchestrator's priority order:
  D0  health + identity                      (done in `extract_r81.py`; re-asserted here)
...
# V98 byte-4 map, read off build_v98_tva.py's PAYLOAD.
...
def main():
    ...
    # ---- the FREEZE detector, pre-registered in build_v98_tva.py's VAL section
