...
`analysis-2020accord/_cache_r96/` and `_cache_r97/`.

THE INSTRUMENT IS NOT REIMPLEMENTED.  Exactly the `extract_r95.py` pattern: add a row to
`decode_v84_probe_r6d.ROUTES`, then call `extract_r7d.extract_route()` -- the SAME code that wrote
every cache since `_cache_r6d/`.  Field names, ZOH/interp convention, sentinel definition, the 0x1AB
...
Usage:
    python extract_r96_r97.py                 # both routes, full pipeline
    python extract_r96_r97.py extract 96
    python extract_r96_r97.py derive 96 97
"""
import json
import sys
...
NEW = {
    "96": ("75604b0a432fdc89_00000096--57f5183b32", 15,
           "analysis-2020accord/_cache_r96", "r96s", "r96", "V102"),
    "97": ("75604b0a432fdc89_00000097--489d7896b3", 18,
           "analysis-2020accord/_cache_r97", "r97s", "r97", "V9b-STOCK"),
}
