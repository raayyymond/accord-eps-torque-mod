#!/usr/bin/env python3
r"""v103_r9e_census.py -- ROUTE 9e (V103): FAULT + IDENTITY + EXPOSURE census, per segment.

PART 1  fault sentinels, CONFIG_VALID, OUTPUT_DISABLED, DTC bit2, STEER_STATUS, onroadEvents
PART 2  identity -- V103's ONLY witness is a VARYING b3 (build_v103_tva.py's own rule)
...
def main():
    ...
    Path(HERE / "_v103_r9e_census.json").write_text(json.dumps(OUT, indent=1, default=float))
    print("\n  wrote _v103_r9e_census.json")
