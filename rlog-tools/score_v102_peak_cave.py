#!/usr/bin/env python3
r"""score_v102_peak_cave.py -- TASK 3 (the 4x/6x/8x peak triple, done properly) and TASK 4 (the cave).

WHY THE FIRST PEAK PASS NEEDED REDOING
    `score_v102_matched.py` section B searched 15-32 Hz and the argmax fell on the 15 Hz BAND EDGE
