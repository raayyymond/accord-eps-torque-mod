#!/usr/bin/env python3
r"""Extract route `7d` -- the V94 flight -- into `analysis-2020accord/_cache_r7d/`, tap the FULL
0x1AB payload and 0x14A byte 7, and run V94's own parameter-free IDENTITY test.

🛑 THE INSTRUMENT IS NOT REIMPLEMENTED.  Exactly as `extract_r6e.py` .. `extract_r78_r79.py` do,
...
Usage:
    python extract_r7d.py                 # extract + identity + health + census
    python extract_r7d.py extract 7d
    python extract_r7d.py identity 7d
    python extract_r7d.py health 7d
    python extract_r7d.py census 7d
"""
import json
import sys
...
ROUTE_DEF = {
    "7d": ("75604b0a432fdc89_0000007d--83a5c80392", 3, "analysis-2020accord/_cache_r7d",
           "r7ds", "r7d", "V94"),
}
...
D.ROUTES.setdefault("78", ("75604b0a432fdc89_00000078--93548c06b3", 16,
                           "analysis-2020accord/_cache_r78", "r78s", "r78", "V91"))
D.ROUTES.setdefault("79", ("75604b0a432fdc89_00000079--cb7538ffae", 15,
                           "analysis-2020accord/_cache_r79", "r79s", "r79", "V92"))
...
#  Verbatim from `extract_r78_r79.py`.
# ======================================================================================
...
# ======================================================================================
#  EXPOSURE CENSUS -- verbatim from `extract_r78_r79.py`
# ======================================================================================
