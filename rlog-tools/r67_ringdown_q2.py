#!/usr/bin/env python3
"""CROSS-BUILD RINGDOWN Q, done properly.  Supersedes `r67_ringdown_q.py`, which FAILED.
...
Usage:  python r67_ringdown_q2.py
"""
import json
import sys
...
BUILDS = {
    "V76/r65": ("75604b0a432fdc89_00000065--ae43aa0f27", ROOT / "_cache_r65", "r65s", 11, 1.3866),
    "V81/r67": ("75604b0a432fdc89_00000067--9b3ebbe218", ROOT / "_cache_r67x", "r67xs", 14, 1.5798),
    "V80/r66": ("75604b0a432fdc89_00000066--276b942769", ROOT / "_cache_r66x", "r66xs", 15, 4.1597),
}
