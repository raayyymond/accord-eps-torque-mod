#!/usr/bin/env python3
r"""Exploration pass over `_cache_r7e` / `_cache_r7f`: verify the route-time map, confirm the
...
CACHE = {"7e": ROOT / "analysis-2020accord" / "_cache_r7e" / "r7e.npz",
         "7f": ROOT / "analysis-2020accord" / "_cache_r7f" / "r7f.npz"}
...
if __name__ == "__main__":
    ...
    (ROOT / "analysis-2020accord" / "_r7e_r7f_lowspeed.json").write_text(
