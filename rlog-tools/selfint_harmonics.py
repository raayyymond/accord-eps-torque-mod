#!/usr/bin/env python3
"""selfint_harmonics.py -- RELAY TEST: is the engaged torsion-bar signal richer in ODD harmonics
...
Usage: python selfint_harmonics.py
Writes: _cache_selfint/selfint_harmonics.json
"""
import json
import sys
...
def main():
    ...
    def san(o):
        ...
        if isinstance(o, (np.integer, int)):
            return int(o)
        return o
    (ROOT / "_cache_selfint" / "selfint_harmonics.json").write_text(json.dumps(san(out), indent=1))
    print("\nwrote _cache_selfint/selfint_harmonics.json")
