#!/usr/bin/env python3
r"""v103_r9e_final.py -- the four things the first four scripts left open.

1  b3's RUN-LENGTH vs a BERNOULLI-PER-FRAME NULL.  `v103_r9e_b3.py` found NO spectral line and an
...
def main():
    ...
    Path(HERE / "_v103_r9e_final.json").write_text(json.dumps(OUT, indent=1, default=float))
    print("\n  wrote _v103_r9e_final.json")
