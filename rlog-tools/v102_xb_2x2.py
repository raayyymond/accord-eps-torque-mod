...
🛑 `_cache_r71/` EXISTS -- at the REPO ROOT, not under `analysis-2020accord/`.  23,765 rows at
   99.2 Hz with the full bus channel set (`tq`, `rate_c`, `cs_ang`, `imu_*`, `cc_lat`, `e4tq`,
   `ws_*`).  No re-extraction was needed.  (`_cache_ratio/00000071.npz` at 14.6 Hz is the useless
