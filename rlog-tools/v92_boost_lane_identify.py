...
===================================================================================================
`v92_boost_lane_and_rez.py` measured Re(boost/rate) = +87..+89 counts per rad/s, FLAT across
...
Usage:  python v92_boost_lane_identify.py
"""
import json
import sys
...
def main():
    ...
    (CACHE / "_cache_r79" / "boost_identify.json").write_text(json.dumps(OUT, indent=1,
                                                                        default=float))
    print("\n  wrote analysis-2020accord/_cache_r79/boost_identify.json")
