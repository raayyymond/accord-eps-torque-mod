...
# route table -- V83a's cache/prefix/parked taken from score_v84_r6d.py's registry
ROUTES = [("V81/r67",  "_cache_r67x", "r67xs", [s for s in range(13) if s != 13]),
          ("V83a/r68", "_cache_r68x", "r68xs", [s for s in range(8) if s not in (0, 7)]),
