#!/usr/bin/env python3
r"""v103_r9e_symptom2.py -- FIXES TWO DEFECTS in `v103_r9e_symptom.py`, and adds the speed-matched
...
def main():
    ...
    Path(HERE / "_v103_r9e_symptom2.json").write_text(json.dumps(OUT, indent=1, default=float))
    print("\n  wrote _v103_r9e_symptom2.json")
