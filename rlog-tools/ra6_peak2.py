...
🛑 SELF-CORRECTION 6.  `ra6_peak.py`'s pooled low-speed argmax for V106 (17.98 Hz, "the mode moved
   ...
   `ra6_confound.py`'s matched cells show what conditioning does.  In the best-powered low-speed
...
json.dump(OUT, open(os.path.join(ROOT, 'analysis-2020accord', '_ra6_peak2.json'), 'w'),
          indent=1, default=float)
print("\nwrote analysis-2020accord/_ra6_peak2.json")
