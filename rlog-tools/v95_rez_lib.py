#!/usr/bin/env python3
r"""v95_rez_lib.py -- the shared instrument for the 2026-08-11/12 driving-point-impedance session.
...
directly comparable with `v92_rez_extend.py` and `v92_boost_lane_and_rez.py`.
...
SIGN CONVENTION, anchored rather than assumed (`v95_rez_polarity_and_mask.py`):
