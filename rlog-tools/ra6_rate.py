...
* Route `73` (V88) lives in `_cache_r73` at the REPO ROOT, not under `analysis-2020accord`, so it
  is loaded by explicit path.  It has no `v_rear`; rear wheel speeds are averaged directly.

Usage:  python ra6_rate.py
"""
import os
import sys
import json
...
json.dump(OUT, open(os.path.join(ROOT, 'analysis-2020accord', '_ra6_rate.json'), 'w'),
          indent=1, default=float)
print("\nwrote analysis-2020accord/_ra6_rate.json")
