#!/usr/bin/env python3
r"""stock_r97_rez_matched.py -- Re(Z) on STOCK vs the modded arms, SPEED-MATCHED.
...
if __name__ == "__main__":
    main()
    Path(__file__).with_name("_stock_r97_rez_matched.json").write_text(
        json.dumps(OUT, indent=1, default=float))
    print("\n  wrote _stock_r97_rez_matched.json")
