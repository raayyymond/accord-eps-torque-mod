#!/usr/bin/env python3
"""decode_v76_probe.py -- read V76's probe: THE GATE, its MASKING RISK, and the r24 arm ladder.
...
Usage:  python decode_v76_probe.py <rlog-or-segment-dir> [...]
"""
import os
import sys
...
# -- there is no thermometer invariant here. build_v76_tva.py asserts this tuple against its own
...
# 🛑 ONE LINE, deliberately. build_v76_tva.py asserts this exact basename appears in this file;
