#!/usr/bin/env python3
r"""v103_r9e_cave.py -- WHAT THE V103 CAVE ACTUALLY MEASURED, and what each rung LICENSES.
...
def main():
  ...
  b3         *** NEW ***  EVIDENCE for D_state's SIGN STRUCTURE ONLY.  It has NO magnitude
    ...
    Path(HERE / "_v103_r9e_cave.json").write_text(json.dumps(OUT, indent=1, default=float))
    print("\n  wrote _v103_r9e_cave.json")
