...
Predictions, fixed before the drive in `docs/handoffs/2026-08/HANDOFF-2026-08-08-v83a-flew-and-r24-is-the-actor.md`
...
route-68 number in it is currently irreproducible.  `decode/extract_r6d_r68.py` + this file are that
...
Usage:
    python score/score_v84_r6d.py records     # build/refresh the window records  (slow, ~10 min)
    python score/score_v84_r6d.py analyze     # S0-S7  the band scoring
    python score/score_v84_r6d.py grind2      # the grind-#2 event hunt + the §7b exposure accounting
    python score/score_v84_r6d.py ring        # the 26-31 Hz highway ring / limit cycle
    python score/score_v84_r6d.py imped       # S4: engaged-vs-manual impedance, V81's own estimator
    python score/score_v84_r6d.py all
"""
...
CACHE6D = ROOT / "_scratch/cache/r6d"
CACHE68 = ROOT / "_scratch/cache/r68x"
KMH = 1.0 / 3.6
