...
ROUTES = {"95": ("V101 8x, Lever B OUT", "_scratch/cache/r95/r95.npz"),
          "85": ("V100 4x, Lever B IN", "_scratch/cache/r85/r85.npz")}
out = {}
...
(ROOT / "analysis-2020accord/_scratch/cache/r95/r95_v102_prereg.json").write_text(
    json.dumps(out, indent=1, default=float))
print(f"\nwrote {ROOT / 'analysis-2020accord/_scratch/cache/r95/r95_v102_prereg.json'}")
