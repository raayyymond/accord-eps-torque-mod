...
🛑 WHY THIS IS NOT TAMPERING.  §10.5(b) of `docs/scoring/SCORING-2026-08-11-v90-flight.md` deliberately left
...
pre-registration means.  This file only READS `_scratch/cache/r77/records_v90_score.pkl`; it writes nothing
...
Usage:  python score/v91_prereg_threshold.py
"""
...
if __name__ == "__main__":
    ...
    print("  🛑 READ-ONLY on the frozen `_scratch/cache/r77`. Nothing is written into it.")
