...
if rows:
    ...
    print('  ANTI-DAMPING at the ratchet. That is the ratchet being FED, and it would mean the')
    print('  lane is a PUMP there, not the damper the 427-derived sign claimed.')
