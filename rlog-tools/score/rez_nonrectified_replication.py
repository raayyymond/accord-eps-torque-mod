...
if rows:
  ...
  READING: Re(Z)<0 engaged AND more negative than manual => ENGAGEMENT ADDS')
    ...
    print('  🛑 This REPLICATES the known system-level result. It does NOT overturn')
    print('     \"every tapped lane damps at 6-9 Hz\", and does NOT license a 6-10 Hz notch:')
    print('     system Re(Z) and per-lane phase are DIFFERENT OBJECTS. Their coexistence is')
    print('     what forces the source to be NONLINEAR -- no set of damping linear lanes')
    print('     gives an anti-damped system. That points at the Coulomb relay.')
