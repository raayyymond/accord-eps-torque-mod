...
The statistics are the PRE-REGISTERED ones from `builds/v80_v107/build_v100_tva.py`.  Nothing is re-invented and
...
===================================================================================================
V100's byte-4 map, read off `builds/v80_v107/build_v100_tva.py`'s PAYLOAD
===================================================================================================
...
Usage:
    python score/score_r85_v100.py
"""
...
def main():
    ...
    print("    lane (`|gp-0x6b94| >= thr`).  Same method as `score/v100_power_gate.py`, on-route data:")
    sur = {}
    ...
    xr = {}
    for stem, cdir in (("r82", "_scratch/cache/r82"), ("r81", "_scratch/cache/r81"), ("r80", "_scratch/cache/r80")):
