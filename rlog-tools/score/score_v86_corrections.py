...
Usage: python score/score_v86_corrections.py
"""
...
def main():
    ...
    def _san(o):
        ...
        return o
    for p in (ROOT / "_scratch/cache/r6f" / "score_v86_corrections.json",
              ROOT / "_scratch/cache/r70" / "score_v86b_corrections.json"):
