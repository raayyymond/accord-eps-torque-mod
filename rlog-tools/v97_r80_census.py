#!/usr/bin/env python3
r"""Route 80 (V97 flight) -- regime census + probe liveness.  Reads `_cache_r80/r80.npz` only.
...
CACHE = ROOT / "analysis-2020accord" / "_cache_r80"
...
def main():
    ...
    # ---- cave decode, V96/V97 map (build_v96_tva.py THE PAYLOAD)
