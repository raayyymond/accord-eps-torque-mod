...
def main():
    ...
    (ROOT / "_scratch/cache/r6e" / "raw_scan_r6e.json").write_text(json.dumps(out, indent=1))
    print(f"\nwrote {ROOT / '_scratch/cache/r6e' / 'raw_scan_r6e.json'}")
