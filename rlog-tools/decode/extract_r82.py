#!/usr/bin/env python3
r"""Extract route `82` -- THE V99 FLIGHT -- into `analysis-2020accord/_scratch/cache/r82/`.

🛑 THE INSTRUMENT IS NOT REIMPLEMENTED.  Like `decode/extract_r80.py` / `decode/extract_r81.py`, this file only
...
🛑 **IDENTITY RULE, PRE-REGISTERED (`builds/v80_v107/build_v99_tva.py` line ~159):**
...
Usage:
    python decode/extract_r82.py                 # extract + identity + health + census
    python decode/extract_r82.py extract 82
    python decode/extract_r82.py identity 82
"""
...
NEW = {
    "82": ("75604b0a432fdc89_00000082--e30d55731b", 2, "analysis-2020accord/_scratch/cache/r82",
           "r82s", "r82", "V99"),
}
...
# ---- V99's byte-4 map, read off `builds/v80_v107/build_v99_tva.py`'s PAYLOAD, not inferred.
