#!/usr/bin/env python3
"""Extract route 67 (V81) into `_scratch/cache/r67x/` with the SCHEMA the grind harness already reads.
...
back-drive bit -- `probe/decode_v75_probe.py` is the authority for the layout and this file mirrors it.
...
Usage:  python decode/extract_r67_v81.py [seg ...]      (default: all 14)
"""
...
CACHE = ROOT / "_scratch/cache/r67x"
PFX = "r67xs"
LABEL = "V81"
SENTINEL = 0x7FFF
...
def extract(paths):
    ...
    # ---- the probe.  🛑 V75's cave, byte-identical on V81 -- see probe/decode_v75_probe.py -------------
