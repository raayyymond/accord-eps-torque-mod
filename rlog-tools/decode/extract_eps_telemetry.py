#!/usr/bin/env python3
"""decode/extract_eps_telemetry.py -- pull EPS gentle-EME gate-firing telemetry (+ steering context)
...
Usage:
    python decode/extract_eps_telemetry.py RLOG [RLOG ...] -o out.csv
    python decode/extract_eps_telemetry.py "<route>--*/rlog.zst" -o eme.csv
    python decode/extract_eps_telemetry.py --eps-only rlog.zst -o eps.csv

Requires only the local lib/rlog_parse.py (cereal schema + pycapnp + zstandard).
"""
