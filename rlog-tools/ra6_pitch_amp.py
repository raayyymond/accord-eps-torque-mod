...
json.dump(OUT, open(os.path.join(ROOT, 'analysis-2020accord', '_ra6_pitch_amp.json'), 'w'),
          indent=1, default=float)
print("\nwrote analysis-2020accord/_ra6_pitch_amp.json")
