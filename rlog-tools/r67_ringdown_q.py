...
Usage:  python r67_ringdown_q.py
"""
import json
import sys
...
BUILDS = {
    "V76/r65": ("75604b0a432fdc89_00000065--ae43aa0f27", ROOT / "_cache_r65", "r65s",
                list(range(11))),
    "V81/r67": ("75604b0a432fdc89_00000067--9b3ebbe218", ROOT / "_cache_r67x", "r67xs",
                list(range(14))),
    "V80/r66": ("75604b0a432fdc89_00000066--276b942769", ROOT / "_cache_r66x", "r66xs",
                list(range(15))),
}
...
def main():
    ...
    (ROOT / "_cache_r67x" / "r67_ringdown_q.json").write_text(
        json.dumps(OUT, indent=1, default=lambda o: None if o is None else float(o)))
    print(f"\nwrote {ROOT / '_cache_r67x' / 'r67_ringdown_q.json'}")
