...
(1) THE `427 == 1023` FLAG.  At `0x38234` a `bnc 0x382ce` routes to `movea 0x7fff,r0,r11` ->
    ...
    🛑 I verified the CEILING claim independently, from `build_v96_tva.py:128` (its own no-clip
...
PLAUSIBLE_CEIL = 640          # build_v96_tva.py:128, 8192*5>>6
...
def main():
    ...
    (AN / "_cache_r80" / "r80_override_and_1023.json").write_text(
        json.dumps(out, indent=1, default=float))
    print(f"\nwrote {AN/'_cache_r80'/'r80_override_and_1023.json'}")
