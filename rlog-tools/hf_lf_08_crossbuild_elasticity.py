...
OUTPUT `rlog-tools/_hf_lf_elasticity.json`
"""
...
def main():
    ...
    (HERE / "_hf_lf_elasticity.json").write_text(json.dumps(out, indent=1), encoding="utf-8")
    print("wrote", HERE / "_hf_lf_elasticity.json")
