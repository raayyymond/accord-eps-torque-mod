...
CHANNELS, and why each one -- [EVIDENCE] from the Honda DBC in `opendbc_reference/honda/carstate.py`
...
def main():
    ...
    (ROOT / "_cache_r67x" / "r67_t2t3.json").write_text(json.dumps(OUT, indent=1, default=float))
    print(f"\nwrote {ROOT / '_cache_r67x' / 'r67_t2t3.json'}")
