...
ROUTES = {"V86/6f": ("_cache_r6f", "r6fs", range(4)),
          "V85/6e": ("_cache_r6e", "r6es", range(8)),
          "V86B/70": ("_cache_r70", "r70s", range(4))}
...
(ROOT / "_cache_r6f").mkdir(exist_ok=True)
json.dump(out, open(ROOT / "_cache_r6f" / "qd_census.json", "w"), indent=1)
print("\nwrote _cache_r6f/qd_census.json")
