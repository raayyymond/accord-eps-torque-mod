#!/usr/bin/env python3
"""decode_v75_probe.py -- read V75's probe: a MAGNITUDE THERMOMETER on the damper, plus the
back-drive gate.
...
Usage:  python decode_v75_probe.py <rlog-or-segment-dir> [...]
"""
import os
import sys
...
# THERMOMETER and bit3 is independent. build_v75_tva.py asserts this tuple against its own model.
...
# converts BETWEEN the two -- nothing in this file or in build_v75_tva.py does, because the dose
