...
(which loads every other build READ-ONLY from `_cache_r6e/records_v85_score.pkl`), `blk` resampling,
...
Usage: python score_v86_burst_origin.py
"""
import json
import sys
...
def t5_timing(R):
    ...
    for rt, cache, stem in (("6d/V84", "_cache_r6d", "r6d"), ("6e/V85", "_cache_r6e", "r6e"),
                            ("6f/V86", "_cache_r6f", "r6f"), ("70/V86B", "_cache_r70", "r70")):
...
def main():
    ...
    def _san(o):
        ...
        return o
    for p in (ROOT / "_cache_r6f" / "score_v86_burst_origin.json",
              ROOT / "_cache_r70" / "score_v86b_burst_origin.json"):
