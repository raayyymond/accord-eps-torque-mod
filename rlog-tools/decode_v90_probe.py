...
Usage:
    python decode_v90_probe.py d1        # the cross-build K1 question (no new data needed)
"""
import json
import sys
...
OUTDIR = ROOT / "analysis-2020accord" / "_cache_r77"
OUT = {}
...
#
#  THE LANE, byte-exact, COPIED from `docs/TRACE-2026-08-10-damping-axis-hunt.md` §1 (NOT re-derived):
