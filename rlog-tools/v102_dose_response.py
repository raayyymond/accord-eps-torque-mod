...
🛑 AND A MEASURED FACT THAT RULES OUT THE OBVIOUS MODEL.  Within either route, the 22-26 Hz band
   ...
   +0.01 [-0.36, +0.31] on V101 and +0.12 [+0.01, +0.40] on V100 (v102_xb_line23b.py, L1), over a
...
print("      G (22-26 Hz shape, V101/V100) = %.2f  [channel range %.2f - %.2f]   (v102_xb_deconf.py)"
      % (G_MID, G_LO, G_HI))
