...
Read `studies/identification/plant_zcurve.py`'s header first; it establishes the channel choice and the shape.  The one
...
def main():
    ...
    (HERE / "_scratch/out/_plant_fit_final.json").write_text(json.dumps(OUT, indent=1, default=float))
    print("\nwrote %s" % (HERE / "_scratch/out/_plant_fit_final.json"))
