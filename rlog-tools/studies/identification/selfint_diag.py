#!/usr/bin/env python3
"""studies/identification/selfint_diag.py -- the diagnostics that decide whether `studies/identification/selfint_transfer.py`'s coherence
...
Usage: python studies/identification/selfint_diag.py
Writes: _scratch/cache/selfint/selfint_diag.json
"""
...
def d6():
    hdr("D6  WHAT A FEEDFORWARD theta_ddot CANCELLATION WOULD HAVE TO BE, and the correction it\n"
        "    forces on docs/research/FEASIBILITY-SELF-INTERFERENCE-CANCELLATION.md section 3.4.")
...
if __name__ == "__main__":
    ...
    def san(o):
        ...
        if isinstance(o, (np.integer, int)):
            return int(o)
        return o
    (ROOT / "_scratch/cache/selfint" / "selfint_diag.json").write_text(json.dumps(san(OUT), indent=1))
    print("\nwrote _scratch/cache/selfint/selfint_diag.json")
