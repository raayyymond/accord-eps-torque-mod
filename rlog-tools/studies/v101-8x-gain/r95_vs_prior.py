...
ROUTES = {"95": ("V101  8x LKAS gain, Lever B removed", "_scratch/cache/r95/r95.npz"),
          "85": ("V100  4x gain, Lever B armed", "_scratch/cache/r85/r85.npz"),
          "82": ("V99   4x gain, Lever B armed", "_scratch/cache/r82/r82.npz")}
...
(ROOT / "analysis-2020accord/_scratch/cache/r95/r95_vs_prior.json").write_text(
    json.dumps(out, indent=1, default=float))
print(f"\nwrote {ROOT / 'analysis-2020accord/_scratch/cache/r95/r95_vs_prior.json'}")
