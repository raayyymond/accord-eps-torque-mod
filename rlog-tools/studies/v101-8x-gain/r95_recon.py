...
Uses `analysis-2020accord/_scratch/cache/r95/r95.npz` written by `decode/extract_r95.py`.
"""
import sys
...
Z = dict(np.load(ROOT / "analysis-2020accord/_scratch/cache/r95/r95.npz", allow_pickle=True))
