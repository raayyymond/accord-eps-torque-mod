...
🛑 THE INSTRUMENT IS `studies/v86-frequency/v86_freq_test.py`'s, IMPORTED.  `spectra` / `in_speed` / `order_clean` /
...
usage:  python studies/ratchet/ratchet_discriminators.py
out:    _scratch/cache/r6f/ratchet_discriminators.json
"""
...
ROUTES = {
    "V86/r6f":  ("_scratch/cache/r6f",  "r6fs",  list(range(4))),
    "V85/r6e":  ("_scratch/cache/r6e",  "r6es",  list(range(7))),
    "V86B/r70": ("_scratch/cache/r70",  "r70s",  list(range(4))),
