#!/usr/bin/env python3
"""studies/grind/friction_lane_duty_r65.py -- the FRICTION-LANE duty cycle that decides V81's second byte.
...
🛑 DO NOT USE `rlog-tools/probe/decode_v76_probe.py` ON THIS ROUTE. That file documents the SUPERSEDED
...
`analysis-2020accord/studies/sessions/v76/v76flight_extract.py` -> `_scratch/data/_cache_r65_records.pkl`.
...
per `studies/sessions/v74_v75/v75fault_final.py`'s correction of the earlier `t < 284.795` split).

Usage:  python studies/grind/friction_lane_duty_r65.py
"""
import pickle
import sys
...
R65_PKL = ROOT / "analysis-2020accord" / "_scratch/data/_cache_r65_records.pkl"
R5E_NPZ = ROOT / "_scratch/cache/r5e" / "r5e.npz"
