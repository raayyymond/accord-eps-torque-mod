#!/usr/bin/env python3
"""studies/grind/analyze_r29_grinding.py -- what is the parking-lot "grinding" on V57, spectrally?
...
CONVENTIONS (kept identical to decode/decode_two_angles.py so numbers are comparable across the kit):
...
Usage:  python studies/grind/analyze_r29_grinding.py CACHE.npz [--concat]
