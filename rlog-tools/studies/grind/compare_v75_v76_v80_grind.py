...
as every prior route this kit has scored.  What this file adds:
  * the V80/route-66 extract (its OWN cache `_scratch/cache/r66x/`, never `_scratch/cache/r66/` -- a sibling agent
    owns that);
...
Usage:
    python studies/grind/compare_v75_v76_v80_grind.py extract   # route 66 -> _scratch/cache/r66x/  (~6 min, 15 segments)
    python studies/grind/compare_v75_v76_v80_grind.py analyze   # S0-S7: exposure, band table, split-half null,
                                                  #        ratios, dose-response, identity, duty
    python studies/grind/compare_v75_v76_v80_grind.py deep      # D1-D5: line-or-floor spectra, control channels
                                                  #        (angle / IMU / command), the 100 km/h
                                                  #        event, 30-49 Hz duty, creep cell census
    python studies/grind/compare_v75_v76_v80_grind.py deep2     # E1-E5: duty at three thresholds, the FFT-free
                                                  #        near-Nyquist test, event uniqueness,
                                                  #        raw waveform + aliasing, dose table
    python studies/grind/compare_v75_v76_v80_grind.py deep3     # F1-F3: the V80 limit-cycle event class, f0 vs
...
CACHE66 = ROOT / "_scratch/cache/r66x"            # ★ MY cache. `_scratch/cache/r66/` belongs to a sibling agent.
PFX66 = "r66xs"
...
# =================================================================================================
#  PART 1 -- the V80 / route-66 extract.  Field names are studies/sessions/v77/v77sizing_extract.py's, verbatim, so the
