# -*- coding: utf-8 -*-
"""v293_ident_extract.py -- ONE-PASS extraction of every channel the V293 plant identification needs,
...
def extract(tag):
    ...
    KEYS = (
        ...
        "cs_f", "cs_p", "cs_i", "cs_sat", "cs_active",
        ...
        "t_lpar", "lpar_sr", "lpar_stiff", "lpar_ao", "lpar_valid",
        "t_mv", "mv_curv",
...
if __name__ == "__main__":
    for t in (sys.argv[1:] or list(ROUTES)):
        extract(t)
