...
KMH = 3.6
ROUTES = {"80": ("_scratch/cache/r80", "r80", "V97"),
...
def main():
    ...
    (AN / "_scratch/cache/r80" / "r80_vs_v96.json").write_text(json.dumps(out, indent=1, default=float))
    print(f"\nwrote {AN/'_scratch/cache/r80'/'r80_vs_v96.json'}")
