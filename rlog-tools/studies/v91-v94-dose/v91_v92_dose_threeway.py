...
===================================================================================================
WHY A SECOND SCRIPT.  Two defects in `studies/v91-v94-dose/v91_v92_dose_in_force.py` had to be fixed before the engaged
...
Usage:  python studies/v91-v94-dose/v91_v92_dose_threeway.py
"""
import json
import sys
...
def main():
    ...
    (CACHE / "_scratch/cache/r78" / "dose_threeway.json").write_text(json.dumps(out, indent=1,
                                                                       default=float))
    print("\n  wrote analysis-2020accord/_scratch/cache/r78/dose_threeway.json")
