...
🛑 AND THE THREE ROUTES ARE THE SAME FUNCTIONAL CAR.  V91/V92's only calibration edit was measured
   INERT this session at its own single documented output (`studies/v91-v94-dose/v91_v92_dose_threeway.py`).  So every
...
Usage:  python studies/v91-v94-dose/v92_symptom_bands.py
"""
...
def main():
    ...
    (CACHE / "_scratch/cache/r79" / "symptom_bands.json").write_text(json.dumps(OUT, indent=1,
                                                                       default=float))
    print("\n  wrote analysis-2020accord/_scratch/cache/r79/symptom_bands.json")
