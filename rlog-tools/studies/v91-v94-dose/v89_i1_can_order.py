#!/usr/bin/env python3
"""studies/v91-v94-dose/v89_i1_can_order.py -- THE DEFINITIVE TEST for the 0x18F / 0x14A row-packing skew.

The dispute: does a cache ROW carry the 0x18F frame from its own instant, or the previous one?

`studies/grind/compare_v75_v76_v80_grind.py:extract66()` walks `for m in evt.can:` and holds `last18`, appending a
...
RLOGS = Path(__file__).resolve().parents[2].parent / "analysis-2020accord" / "rlogs"
