...
🛑 THE TWO ROUTES ARE CALIBRATION-IDENTICAL, AND SO IS ROUTE 77.  V91 and V92 carry the same 12 cal
   bytes, and this session MEASURED those bytes to be INERT (`studies/v91-v94-dose/v91_v92_dose_threeway.py`: engaged
...
===================================================================================================
THE PRE-DECLARED TRUST GATE (carried verbatim from `studies/impedance/v92_rez_extend.py`, not re-chosen here)
===================================================================================================
...
Usage:  python studies/v91-v94-dose/v92_boost_lane_and_rez.py
"""
...
if __name__ == "__main__":
    ...
    (CACHE / "_scratch/cache/r79" / "boost_lane_and_rez.json").write_text(
        json.dumps(OUT, indent=1, default=float))
    print("\n  wrote analysis-2020accord/_scratch/cache/r79/boost_lane_and_rez.json")
