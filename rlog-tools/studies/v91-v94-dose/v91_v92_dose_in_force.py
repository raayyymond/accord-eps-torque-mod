...
Usage:  python studies/v91-v94-dose/v91_v92_dose_in_force.py
"""
import json
import sys
...
def main():
    ...
    (CACHE / "_scratch/cache/r78" / "dose_in_force.json").write_text(
        json.dumps(res, indent=1, default=float))
    print("\n  wrote analysis-2020accord/_scratch/cache/r78/dose_in_force.json")
    return res
