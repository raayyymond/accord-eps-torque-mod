...
Usage:
    python studies/v91-v94-dose/stratified_damper_test.py
"""
...
def main():
    ...
    (ROOT / "_scratch/cache/r6e" / "stratified_damper_test.json").write_text(
        json.dumps(OUT, indent=1, default=float))
    print(f"\nwrote {ROOT / '_scratch/cache/r6e' / 'stratified_damper_test.json'}")
