...
===================================================================================================
`studies/v91-v94-dose/v92_boost_lane_identify.py` tried to isolate the micro regime with an INSTANTANEOUS mask
...
Usage:  python studies/v91-v94-dose/v92_micro_regime.py
"""
...
def main():
    ...
    (CACHE / "_scratch/cache/r79" / "micro_regime.json").write_text(json.dumps(OUT, indent=1,
                                                                      default=float))
    print("\n  wrote analysis-2020accord/_scratch/cache/r79/micro_regime.json")
