...
Usage:
    python studies/steering-ratio/measure_steering_ratio.py            # everything, writes _scratch/cache/ratio/results.json
    python studies/steering-ratio/measure_steering_ratio.py qa|fit|curve|controls
"""
