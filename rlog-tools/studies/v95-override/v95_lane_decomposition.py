#!/usr/bin/env python3
r"""studies/v95-override/v95_lane_decomposition.py -- WHICH TELEMETERED LANE IS THE 6-9 Hz ENERGY SOURCE, AND HOW BIG.
...
🛑 427 IS RECTIFIED AND SAMPLED AT 50 Hz -- see `studies/v95-override/v95_427_aliasing_and_cadence.py`.  The SIGNED
...
Usage:  python studies/v95-override/v95_lane_decomposition.py
"""
...
def part3():
    ...
    print("  Detection floor for comparison (studies/impedance/v95_crossbuild_rez_ledger.py): ~60 counts at >= 12")
