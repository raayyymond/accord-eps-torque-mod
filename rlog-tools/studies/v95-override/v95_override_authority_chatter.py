#!/usr/bin/env python3
r"""studies/v95-override/v95_override_authority_chatter.py -- THE DECISIVE OVERRIDE TEST.
...
🛑 WHY THIS FILE USES NO WELCH WINDOWS.  Override is a FLICKER, not a state: 5013 contiguous runs
   ...
   (`studies/v95-override/v95_override_exposure.py`).  The kit's band estimator cannot be used in this regime.  Everything
...
Usage:  python studies/v95-override/v95_override_authority_chatter.py
"""
