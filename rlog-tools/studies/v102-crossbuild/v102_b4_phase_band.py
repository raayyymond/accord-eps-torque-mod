#!/usr/bin/env python3
r"""studies/v102-crossbuild/v102_b4_phase_band.py -- run the b4 sign-phase measurement in ANY band.  Default: 6-9 Hz.

    python studies/v102-crossbuild/v102_b4_phase_band.py 6 9

Same chain as `studies/v102-crossbuild/v102_b4_phase_feasibility.py` + `studies/v102-crossbuild/v102_b4_phase_ci.py`, parameterised by band, so the
