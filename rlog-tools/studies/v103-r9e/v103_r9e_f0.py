#!/usr/bin/env python3
r"""studies/v103-r9e/v103_r9e_f0.py -- THE PRE-REGISTERED ENDPOINT for route 9e (V103): `f0`, the Re(Z) zero crossing.

PRE-REGISTERED, `docs/specs/SPEC-2026-08-20-band-definition.md` §4 + `HANDOFF-2026-08-20` §3:
...
Estimator imported READ-ONLY from `decode_v90_probe`; `studies/impedance/rez_control.py` pins it to 0.00 %.
"""
...
def main():
    ...
    Path(HERE / "_scratch/out/_v103_r9e_f0.json").write_text(json.dumps(OUT, indent=1, default=float))
    print("\n  wrote _scratch/out/_v103_r9e_f0.json")
