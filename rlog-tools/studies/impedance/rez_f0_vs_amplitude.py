#!/usr/bin/env python3
r"""studies/impedance/rez_f0_vs_amplitude.py -- DOES f0 MOVE WITH COMMAND AMPLITUDE AT FIXED GAIN?
...
if __name__ == "__main__":
    ...
    for rt, lab in (("96", "V102 6x"), ("97", "STOCK 1x"), ("85", "V100 4x")):
        part_b(rt, lab)
    Path(__file__).with_name("_scratch/out/_rez_f0_vs_amplitude.json").write_text(
        json.dumps(OUT, indent=1, default=float))
    print("\n  wrote _scratch/out/_rez_f0_vs_amplitude.json")
