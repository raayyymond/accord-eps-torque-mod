...
def main():
    ...
    (ROOT / "_scratch/cache/r6f" / "rim_impedance.json").write_text(
        json.dumps({**json.loads((ROOT / "_scratch/cache/r6f" / "rim_impedance.json").read_text()),
                    "part2": O}, indent=1, default=float))
    print("\nwrote %s" % (ROOT / "_scratch/cache/r6f" / "rim_impedance.json"))
