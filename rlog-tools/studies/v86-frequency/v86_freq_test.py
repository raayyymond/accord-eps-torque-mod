...
argmax are `studies/misc/relay_fingerprint_r6e.py`'s, imported verbatim (NW=1024 @ ~101 Hz -> 0.0987 Hz bins;
...
ROUTES = {
    ...
    "V85/r6e":  ("_scratch/cache/r6e",  "r6es",  list(range(7))),      # seg 7 parked
