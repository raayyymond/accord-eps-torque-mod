...
OUTPUT  `rlog-tools/_scratch/out/_hf_lf_controls.json`
"""
...
def main():
    ...
    (HERE / "_scratch/out/_hf_lf_controls.json").write_text(json.dumps(res, indent=1))
    print("\nwrote", HERE / "_scratch/out/_hf_lf_controls.json")
    return 0
