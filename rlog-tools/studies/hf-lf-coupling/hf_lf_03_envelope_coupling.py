...
OUTPUT `rlog-tools/_scratch/out/_hf_lf_coupling.json`
"""
...
def main():
    ...
    (HERE / "_scratch/out/_hf_lf_coupling.json").write_text(json.dumps(out, indent=1))
    print("\nwrote", HERE / "_scratch/out/_hf_lf_coupling.json")
    return 0
