...
OUTPUT `rlog-tools/_scratch/out/_hf_lf_sensitivity.json`
"""
...
def main():
    ...
    (HERE / "_scratch/out/_hf_lf_sensitivity.json").write_text(json.dumps(out, indent=1), encoding="utf-8")
    print("\nwrote", HERE / "_scratch/out/_hf_lf_sensitivity.json")
