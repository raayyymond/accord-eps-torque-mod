...
WHY THIS FILE EXISTS.  `studies/misc/dcmd_dt_hypothesis.py` returned an answer that DEPENDS ON THE CONTROL BAND:
...
Usage:  python studies/misc/dcmd_dt_spectrum.py
"""
