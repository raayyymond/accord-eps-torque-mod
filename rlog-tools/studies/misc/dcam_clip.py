...
Usage:
    python studies/misc/dcam_clip.py <route_id> <seg_idx> <t_start_in_seg> <duration> [--cam dcamera|fcamera] [--out PATH]
    python studies/misc/dcam_clip.py 00000007--408bdfcdb9 10 22.5 8
