...
=================================================================================================
`model/eps_chain_lanes.py` states the trap explicitly:
...
Usage:  python studies/ra6/ra6_dose.py
"""
import os
import sys
import json
...
json.dump(OUT, open(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))),
                                 'analysis-2020accord', '_scratch/out/_ra6_dose.json'), 'w'),
          indent=1, default=float)
print("\nwrote analysis-2020accord/_scratch/out/_ra6_dose.json")
