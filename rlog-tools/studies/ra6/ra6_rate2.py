...
🛑 SELF-CORRECTION 4.  `studies/ra6/ra6_rate.py` section 4 found **ZERO onset events on all four routes**.
...
🛑 SELF-CORRECTION 5.  `studies/ra6/ra6_line.py` section 3's partial correlation is DEFECTIVE.  `LINE` is
...
Usage:  python studies/ra6/ra6_rate2.py
"""
import os
import sys
import json
...
print()
print("=" * 124)
print("2.  ⭐ THE SUSTAINED-DEMAND RATE, **SPEED-STRATIFIED** -- `studies/ra6/ra6_rate.py` section 5 pooled")
...
print("    floor that broke `studies/ra6/ra6_line.py` section 3), plus a 30 s contiguous-BLOCK bootstrap")
...
json.dump(OUT, open(os.path.join(ROOT, 'analysis-2020accord', '_scratch/out/_ra6_rate2.json'), 'w'),
          indent=1, default=float)
print("\nwrote analysis-2020accord/_scratch/out/_ra6_rate2.json")
