r"""ROUTE `a6` -- Q1/Q2' PART 2.  THREE CORRECTIONS AND ONE ADDITION TO `studies/ra6/ra6_dose.py`.

🛑 SELF-CORRECTION 1.  `studies/ra6/ra6_dose.py`'s `alpha_at()` IS DEFECTIVE AND ITS "delivered multiplier"
...
🛑 SELF-CORRECTION 2.  The reconstruction in `studies/ra6/ra6_dose.py` 3(A) used the POINT prediction, so its
...
Usage:  python studies/ra6/ra6_dose2.py
"""
import os
import sys
import json
...
print("    (`studies/ra6/ra6_dose.py`'s version searched both branches and is RETRACTED.)")
...
json.dump(OUT, open(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))),
                                 'analysis-2020accord', '_scratch/out/_ra6_dose2.json'), 'w'),
          indent=1, default=float)
print("\nwrote analysis-2020accord/_scratch/out/_ra6_dose2.json")
