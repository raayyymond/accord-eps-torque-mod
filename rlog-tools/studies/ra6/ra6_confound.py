...
Usage:  python studies/ra6/ra6_confound.py
"""
import os
import sys
import json
...
json.dump(OUT, open(os.path.join(ROOT, 'analysis-2020accord', '_scratch/out/_ra6_confound.json'), 'w'),
          indent=1, default=float)
print("\nwrote analysis-2020accord/_scratch/out/_ra6_confound.json")
