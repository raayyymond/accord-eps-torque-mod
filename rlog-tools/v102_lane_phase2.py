#!/usr/bin/env python3
r"""v102_lane_phase2.py -- arg(csd(gp-0x6b26 / gp-0x6bbe, STEER_TORQUE_SENSOR)) at 20-23 Hz.
...
`extract_r77.py:75` B7_SIGN_6B26 = 0x80 · `extract_r78_r79.py:97,99` b7_sign_6b26 / b7_sign_6bbe.
The wire SCALE (2/5, 8/5, 16/5) is irrelevant to a phase and is deliberately not applied.

INSTRUMENT HAZARDS -- unchanged from `v102_lane_phase.py`, and they dominate:
