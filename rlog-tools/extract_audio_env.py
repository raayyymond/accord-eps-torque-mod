...
WHY A SECOND PASS.  The first pass (`extract_audio.py`) stores 1024-point FFT band powers.  At
...
usage:  python extract_audio_env.py            # all six routes
        python extract_audio_env.py ra4 r97
"""
import sys
