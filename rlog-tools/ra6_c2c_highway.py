...
Usage:  python ra6_c2c_highway.py
"""
import os
import sys
import json
...
json.dump(OUT, open(os.path.join(ROOT, 'analysis-2020accord', '_ra6_c2c_highway.json'), 'w'),
          indent=1, default=float)
print("\nwrote analysis-2020accord/_ra6_c2c_highway.json")
