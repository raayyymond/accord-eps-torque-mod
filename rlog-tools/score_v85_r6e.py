...
Reads `_cache_r6e/r6e.npz` (written by `extract_r6e.py`, which drives the corpus's own
...
Usage:
    python score_v85_r6e.py            # everything, to stdout + json into _cache_r6e/
"""
import json
import sys
...
# V84's OWN field alphabet on route 6d, quoted from `_cache_r6d/identity.json` -- the discriminator
