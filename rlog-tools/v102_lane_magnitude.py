#!/usr/bin/env python3
r"""v102_lane_magnitude.py -- |L(f)| at 20-23 Hz: the MAGNITUDE half of `pole-hunt`'s cross-spectrum.

`v102_lane_phase2.py` gave arg(L).  This gives |L| = |Sxy| / Pxx -- the least-squares transfer gain
