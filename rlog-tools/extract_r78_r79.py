...
`analysis-2020accord/_cache_r78/` and `_cache_r79/`, tap the FULL 0x1AB payload, tap CAN 0x14A
...
🛑 THE INSTRUMENT IS NOT REIMPLEMENTED.  Exactly as `extract_r6e.py` .. `extract_r77.py` do, this
file adds rows to `decode_v84_probe_r6d.ROUTES` and calls that module's `extract()`/`split()` -- the
SAME code that wrote every cache since `_cache_r6d/`.  Field names, ZOH/interp convention, IMU axis
...
Usage:
    python extract_r78_r79.py                 # extract + identity + health + census, both routes
    python extract_r78_r79.py extract 78
    python extract_r78_r79.py identity 79
    python extract_r78_r79.py health 79
    python extract_r78_r79.py census 78
"""
import json
import sys
...
ROUTE_DEF = {
    "78": ("75604b0a432fdc89_00000078--93548c06b3", 16, "analysis-2020accord/_cache_r78",
           "r78s", "r78", "V91"),
    "79": ("75604b0a432fdc89_00000079--cb7538ffae", 15, "analysis-2020accord/_cache_r79",
           "r79s", "r79", "V92"),
}
for _k, _v in ROUTE_DEF.items():
    D.ROUTES[_k] = _v
D.ROUTES.setdefault("77", ("75604b0a432fdc89_00000077--7411859c54", 21,
                           "analysis-2020accord/_cache_r77", "r77s", "r77", "V90"))
...
#  0x1AB carried verbatim from `extract_r77.py`; 0x14A byte7 is new.
# ======================================================================================
...
# ======================================================================================
#  EXPOSURE CENSUS -- verbatim from `extract_r77.py`
# ======================================================================================
