#!/usr/bin/env python3
r"""v103_r9e_symptom.py -- ROUTE 9e (V103): LOCATE THE OPERATOR'S TWO SYMPTOMS IN TIME AND FREQUENCY.
...
🛑 Bands per `docs/SPEC-2026-08-20-band-definition.md`: 20-28 primary, 21.5-25.5 legacy, 2.5-4.5 the
...
def main():
    ...
    Path(HERE / "_v103_r9e_symptom.json").write_text(json.dumps(OUT, indent=1, default=float))
    print("\n  wrote _v103_r9e_symptom.json")
