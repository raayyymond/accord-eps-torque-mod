#!/usr/bin/env python3
"""Driver for the V86 pre-registered frequency test.  See `v86_freq_test.py` for the instrument."""
import json
import sys
...
def main():
    ...
    (ROOT / "_cache_r6f" / "v86_freq_test.json").write_text(
        json.dumps(OUT, indent=1, default=float))
    print("\nwrote %s" % (ROOT / "_cache_r6f" / "v86_freq_test.json"))
