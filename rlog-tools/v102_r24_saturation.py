...
THE ARITHMETIC, from the golden model, NOT from the brief:
  eps_chain_lanes.py:123  "FUN_0007f3f8 calls FUN_0007e74a ... 2*(current-delayed)/wrapped_sample_delta,
                           with delay cal tp+0x7c42=4"
  eps_chain_control.py:880 "gp-0x4f62 is a 4-SAMPLE FINITE DIFFERENCE at 1 kHz (2*(x[n]-x[n-4])/4 ...)"
...
🛑 THE KIT HAS ALREADY MEASURED THIS ONCE, at 4x.  eps_chain_control.py:905, the V67 design note:
