...
HOLD_OFF = 300.0       # `v97_return_to_centre.py`'s HANDS-OFF criterion: p90|tq| < 300
NFFT = 512
...
def q3_exposure(routes):
    ...
    print("    hands-off = window p90|tq| < %.0f counts (`v97_return_to_centre.py`'s HOLD_OFF)."
          % HOLD_OFF)
