#!/usr/bin/env python3
"""probe/decode_v67_gate.py -- read V67's gate probe out of an rlog.
...
(`studies/sessions/v68/v66_v67_explained.py` mirrors this as `> CEIL`; the builder asserts the disagreement is confined
...
Hz pair in docs/specs/design/V66-V67-DESIGN.md.
...
Usage:  python probe/decode_v67_gate.py RLOG [RLOG ...]
"""
...
# `probe/decode_v67_gate.py ... > out.txt` crashed before emitting a single line. Found by the probe
