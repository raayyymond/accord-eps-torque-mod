...
def run(r):
    ...
    blocks_ = json.loads(
        (ROOT / "analysis-2020accord" / "_scratch/out/_r7e_r7f_elicitations.json").read_text())[r]
...
if __name__ == "__main__":
    ...
    (ROOT / "analysis-2020accord" / "_scratch/out/_r7e_r7f_probe_vs_ratchet.json").write_text(
