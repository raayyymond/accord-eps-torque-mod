#!/usr/bin/env python3
"""probe/decode_v74_probe.py -- read V74's probe: the damper's OWN OUTPUT and the assist-chain STATE.
...
Usage:  python probe/decode_v74_probe.py <rlog-or-segment-dir> [...]
"""
...
# 🛑 ONE LINE, deliberately. builds/v50_v79/build_v74_tva.py asserts this exact basename appears in this file;
...
def identify(b4, engaged=None, speed_ms=None, rate_degs=None, t=None, override=False):
    ...
    if decisive:
        ...
        print("       answer. Read it with probe/decode_v73_probe.py instead.")
