#!/usr/bin/env python3
"""probe/v86_probe_physics.py -- what the V86 / V86B `gp-0x6b70` probe cave actually MEASURED.
...
ROUTES = {"6f": ("_scratch/cache/r6f", "r6f", V86), "70": ("_scratch/cache/r70", "r70", V86B)}
...
def main():
    ...
    (ROOT / "_scratch/cache/r6f" / "probe_v86_cross_route.json").write_text(
