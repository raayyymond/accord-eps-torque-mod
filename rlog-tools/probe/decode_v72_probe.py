#!/usr/bin/env python3
"""probe/decode_v72_probe.py -- read V72's probe: `a`, the base damper, and the rate index.
...
Usage:  python probe/decode_v72_probe.py <rlog-or-route-dir> [...]
"""
...
# 🛑 ONE LINE, deliberately. builds/v50_v79/build_v72_tva.py asserts this exact basename appears in this file;
