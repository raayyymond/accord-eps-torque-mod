#!/usr/bin/env python3
"""probe/decode_v70_probe.py -- read V70's probe: three REPAIRED rungs and a sign bit.
...
--------------------------------------------------------------------------------------------
From the golden model (`model/eps_lkas_chain_model.py` ~line 1193): r24 and r26 take **the same
...
fact -- so it is asserted at BUILD time (`verify/verify_v70_image.py`) and only recorded here. FUN_0003aa2c
...
Usage:  python probe/decode_v70_probe.py <route-dir-or-segment-paths...>
"""
