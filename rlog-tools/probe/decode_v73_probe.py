#!/usr/bin/env python3
"""probe/decode_v73_probe.py -- read V73's probe: the base-assist damper's MODE BYTE, `gp+0x63fd`.
...
Usage:  python probe/decode_v73_probe.py <rlog-or-route-dir> [...]
"""
...
# 🛑 ONE LINE, deliberately. builds/v50_v79/build_v73_tva.py asserts this exact basename appears in this file;
...
def identify(b4):
    ...
    if void:
        ...
        # 🛑 The forward direction is NOT free and needed a real guard: see probe/decode_v74_probe.py's
