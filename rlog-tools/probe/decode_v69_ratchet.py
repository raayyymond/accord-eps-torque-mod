#!/usr/bin/env python3
"""probe/decode_v69_ratchet.py -- read V69's probe, which is aimed at the RATCHET, not the grinds.
...
fact -- so it is asserted at BUILD time (`verify/verify_v69_image.py`) and only recorded here.
...
Usage:  python probe/decode_v69_ratchet.py <route-dir-or-segment-paths...>
"""
...
# from `analysis-2020accord/studies/sessions/r4f/r4f_v69_readout.py`, which also adds the matched negative control that
...
def main(paths):
    ...
    if not rr:
        ...
        print("     +4096. See analysis-2020accord/studies/sessions/v70/v70_rung_reachability.py. bit5 is NOT vacuous")
