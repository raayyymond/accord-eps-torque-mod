#!/usr/bin/env python3
r"""Extract route `77` (the V90 flight) into `analysis-2020accord/_cache_r77/`, tap the FULL
0x1AB payload, and run the SINGLE-FRAME V90 identity test from `docs/SPEC-2026-08-10-v90-cave.md` §4.

🛑 THE INSTRUMENT IS NOT REIMPLEMENTED.  Exactly as `extract_r6e.py` .. `extract_r75_r76.py` do,
this file adds a row to `decode_v84_probe_r6d.ROUTES` and calls that module's `extract()`/`split()`
-- the SAME code that wrote every cache since `_cache_r6d/`.  Field names, ZOH/interp convention,
IMU axis pick, sentinel definition and `PASS_1D` are therefore bit-for-bit the ones every prior
route was scored with.

★ V90'S CAVE BIT LAYOUT (`docs/SPEC-2026-08-10-v90-cave.md` §2, four INDEPENDENT signals)
...
Usage:
    python extract_r77.py                  # extract, identity, health, census
    python extract_r77.py extract
    python extract_r77.py identity
    python extract_r77.py health
    python extract_r77.py census
"""
import json
import sys
...
CDIR = "analysis-2020accord/_cache_r77"

D.ROUTES[ROUTE] = ("75604b0a432fdc89_00000077--7411859c54", NSEG, CDIR, "r77s", "r77", "V90")
D.ROUTES.setdefault("76", ("75604b0a432fdc89_00000076--c81e964e05", 13, "_cache_r76", "r76s",
                           "r76", "V89"))
D.ROUTES.setdefault("75", ("75604b0a432fdc89_00000075--9bbcb3f7da", 16, "_cache_r75", "r75s",
                           "r75", "V89"))
D.ROUTES.setdefault("73", ("75604b0a432fdc89_00000073--9380c74d52", 11, "_cache_r73", "r73s",
                           "r73", "V88"))
...
# Carried VERBATIM from `extract_r75_r76.py`.
# ======================================================================================
...
# ======================================================================================
#  EXPOSURE CENSUS -- verbatim from `extract_r75_r76.py`
# ======================================================================================
