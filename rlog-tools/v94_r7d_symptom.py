...
classified by their OWN median |wheel rate| — the same pattern `v92_symptom_bands.py` uses, so every
...
Usage:  python v94_r7d_symptom.py
"""
import json
import sys
...
COH_ABS, COH_REL = 0.10, 5.0          # the pre-declared trust gate from v92_rez_extend.py
...
def main():
    ...
    (CACHE / "_cache_r7d" / "v94_symptom.json").write_text(json.dumps(OUT, indent=1, default=float))
    print("  wrote analysis-2020accord/_cache_r7d/v94_symptom.json")
