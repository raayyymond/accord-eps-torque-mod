#!/usr/bin/env python3
r"""score_v102_ancova.py -- the peak triple with the SPEED SLOPE removed, and the ratchet band.

WHY: `score_v102_peak_cave.py` s3C measured a REAL, non-tyre speed slope on the resonance --
