#!/usr/bin/env python3
r"""v102_endpoint_reconcile.py -- WHY DO TWO AGENTS GET 2.982 AND 1.003 FOR THE SAME ENDPOINT?
...
THE TWO ESTIMATORS ARE GENUINELY DIFFERENT:
  ...
  MINE   `r95_v102_prereg.py` lineage (the one that produced the record's 5.07 / 0.62)
  ...
  THEIRS `v102_xb_lib.windows()` lineage (the one `score_v102.py` uses)
