...
🛑 SELF-CORRECTION 3.  `ra6_dose2.py` section 2 returned **1.02x** for the delivered multiplier and
   ...
   V105 does not fall to 0.268 until alpha ~ 640.  **`ra6_dose2.py` section 2 is RETRACTED and
   replaced by section 1 here.**

⭐ ADDITION 1.  A WITHIN-DRIVE SPLIT-HALF NULL ON THE ALPHA STATISTIC.  `ra6_dose2.py` section 4
...
⭐ ADDITION 2.  A REAL SANITY CHECK ON THE CLAMP LAW.  `ra6_dose2.py` "verified" the law by
...
print("    The 8/8 matched-alpha ratio in `ra6_dose2.py` section 1 is the ROBUST result; this")
print("    multiplier is the QUANTITATIVE one and carries that extra assumption.  [BELIEF]")

# ================================================================== 2. alpha + its null
print()
print("=" * 124)
print("2.  ⭐ THE MOTOR ACCELERATION ITSELF -- **AND THE WITHIN-DRIVE NULL THAT `ra6_dose2.py`")
...
print("     tail, the a6 clamp duties in `ra6_dose2.py` section 3 inherit that bias in the same")
...
json.dump(OUT, open(os.path.join(ROOT, 'analysis-2020accord', '_ra6_dose3.json'), 'w'),
          indent=1, default=float)
print("\nwrote analysis-2020accord/_ra6_dose3.json")
