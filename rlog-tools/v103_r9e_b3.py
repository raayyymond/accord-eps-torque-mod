#!/usr/bin/env python3
r"""v103_r9e_b3.py -- THE V103 DELIVERABLE: what `b3` (sign of D_state, gp-0x3680) shows.

`v103_r9e_cave.py` found the headline: b3's sign spectrum peaks at **24.3 Hz when ENGAGED** and at
...
def main():
    ...
    Path(HERE / "_v103_r9e_b3.json").write_text(json.dumps(OUT, indent=1, default=float))
    print("\n  wrote _v103_r9e_b3.json")
