...
def main():
    ...
    (CACHE / "_cache_r7d" / "v94_dose.json").write_text(json.dumps(res, indent=1, default=float))
    print("\n  wrote analysis-2020accord/_cache_r7d/v94_dose.json")
