...
`memory/reference-accord-rate-scale-4p7121-stands.md`: **`gp-0x6ac0` counts = |column deg/s| x 4.7121**,
...
`docs/FEASIBILITY-8X-LKAS.md` says BOTH of these, in one document:
...
Usage:  python v93_return_to_centre.py
"""
import json
import sys
...
OUTJ = ROOT / "analysis-2020accord" / "_cache_r77" / "v93_return_to_centre.json"
...
RATE_MIN = 1.0                             # deg/s
MIN_RUN_S = 0.30
ROUTES = {"77": (ROOT / "analysis-2020accord" / "_cache_r77", "r77"),
          "73": (ROOT / "_cache_r73", "r73"),
          "75": (ROOT / "_cache_r75", "r75"),
          "76": (ROOT / "_cache_r76", "r76")}
