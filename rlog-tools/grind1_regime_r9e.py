#!/usr/bin/env python3
r"""grind1_regime_r9e.py -- LOCALISE GRINDING #1 on route `9e` (V103) and test the operator's
...
def part7(d):
    ...
    print("\n  CONTEXT [inherited EVIDENCE, docs/SCORING-2026-08-20-v103-route9e.md sec 3.6-3.7]:")
...
def part9b(d):
    ...
    p = HERE.parent / "analysis-2020accord" / "_cache_r47_ratchet.npz"
    if not p.exists():
...
def part10(d):
    ...
    p = HERE.parent / "analysis-2020accord" / "_cache_r79" / "r79.npz"
...
def dump():
    p = HERE / "_grind1_regime_r9e.json"
