#!/usr/bin/env python3
r"""v102_wire_and_427.py -- two short sub-reports on routes 96 (V102) and 97 (STOCK).
  ...
  Q2  HOW DENSELY DOES OPENPILOT FILL ITS OWN +-4096 WIRE RANGE?
      ...
      `decode_v84_probe_r6d.py:117`), NOT a gateway echo -- so the cached value SET is the
   ...
   should track the COMMAND much more tightly and the wheel much more loosely.""")
    ...
    for r in ("96", "97"):
        ...
        for s in RAW_SEGS[r]:
            ...
            # filter `decode_v84_probe_r6d.py:117` uses.  A per-event try/except is mandatory:
