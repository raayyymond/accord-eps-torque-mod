#!/usr/bin/env python3
r"""v95_rez_2x2.py -- ENGAGED vs MANUAL x HANDS-OFF vs HANDS-ON, matched, with the mask guarded.
...
🛑 RUN `v95_rez_polarity_and_mask.py` FIRST.  Its CONTROL 2 is the reason this file exists: the
