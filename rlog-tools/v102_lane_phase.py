#!/usr/bin/env python3
r"""v102_lane_phase.py -- cross-spectral phase arg(csd(lane, torque)) at 20-23 Hz, for `pole-hunt`.
...
TWO INSTRUMENT HAZARDS AT 20-23 Hz, both large enough to dominate the answer:
  1. **427 SAMPLES AT 49.8 Hz => NYQUIST 24.9 Hz.**  20-23 Hz is 0.80-0.92 of Nyquist, ~2.2
     samples/cycle.  `v102_xb_lib.CH_NYQ` itself caps this lane at 20 Hz, and `build_v102_tva.py`
